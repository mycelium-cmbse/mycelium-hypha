...
```
tools/
├── metamodel-gen/   C# (uml4net): reads XMI → writes knowledge/{kerml,sysml2}/elements + index.md
└── spec-extract/    Python:       reads PDFs → writes knowledge/spec/{kerml,sysml2} by clause
```

| Pipeline | Language | Input | Output |
| --- | --- | --- | --- |
| `metamodel-gen` | C# / [uml4net](https://github.com/STARIONGROUP/uml4net) | `sources/xmi/*.kermlx`, `*.sysmlx` | `knowledge/kerml/`, `knowledge/sysml2/` |
