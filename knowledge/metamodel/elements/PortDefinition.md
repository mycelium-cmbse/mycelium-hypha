...
name: PortDefinition
package: Ports
fully qualified name: SysML::Systems::Ports::PortDefinition
isAbstract: false
visibility: public
generalizes: [OccurrenceDefinition, Structure]
specializedBy: [ConjugatedPortDefinition]
---
...
- [ConjugatedPortDefinition](ConjugatedPortDefinition.md)

## Owned features

### conjugatedPortDefinition

`+` [ConjugatedPortDefinition](ConjugatedPortDefinition.md) · `[0..1]` · *derived*
