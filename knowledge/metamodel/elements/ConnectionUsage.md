...
`+` [AssociationStructure](AssociationStructure.md) · `[0..*]` · *derived, ordered*
...
Redefines [association](Connector.md#association)

Subsets [itemDefinition](ItemUsage.md#itemdefinition)
