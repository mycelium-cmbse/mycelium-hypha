...
package: States
fully qualified name: SysML::Systems::States::StateSubactionMembership
isAbstract: false
visibility: public
...
`+` [ActionUsage](ActionUsage.md) · `[1..1]` · *derived, composite*
...
`+` [StateSubactionKind](StateSubactionKind.md) · `[1..1]`
