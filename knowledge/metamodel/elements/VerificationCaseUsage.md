...
fully qualified name: SysML::Systems::VerificationCases::VerificationCaseUsage
isAbstract: false
visibility: public
...
`+` [VerificationCaseDefinition](VerificationCaseDefinition.md) · `[0..1]` · *derived*

The VerificationCase that is the definition of this VerificationCaseUsage.

Subsets [caseDefinition](CaseUsage.md#casedefinition)
