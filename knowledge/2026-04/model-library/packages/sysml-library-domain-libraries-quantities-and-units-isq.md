...
language: SysML
source: sysml.library/Domain Libraries/Quantities and Units/ISQ.sysml
declares: [ISQ, ISQ::TemperatureDifferenceValue, ISQ::temperatureDifference, ISQ::TemperatureDifferenceUnit, ISQ::TemperatureDifferenceUnit::thermodynamicTemperaturePF]
license: EPL-2.0
---

# ISQ

Verbatim SysML standard-library source from `sysml.library/Domain Libraries/Quantities and Units/ISQ.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `ISQ` — standard library package
- `ISQ::TemperatureDifferenceValue` — attribute def
- `ISQ::temperatureDifference` — attribute
- `ISQ::TemperatureDifferenceUnit` — attribute def
- `ISQ::TemperatureDifferenceUnit::thermodynamicTemperaturePF` — attribute
