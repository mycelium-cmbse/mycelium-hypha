...
language: SysML
source: sysml.library/Domain Libraries/Quantities and Units/SI.sysml
declares: [SI, SI::temperatureOfWaterAtTriplePointInK, SI::tonne, SI::temperatureWaterAtFreezingPointInC, SI::temperatureWaterAtTriplePointInC, SI::celsiusToKelvinScaleMapping, SI::zeroDegreeCelsiusInKelvin, SI::zeroDegreeCelsiusToKelvinShift]
license: EPL-2.0
---

# SI

Verbatim SysML standard-library source from `sysml.library/Domain Libraries/Quantities and Units/SI.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `SI` — standard library package
- `SI::temperatureOfWaterAtTriplePointInK` — attribute
- `SI::tonne` — attribute
- `SI::temperatureWaterAtFreezingPointInC` — attribute
- `SI::temperatureWaterAtTriplePointInC` — attribute
- `SI::celsiusToKelvinScaleMapping` — attribute
- `SI::zeroDegreeCelsiusInKelvin` — attribute
- `SI::zeroDegreeCelsiusToKelvinShift` — attribute
