...
language: SysML
source: sysml.library/Domain Libraries/Quantities and Units/ISQLight.sysml
declares: [ISQLight, ISQLight::SpeedOfLightInAMediumValue, ISQLight::speedOfLightInAMedium, ISQLight::SpeedOfLightInAMediumUnit, ISQLight::SpeedOfLightInAMediumUnit::lengthPF, ISQLight::SpeedOfLightInAMediumUnit::durationPF, ISQLight::RefractiveIndexValue, ISQLight::refractiveIndex, ISQLight::radiantEnergy, ISQLight::SpectralRadiantEnergyValue, ISQLight::spectralRadiantEnergy, ISQLight::SpectralRadiantEnergyUnit, ISQLight::SpectralRadiantEnergyUnit::lengthPF, ISQLight::SpectralRadiantEnergyUnit::massPF, ISQLight::SpectralRadiantEnergyUnit::durationPF, ISQLight::RadiantEnergyDensityValue, ISQLight::radiantEnergyDensity, ISQLight::RadiantEnergyDensityUnit, ISQLight::RadiantEnergyDensityUnit::lengthPF, ISQLight::RadiantEnergyDensityUnit::massPF, ISQLight::RadiantEnergyDensityUnit::durationPF, ISQLight::SpectralRadiantEnergyDensityInTermsOfWavelengthValue, ISQLight::spectralRadiantEnergyDensityInTermsOfWavelength, ISQLight::SpectralRadiantEnergyDensityInTermsOfWavelengthUnit, ISQLight::SpectralRadiantEnergyDensityInTermsOfWavelengthUnit::lengthPF, ISQLight::SpectralRadiantEnergyDensityInTermsOfWavelengthUnit::massPF, ISQLight::SpectralRadiantEnergyDensityInTermsOfWavelengthUnit::durationPF, ISQLight::SpectralRadiantEnergyDensityInTermsOfWavenumberValue, ISQLight::spectralRadiantEnergyDensityInTermsOfWavenumber, ISQLight::SpectralRadiantEnergyDensityInTermsOfWavenumberUnit, ISQLight::SpectralRadiantEnergyDensityInTermsOfWavenumberUnit::massPF, ISQLight::SpectralRadiantEnergyDensityInTermsOfWavenumberUnit::durationPF, ISQLight::RadiantFluxValue, ISQLight::radiantFlux, ISQLight::RadiantFluxUnit, ISQLight::RadiantFluxUnit::lengthPF, ISQLight::RadiantFluxUnit::massPF, ISQLight::RadiantFluxUnit::durationPF, ISQLight::SpectralRadiantFluxValue, ISQLight::spectralRadiantFlux, ISQLight::SpectralRadiantFluxUnit, ISQLight::SpectralRadiantFluxUnit::lengthPF, ISQLight::SpectralRadiantFluxUnit::massPF, ISQLight::SpectralRadiantFluxUnit::durationPF, ISQLight::RadiantIntensityValue, ISQLight::radiantIntensity, ISQLight::RadiantIntensityUnit, ISQLight::RadiantIntensityUnit::lengthPF, ISQLight::RadiantIntensityUnit::massPF, ISQLight::RadiantIntensityUnit::durationPF, ISQLight::SpectralRadiantIntensityValue, ISQLight::spectralRadiantIntensity, ISQLight::SpectralRadiantIntensityUnit, ISQLight::SpectralRadiantIntensityUnit::lengthPF, ISQLight::SpectralRadiantIntensityUnit::massPF, ISQLight::SpectralRadiantIntensityUnit::durationPF, ISQLight::RadianceValue, ISQLight::radiance, ISQLight::RadianceUnit, ISQLight::RadianceUnit::massPF, ISQLight::RadianceUnit::durationPF, ISQLight::SpectralRadianceValue, ISQLight::spectralRadiance, ISQLight::SpectralRadianceUnit, ISQLight::SpectralRadianceUnit::lengthPF, ISQLight::SpectralRadianceUnit::massPF, ISQLight::SpectralRadianceUnit::durationPF, ISQLight::IrradianceValue, ISQLight::irradiance, ISQLight::IrradianceUnit, ISQLight::IrradianceUnit::massPF, ISQLight::IrradianceUnit::durationPF, ISQLight::SpectralIrradianceValue, ISQLight::spectralIrradiance, ISQLight::SpectralIrradianceUnit, ISQLight::SpectralIrradianceUnit::lengthPF, ISQLight::SpectralIrradianceUnit::massPF, ISQLight::SpectralIrradianceUnit::durationPF, ISQLight::RadiantExitanceValue, ISQLight::radiantExitance, ISQLight::RadiantExitanceUnit, ISQLight::RadiantExitanceUnit::massPF, ISQLight::RadiantExitanceUnit::durationPF, ISQLight::SpectralRadiantExitanceValue, ISQLight::spectralRadiantExitance, ISQLight::SpectralRadiantExitanceUnit, ISQLight::SpectralRadiantExitanceUnit::lengthPF, ISQLight::SpectralRadiantExitanceUnit::massPF, ISQLight::SpectralRadiantExitanceUnit::durationPF, ISQLight::RadiantExposureValue, ISQLight::radiantExposure, ISQLight::RadiantExposureUnit, ISQLight::RadiantExposureUnit::massPF, ISQLight::RadiantExposureUnit::durationPF, ISQLight::SpectralRadiantExposureValue, ISQLight::spectralRadiantExposure, ISQLight::SpectralRadiantExposureUnit, ISQLight::SpectralRadiantExposureUnit::lengthPF, ISQLight::SpectralRadiantExposureUnit::massPF, ISQLight::SpectralRadiantExposureUnit::durationPF, ISQLight::LuminousEfficiencyValue, ISQLight::luminousEfficiency, ISQLight::SpectralLuminousEfficiencyValue, ISQLight::spectralLuminousEfficiency, ISQLight::LuminousEfficacyOfRadiationValue, ISQLight::luminousEfficacyOfRadiation, ISQLight::LuminousEfficacyOfRadiationUnit, ISQLight::LuminousEfficacyOfRadiationUnit::lengthPF, ISQLight::LuminousEfficacyOfRadiationUnit::massPF, ISQLight::LuminousEfficacyOfRadiationUnit::durationPF, ISQLight::LuminousEfficacyOfRadiationUnit::luminousIntensityPF, ISQLight::SpectralLuminousEfficacyValue, ISQLight::spectralLuminousEfficacy, ISQLight::SpectralLuminousEfficacyUnit, ISQLight::SpectralLuminousEfficacyUnit::lengthPF, ISQLight::SpectralLuminousEfficacyUnit::massPF, ISQLight::SpectralLuminousEfficacyUnit::durationPF, ISQLight::SpectralLuminousEfficacyUnit::luminousIntensityPF, ISQLight::MaximumLuminousEfficacyValue, ISQLight::maximumLuminousEfficacy, ISQLight::MaximumLuminousEfficacyUnit, ISQLight::MaximumLuminousEfficacyUnit::lengthPF, ISQLight::MaximumLuminousEfficacyUnit::massPF, ISQLight::MaximumLuminousEfficacyUnit::durationPF, ISQLight::MaximumLuminousEfficacyUnit::luminousIntensityPF, ISQLight::LuminousEfficacyOfASourceValue, ISQLight::luminousEfficacyOfASource, ISQLight::LuminousEfficacyOfASourceUnit, ISQLight::LuminousEfficacyOfASourceUnit::lengthPF, ISQLight::LuminousEfficacyOfASourceUnit::massPF, ISQLight::LuminousEfficacyOfASourceUnit::durationPF, ISQLight::LuminousEfficacyOfASourceUnit::luminousIntensityPF, ISQLight::LuminousEnergyValue, ISQLight::luminousEnergy, ISQLight::LuminousEnergyUnit, ISQLight::LuminousEnergyUnit::durationPF, ISQLight::LuminousEnergyUnit::luminousIntensityPF, ISQLight::LuminousFluxValue, ISQLight::luminousFlux, ISQLight::LuminousFluxUnit, ISQLight::LuminousFluxUnit::luminousIntensityPF, ISQLight::LuminanceValue, ISQLight::luminance, ISQLight::LuminanceUnit, ISQLight::LuminanceUnit::lengthPF, ISQLight::LuminanceUnit::luminousIntensityPF, ISQLight::IlluminanceValue, ISQLight::illuminance, ISQLight::IlluminanceUnit, ISQLight::IlluminanceUnit::lengthPF, ISQLight::IlluminanceUnit::luminousIntensityPF, ISQLight::LuminousExitanceValue, ISQLight::luminousExitance, ISQLight::LuminousExitanceUnit, ISQLight::LuminousExitanceUnit::lengthPF, ISQLight::LuminousExitanceUnit::luminousIntensityPF, ISQLight::LuminousExposureValue, ISQLight::luminousExposure, ISQLight::LuminousExposureUnit, ISQLight::LuminousExposureUnit::lengthPF, ISQLight::LuminousExposureUnit::durationPF, ISQLight::LuminousExposureUnit::luminousIntensityPF, ISQLight::PhotonNumberValue, ISQLight::photonNumber, ISQLight::photonEnergy, ISQLight::PhotonFluxValue, ISQLight::photonFlux, ISQLight::PhotonFluxUnit, ISQLight::PhotonFluxUnit::durationPF, ISQLight::PhotonIntensityValue, ISQLight::photonIntensity, ISQLight::PhotonIntensityUnit, ISQLight::PhotonIntensityUnit::durationPF, ISQLight::PhotonRadianceValue, ISQLight::photonRadiance, ISQLight::PhotonRadianceUnit, ISQLight::PhotonRadianceUnit::lengthPF, ISQLight::PhotonRadianceUnit::durationPF, ISQLight::PhotonIrradianceValue, ISQLight::photonIrradiance, ISQLight::PhotonIrradianceUnit, ISQLight::PhotonIrradianceUnit::lengthPF, ISQLight::PhotonIrradianceUnit::durationPF, ISQLight::PhotonExitanceValue, ISQLight::photonExitance, ISQLight::PhotonExitanceUnit, ISQLight::PhotonExitanceUnit::lengthPF, ISQLight::PhotonExitanceUnit::durationPF, ISQLight::PhotonExposureValue, ISQLight::photonExposure, ISQLight::PhotonExposureUnit, ISQLight::PhotonExposureUnit::lengthPF, ISQLight::TristimulusValuesForTheCie1931StandardColorimetricObserverValue, ISQLight::tristimulusValuesForTheCie1931StandardColorimetricObserver, ISQLight::TristimulusValuesForTheCie1931StandardColorimetricObserverUnit, ISQLight::TristimulusValuesForTheCie1931StandardColorimetricObserverUnit::lengthPF, ISQLight::TristimulusValuesForTheCie1931StandardColorimetricObserverUnit::luminousIntensityPF, ISQLight::TristimulusValuesForTheCie1964StandardColorimetricObserverValue, ISQLight::tristimulusValuesForTheCie1964StandardColorimetricObserver, ISQLight::TristimulusValuesForTheCie1964StandardColorimetricObserverUnit, ISQLight::TristimulusValuesForTheCie1964StandardColorimetricObserverUnit::lengthPF, ISQLight::TristimulusValuesForTheCie1964StandardColorimetricObserverUnit::luminousIntensityPF, ISQLight::CieColourMatchingFunctionsForTheCie1931StandardColorimetricObserverValue, ISQLight::cieColourMatchingFunctionsForTheCie1931StandardColorimetricObserver, ISQLight::CieColourMatchingFunctionsForTheCie1964StandardColorimetricObserverValue, ISQLight::cieColourMatchingFunctionsForTheCie1964StandardColorimetricObserver, ISQLight::ChromaticityCoordinatesInTheCie1931StandardColorimetricSystemValue, ISQLight::chromaticityCoordinatesInTheCie1931StandardColorimetricSystem, ISQLight::ChromaticityCoordinatesInTheCie1964StandardColorimetricSystemValue, ISQLight::chromaticityCoordinatesInTheCie1964StandardColorimetricSystem, ISQLight::colourTemperature, ISQLight::correlatedColourTemperature, ISQLight::EmissivityValue, ISQLight::emissivity, ISQLight::EmissivityAtASpecifiedWavelengthValue, ISQLight::emissivityAtASpecifiedWavelength, ISQLight::AbsorptanceValue, ISQLight::absorptance, ISQLight::LuminousAbsorptanceValue, ISQLight::luminousAbsorptance, ISQLight::ReflectanceValue, ISQLight::reflectance, ISQLight::LuminousReflectanceValue, ISQLight::luminousReflectance, ISQLight::TransmittanceValue, ISQLight::transmittance, ISQLight::LuminousTransmittanceValue, ISQLight::luminousTransmittance, ISQLight::TransmittanceOpticalDensityValue, ISQLight::transmittanceOpticalDensity, ISQLight::NapierianAbsorbanceValue, ISQLight::napierianAbsorbance, ISQLight::RadianceFactorValue, ISQLight::radianceFactor, ISQLight::LuminanceFactorValue, ISQLight::luminanceFactor, ISQLight::ReflectanceFactorValue, ISQLight::reflectanceFactor, ISQLight::LinearAttenuationCoefficientValue, ISQLight::linearAttenuationCoefficient, ISQLight::LinearAttenuationCoefficientUnit, ISQLight::LinearAttenuationCoefficientUnit::lengthPF, ISQLight::LinearAbsorptionCoefficientValue, ISQLight::linearAbsorptionCoefficient, ISQLight::LinearAbsorptionCoefficientUnit, ISQLight::LinearAbsorptionCoefficientUnit::lengthPF, ISQLight::MassAttenuationCoefficientValue, ISQLight::massAttenuationCoefficient, ISQLight::MassAttenuationCoefficientUnit, ISQLight::MassAttenuationCoefficientUnit::lengthPF, ISQLight::MassAttenuationCoefficientUnit::massPF, ISQLight::MassAbsorptionCoefficientValue, ISQLight::massAbsorptionCoefficient, ISQLight::MassAbsorptionCoefficientUnit, ISQLight::MassAbsorptionCoefficientUnit::lengthPF, ISQLight::MassAbsorptionCoefficientUnit::massPF, ISQLight::MolarAbsorptionCoefficientValue, ISQLight::molarAbsorptionCoefficient, ISQLight::MolarAbsorptionCoefficientUnit, ISQLight::MolarAbsorptionCoefficientUnit::lengthPF, ISQLight::MolarAbsorptionCoefficientUnit::amountOfSubstancePF]
license: EPL-2.0
---

# ISQLight

Verbatim SysML standard-library source from `sysml.library/Domain Libraries/Quantities and Units/ISQLight.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `ISQLight` — standard library package
- `ISQLight::SpeedOfLightInAMediumValue` — attribute def
- `ISQLight::speedOfLightInAMedium` — attribute
- `ISQLight::SpeedOfLightInAMediumUnit` — attribute def
- `ISQLight::SpeedOfLightInAMediumUnit::lengthPF` — attribute
- `ISQLight::SpeedOfLightInAMediumUnit::durationPF` — attribute
- `ISQLight::RefractiveIndexValue` — attribute def
- `ISQLight::refractiveIndex` — attribute
- `ISQLight::radiantEnergy` — attribute
- `ISQLight::SpectralRadiantEnergyValue` — attribute def
- `ISQLight::spectralRadiantEnergy` — attribute
- `ISQLight::SpectralRadiantEnergyUnit` — attribute def
- `ISQLight::SpectralRadiantEnergyUnit::lengthPF` — attribute
- `ISQLight::SpectralRadiantEnergyUnit::massPF` — attribute
- `ISQLight::SpectralRadiantEnergyUnit::durationPF` — attribute
- `ISQLight::RadiantEnergyDensityValue` — attribute def
- `ISQLight::radiantEnergyDensity` — attribute
- `ISQLight::RadiantEnergyDensityUnit` — attribute def
- `ISQLight::RadiantEnergyDensityUnit::lengthPF` — attribute
- `ISQLight::RadiantEnergyDensityUnit::massPF` — attribute
- `ISQLight::RadiantEnergyDensityUnit::durationPF` — attribute
- `ISQLight::SpectralRadiantEnergyDensityInTermsOfWavelengthValue` — attribute def
- `ISQLight::spectralRadiantEnergyDensityInTermsOfWavelength` — attribute
- `ISQLight::SpectralRadiantEnergyDensityInTermsOfWavelengthUnit` — attribute def
- `ISQLight::SpectralRadiantEnergyDensityInTermsOfWavelengthUnit::lengthPF` — attribute
- `ISQLight::SpectralRadiantEnergyDensityInTermsOfWavelengthUnit::massPF` — attribute
- `ISQLight::SpectralRadiantEnergyDensityInTermsOfWavelengthUnit::durationPF` — attribute
- `ISQLight::SpectralRadiantEnergyDensityInTermsOfWavenumberValue` — attribute def
- `ISQLight::spectralRadiantEnergyDensityInTermsOfWavenumber` — attribute
- `ISQLight::SpectralRadiantEnergyDensityInTermsOfWavenumberUnit` — attribute def
- `ISQLight::SpectralRadiantEnergyDensityInTermsOfWavenumberUnit::massPF` — attribute
- `ISQLight::SpectralRadiantEnergyDensityInTermsOfWavenumberUnit::durationPF` — attribute
- `ISQLight::RadiantFluxValue` — attribute def
- `ISQLight::radiantFlux` — attribute
- `ISQLight::RadiantFluxUnit` — attribute def
- `ISQLight::RadiantFluxUnit::lengthPF` — attribute
- `ISQLight::RadiantFluxUnit::massPF` — attribute
- `ISQLight::RadiantFluxUnit::durationPF` — attribute
- `ISQLight::SpectralRadiantFluxValue` — attribute def
- `ISQLight::spectralRadiantFlux` — attribute
- `ISQLight::SpectralRadiantFluxUnit` — attribute def
- `ISQLight::SpectralRadiantFluxUnit::lengthPF` — attribute
- `ISQLight::SpectralRadiantFluxUnit::massPF` — attribute
- `ISQLight::SpectralRadiantFluxUnit::durationPF` — attribute
- `ISQLight::RadiantIntensityValue` — attribute def
- `ISQLight::radiantIntensity` — attribute
- `ISQLight::RadiantIntensityUnit` — attribute def
- `ISQLight::RadiantIntensityUnit::lengthPF` — attribute
- `ISQLight::RadiantIntensityUnit::massPF` — attribute
- `ISQLight::RadiantIntensityUnit::durationPF` — attribute
- `ISQLight::SpectralRadiantIntensityValue` — attribute def
- `ISQLight::spectralRadiantIntensity` — attribute
- `ISQLight::SpectralRadiantIntensityUnit` — attribute def
- `ISQLight::SpectralRadiantIntensityUnit::lengthPF` — attribute
- `ISQLight::SpectralRadiantIntensityUnit::massPF` — attribute
- `ISQLight::SpectralRadiantIntensityUnit::durationPF` — attribute
- `ISQLight::RadianceValue` — attribute def
- `ISQLight::radiance` — attribute
- `ISQLight::RadianceUnit` — attribute def
- `ISQLight::RadianceUnit::massPF` — attribute
- `ISQLight::RadianceUnit::durationPF` — attribute
- `ISQLight::SpectralRadianceValue` — attribute def
- `ISQLight::spectralRadiance` — attribute
- `ISQLight::SpectralRadianceUnit` — attribute def
- `ISQLight::SpectralRadianceUnit::lengthPF` — attribute
- `ISQLight::SpectralRadianceUnit::massPF` — attribute
- `ISQLight::SpectralRadianceUnit::durationPF` — attribute
- `ISQLight::IrradianceValue` — attribute def
- `ISQLight::irradiance` — attribute
- `ISQLight::IrradianceUnit` — attribute def
- `ISQLight::IrradianceUnit::massPF` — attribute
- `ISQLight::IrradianceUnit::durationPF` — attribute
- `ISQLight::SpectralIrradianceValue` — attribute def
- `ISQLight::spectralIrradiance` — attribute
- `ISQLight::SpectralIrradianceUnit` — attribute def
- `ISQLight::SpectralIrradianceUnit::lengthPF` — attribute
- `ISQLight::SpectralIrradianceUnit::massPF` — attribute
- `ISQLight::SpectralIrradianceUnit::durationPF` — attribute
- `ISQLight::RadiantExitanceValue` — attribute def
- `ISQLight::radiantExitance` — attribute
- `ISQLight::RadiantExitanceUnit` — attribute def
- `ISQLight::RadiantExitanceUnit::massPF` — attribute
- `ISQLight::RadiantExitanceUnit::durationPF` — attribute
- `ISQLight::SpectralRadiantExitanceValue` — attribute def
- `ISQLight::spectralRadiantExitance` — attribute
- `ISQLight::SpectralRadiantExitanceUnit` — attribute def
- `ISQLight::SpectralRadiantExitanceUnit::lengthPF` — attribute
- `ISQLight::SpectralRadiantExitanceUnit::massPF` — attribute
- `ISQLight::SpectralRadiantExitanceUnit::durationPF` — attribute
- `ISQLight::RadiantExposureValue` — attribute def
- `ISQLight::radiantExposure` — attribute
- `ISQLight::RadiantExposureUnit` — attribute def
- `ISQLight::RadiantExposureUnit::massPF` — attribute
- `ISQLight::RadiantExposureUnit::durationPF` — attribute
- `ISQLight::SpectralRadiantExposureValue` — attribute def
- `ISQLight::spectralRadiantExposure` — attribute
- `ISQLight::SpectralRadiantExposureUnit` — attribute def
- `ISQLight::SpectralRadiantExposureUnit::lengthPF` — attribute
- `ISQLight::SpectralRadiantExposureUnit::massPF` — attribute
- `ISQLight::SpectralRadiantExposureUnit::durationPF` — attribute
- `ISQLight::LuminousEfficiencyValue` — attribute def
- `ISQLight::luminousEfficiency` — attribute
- `ISQLight::SpectralLuminousEfficiencyValue` — attribute def
- `ISQLight::spectralLuminousEfficiency` — attribute
- `ISQLight::LuminousEfficacyOfRadiationValue` — attribute def
- `ISQLight::luminousEfficacyOfRadiation` — attribute
- `ISQLight::LuminousEfficacyOfRadiationUnit` — attribute def
- `ISQLight::LuminousEfficacyOfRadiationUnit::lengthPF` — attribute
- `ISQLight::LuminousEfficacyOfRadiationUnit::massPF` — attribute
- `ISQLight::LuminousEfficacyOfRadiationUnit::durationPF` — attribute
- `ISQLight::LuminousEfficacyOfRadiationUnit::luminousIntensityPF` — attribute
- `ISQLight::SpectralLuminousEfficacyValue` — attribute def
- `ISQLight::spectralLuminousEfficacy` — attribute
- `ISQLight::SpectralLuminousEfficacyUnit` — attribute def
- `ISQLight::SpectralLuminousEfficacyUnit::lengthPF` — attribute
- `ISQLight::SpectralLuminousEfficacyUnit::massPF` — attribute
- `ISQLight::SpectralLuminousEfficacyUnit::durationPF` — attribute
- `ISQLight::SpectralLuminousEfficacyUnit::luminousIntensityPF` — attribute
- `ISQLight::MaximumLuminousEfficacyValue` — attribute def
- `ISQLight::maximumLuminousEfficacy` — attribute
- `ISQLight::MaximumLuminousEfficacyUnit` — attribute def
- `ISQLight::MaximumLuminousEfficacyUnit::lengthPF` — attribute
- `ISQLight::MaximumLuminousEfficacyUnit::massPF` — attribute
- `ISQLight::MaximumLuminousEfficacyUnit::durationPF` — attribute
- `ISQLight::MaximumLuminousEfficacyUnit::luminousIntensityPF` — attribute
- `ISQLight::LuminousEfficacyOfASourceValue` — attribute def
- `ISQLight::luminousEfficacyOfASource` — attribute
- `ISQLight::LuminousEfficacyOfASourceUnit` — attribute def
- `ISQLight::LuminousEfficacyOfASourceUnit::lengthPF` — attribute
- `ISQLight::LuminousEfficacyOfASourceUnit::massPF` — attribute
- `ISQLight::LuminousEfficacyOfASourceUnit::durationPF` — attribute
- `ISQLight::LuminousEfficacyOfASourceUnit::luminousIntensityPF` — attribute
- `ISQLight::LuminousEnergyValue` — attribute def
- `ISQLight::luminousEnergy` — attribute
- `ISQLight::LuminousEnergyUnit` — attribute def
- `ISQLight::LuminousEnergyUnit::durationPF` — attribute
- `ISQLight::LuminousEnergyUnit::luminousIntensityPF` — attribute
- `ISQLight::LuminousFluxValue` — attribute def
- `ISQLight::luminousFlux` — attribute
- `ISQLight::LuminousFluxUnit` — attribute def
- `ISQLight::LuminousFluxUnit::luminousIntensityPF` — attribute
- `ISQLight::LuminanceValue` — attribute def
- `ISQLight::luminance` — attribute
- `ISQLight::LuminanceUnit` — attribute def
- `ISQLight::LuminanceUnit::lengthPF` — attribute
- `ISQLight::LuminanceUnit::luminousIntensityPF` — attribute
- `ISQLight::IlluminanceValue` — attribute def
- `ISQLight::illuminance` — attribute
- `ISQLight::IlluminanceUnit` — attribute def
- `ISQLight::IlluminanceUnit::lengthPF` — attribute
- `ISQLight::IlluminanceUnit::luminousIntensityPF` — attribute
- `ISQLight::LuminousExitanceValue` — attribute def
- `ISQLight::luminousExitance` — attribute
- `ISQLight::LuminousExitanceUnit` — attribute def
- `ISQLight::LuminousExitanceUnit::lengthPF` — attribute
- `ISQLight::LuminousExitanceUnit::luminousIntensityPF` — attribute
- `ISQLight::LuminousExposureValue` — attribute def
- `ISQLight::luminousExposure` — attribute
- `ISQLight::LuminousExposureUnit` — attribute def
- `ISQLight::LuminousExposureUnit::lengthPF` — attribute
- `ISQLight::LuminousExposureUnit::durationPF` — attribute
- `ISQLight::LuminousExposureUnit::luminousIntensityPF` — attribute
- `ISQLight::PhotonNumberValue` — attribute def
- `ISQLight::photonNumber` — attribute
- `ISQLight::photonEnergy` — attribute
- `ISQLight::PhotonFluxValue` — attribute def
- `ISQLight::photonFlux` — attribute
- `ISQLight::PhotonFluxUnit` — attribute def
- `ISQLight::PhotonFluxUnit::durationPF` — attribute
- `ISQLight::PhotonIntensityValue` — attribute def
- `ISQLight::photonIntensity` — attribute
- `ISQLight::PhotonIntensityUnit` — attribute def
- `ISQLight::PhotonIntensityUnit::durationPF` — attribute
- `ISQLight::PhotonRadianceValue` — attribute def
- `ISQLight::photonRadiance` — attribute
- `ISQLight::PhotonRadianceUnit` — attribute def
- `ISQLight::PhotonRadianceUnit::lengthPF` — attribute
- `ISQLight::PhotonRadianceUnit::durationPF` — attribute
- `ISQLight::PhotonIrradianceValue` — attribute def
- `ISQLight::photonIrradiance` — attribute
- `ISQLight::PhotonIrradianceUnit` — attribute def
- `ISQLight::PhotonIrradianceUnit::lengthPF` — attribute
- `ISQLight::PhotonIrradianceUnit::durationPF` — attribute
- `ISQLight::PhotonExitanceValue` — attribute def
- `ISQLight::photonExitance` — attribute
- `ISQLight::PhotonExitanceUnit` — attribute def
- `ISQLight::PhotonExitanceUnit::lengthPF` — attribute
- `ISQLight::PhotonExitanceUnit::durationPF` — attribute
- `ISQLight::PhotonExposureValue` — attribute def
- `ISQLight::photonExposure` — attribute
- `ISQLight::PhotonExposureUnit` — attribute def
- `ISQLight::PhotonExposureUnit::lengthPF` — attribute
- `ISQLight::TristimulusValuesForTheCie1931StandardColorimetricObserverValue` — attribute def
- `ISQLight::tristimulusValuesForTheCie1931StandardColorimetricObserver` — attribute
- `ISQLight::TristimulusValuesForTheCie1931StandardColorimetricObserverUnit` — attribute def
- `ISQLight::TristimulusValuesForTheCie1931StandardColorimetricObserverUnit::lengthPF` — attribute
- `ISQLight::TristimulusValuesForTheCie1931StandardColorimetricObserverUnit::luminousIntensityPF` — attribute
- `ISQLight::TristimulusValuesForTheCie1964StandardColorimetricObserverValue` — attribute def
- `ISQLight::tristimulusValuesForTheCie1964StandardColorimetricObserver` — attribute
- `ISQLight::TristimulusValuesForTheCie1964StandardColorimetricObserverUnit` — attribute def
- `ISQLight::TristimulusValuesForTheCie1964StandardColorimetricObserverUnit::lengthPF` — attribute
- `ISQLight::TristimulusValuesForTheCie1964StandardColorimetricObserverUnit::luminousIntensityPF` — attribute
- `ISQLight::CieColourMatchingFunctionsForTheCie1931StandardColorimetricObserverValue` — attribute def
- `ISQLight::cieColourMatchingFunctionsForTheCie1931StandardColorimetricObserver` — attribute
- `ISQLight::CieColourMatchingFunctionsForTheCie1964StandardColorimetricObserverValue` — attribute def
- `ISQLight::cieColourMatchingFunctionsForTheCie1964StandardColorimetricObserver` — attribute
- `ISQLight::ChromaticityCoordinatesInTheCie1931StandardColorimetricSystemValue` — attribute def
- `ISQLight::chromaticityCoordinatesInTheCie1931StandardColorimetricSystem` — attribute
- `ISQLight::ChromaticityCoordinatesInTheCie1964StandardColorimetricSystemValue` — attribute def
- `ISQLight::chromaticityCoordinatesInTheCie1964StandardColorimetricSystem` — attribute
- `ISQLight::colourTemperature` — attribute
- `ISQLight::correlatedColourTemperature` — attribute
- `ISQLight::EmissivityValue` — attribute def
- `ISQLight::emissivity` — attribute
- `ISQLight::EmissivityAtASpecifiedWavelengthValue` — attribute def
- `ISQLight::emissivityAtASpecifiedWavelength` — attribute
- `ISQLight::AbsorptanceValue` — attribute def
- `ISQLight::absorptance` — attribute
- `ISQLight::LuminousAbsorptanceValue` — attribute def
- `ISQLight::luminousAbsorptance` — attribute
- `ISQLight::ReflectanceValue` — attribute def
- `ISQLight::reflectance` — attribute
- `ISQLight::LuminousReflectanceValue` — attribute def
- `ISQLight::luminousReflectance` — attribute
- `ISQLight::TransmittanceValue` — attribute def
- `ISQLight::transmittance` — attribute
- `ISQLight::LuminousTransmittanceValue` — attribute def
- `ISQLight::luminousTransmittance` — attribute
- `ISQLight::TransmittanceOpticalDensityValue` — attribute def
- `ISQLight::transmittanceOpticalDensity` — attribute
- `ISQLight::NapierianAbsorbanceValue` — attribute def
- `ISQLight::napierianAbsorbance` — attribute
- `ISQLight::RadianceFactorValue` — attribute def
- `ISQLight::radianceFactor` — attribute
- `ISQLight::LuminanceFactorValue` — attribute def
- `ISQLight::luminanceFactor` — attribute
- `ISQLight::ReflectanceFactorValue` — attribute def
- `ISQLight::reflectanceFactor` — attribute
- `ISQLight::LinearAttenuationCoefficientValue` — attribute def
- `ISQLight::linearAttenuationCoefficient` — attribute
- `ISQLight::LinearAttenuationCoefficientUnit` — attribute def
- `ISQLight::LinearAttenuationCoefficientUnit::lengthPF` — attribute
- `ISQLight::LinearAbsorptionCoefficientValue` — attribute def
- `ISQLight::linearAbsorptionCoefficient` — attribute
- `ISQLight::LinearAbsorptionCoefficientUnit` — attribute def
- `ISQLight::LinearAbsorptionCoefficientUnit::lengthPF` — attribute
- `ISQLight::MassAttenuationCoefficientValue` — attribute def
- `ISQLight::massAttenuationCoefficient` — attribute
- `ISQLight::MassAttenuationCoefficientUnit` — attribute def
- `ISQLight::MassAttenuationCoefficientUnit::lengthPF` — attribute
- `ISQLight::MassAttenuationCoefficientUnit::massPF` — attribute
- `ISQLight::MassAbsorptionCoefficientValue` — attribute def
- `ISQLight::massAbsorptionCoefficient` — attribute
- `ISQLight::MassAbsorptionCoefficientUnit` — attribute def
- `ISQLight::MassAbsorptionCoefficientUnit::lengthPF` — attribute
- `ISQLight::MassAbsorptionCoefficientUnit::massPF` — attribute
- `ISQLight::MolarAbsorptionCoefficientValue` — attribute def
- `ISQLight::molarAbsorptionCoefficient` — attribute
- `ISQLight::MolarAbsorptionCoefficientUnit` — attribute def
- `ISQLight::MolarAbsorptionCoefficientUnit::lengthPF` — attribute
- `ISQLight::MolarAbsorptionCoefficientUnit::amountOfSubstancePF` — attribute
