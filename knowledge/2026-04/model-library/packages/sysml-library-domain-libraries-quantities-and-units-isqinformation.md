...
language: SysML
source: sysml.library/Domain Libraries/Quantities and Units/ISQInformation.sysml
declares: [ISQInformation, ISQInformation::TrafficIntensityValue, ISQInformation::trafficIntensity, ISQInformation::TrafficIntensityUnit, ISQInformation::TrafficOfferedIntensityValue, ISQInformation::trafficOfferedIntensity, ISQInformation::TrafficOfferedIntensityUnit, ISQInformation::TrafficCarriedIntensityValue, ISQInformation::trafficCarriedIntensity, ISQInformation::TrafficCarriedIntensityUnit, ISQInformation::MeanQueueLengthValue, ISQInformation::meanQueueLength, ISQInformation::LossProbabilityValue, ISQInformation::lossProbability, ISQInformation::WaitingProbabilityValue, ISQInformation::waitingProbability, ISQInformation::CallIntensityValue, ISQInformation::callIntensity, ISQInformation::CallIntensityUnit, ISQInformation::CallIntensityUnit::durationPF, ISQInformation::CompletedCallIntensityValue, ISQInformation::completedCallIntensity, ISQInformation::CompletedCallIntensityUnit, ISQInformation::CompletedCallIntensityUnit::durationPF, ISQInformation::StorageCapacityValue, ISQInformation::storageCapacity, ISQInformation::StorageCapacityUnit, ISQInformation::EquivalentBinaryStorageCapacityValue, ISQInformation::equivalentBinaryStorageCapacity, ISQInformation::EquivalentBinaryStorageCapacityUnit, ISQInformation::TransferRateValue, ISQInformation::transferRate, ISQInformation::TransferRateUnit, ISQInformation::TransferRateUnit::durationPF, ISQInformation::periodOfDataElements, ISQInformation::BinaryDigitRateValue, ISQInformation::binaryDigitRate, ISQInformation::BinaryDigitRateUnit, ISQInformation::BinaryDigitRateUnit::durationPF, ISQInformation::periodOfBinaryDigits, ISQInformation::EquivalentBinaryDigitRateValue, ISQInformation::equivalentBinaryDigitRate, ISQInformation::EquivalentBinaryDigitRateUnit, ISQInformation::EquivalentBinaryDigitRateUnit::durationPF, ISQInformation::ModulationRateValue, ISQInformation::modulationRate, ISQInformation::ModulationRateUnit, ISQInformation::ModulationRateUnit::durationPF, ISQInformation::quantizingDistortionRate, ISQInformation::carrierPower, ISQInformation::signalEnergyPerBinaryDigit, ISQInformation::ErrorProbabilityValue, ISQInformation::errorProbability, ISQInformation::hammingDistance, ISQInformation::clockFrequency, ISQInformation::DecisionContentValue, ISQInformation::decisionContent, ISQInformation::InformationContentValue, ISQInformation::informationContent, ISQInformation::InformationContentUnit, ISQInformation::EntropyForInformationScienceValue, ISQInformation::entropyForInformationScience, ISQInformation::EntropyForInformationScienceUnit, ISQInformation::MaximumEntropyValue, ISQInformation::maximumEntropy, ISQInformation::MaximumEntropyUnit, ISQInformation::RelativeEntropyValue, ISQInformation::relativeEntropy, ISQInformation::RedundancyValue, ISQInformation::redundancy, ISQInformation::RedundancyUnit, ISQInformation::RelativeRedundancyValue, ISQInformation::relativeRedundancy, ISQInformation::JointInformationContentValue, ISQInformation::jointInformationContent, ISQInformation::JointInformationContentUnit, ISQInformation::ConditionalInformationContentValue, ISQInformation::conditionalInformationContent, ISQInformation::ConditionalInformationContentUnit, ISQInformation::ConditionalEntropyValue, ISQInformation::conditionalEntropy, ISQInformation::ConditionalEntropyUnit, ISQInformation::EquivocationValue, ISQInformation::equivocation, ISQInformation::EquivocationUnit, ISQInformation::IrrelevanceValue, ISQInformation::irrelevance, ISQInformation::IrrelevanceUnit, ISQInformation::TransinformationContentValue, ISQInformation::transinformationContent, ISQInformation::TransinformationContentUnit, ISQInformation::MeanTransinformationContentValue, ISQInformation::meanTransinformationContent, ISQInformation::MeanTransinformationContentUnit, ISQInformation::CharacterMeanEntropyValue, ISQInformation::characterMeanEntropy, ISQInformation::CharacterMeanEntropyUnit, ISQInformation::AverageInformationRateValue, ISQInformation::averageInformationRate, ISQInformation::AverageInformationRateUnit, ISQInformation::AverageInformationRateUnit::durationPF, ISQInformation::CharacterMeanTransinformationContentValue, ISQInformation::characterMeanTransinformationContent, ISQInformation::CharacterMeanTransinformationContentUnit, ISQInformation::AverageTransinformationRateValue, ISQInformation::averageTransinformationRate, ISQInformation::AverageTransinformationRateUnit, ISQInformation::AverageTransinformationRateUnit::durationPF, ISQInformation::ChannelCapacityPerCharacterValue, ISQInformation::channelCapacityPerCharacter, ISQInformation::ChannelCapacityPerCharacterUnit, ISQInformation::ChannelTimeCapacityValue, ISQInformation::channelTimeCapacity, ISQInformation::ChannelTimeCapacityUnit, ISQInformation::ChannelTimeCapacityUnit::durationPF]
license: EPL-2.0
---

# ISQInformation

Verbatim SysML standard-library source from `sysml.library/Domain Libraries/Quantities and Units/ISQInformation.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `ISQInformation` — standard library package
- `ISQInformation::TrafficIntensityValue` — attribute def
- `ISQInformation::trafficIntensity` — attribute
- `ISQInformation::TrafficIntensityUnit` — attribute def
- `ISQInformation::TrafficOfferedIntensityValue` — attribute def
- `ISQInformation::trafficOfferedIntensity` — attribute
- `ISQInformation::TrafficOfferedIntensityUnit` — attribute def
- `ISQInformation::TrafficCarriedIntensityValue` — attribute def
- `ISQInformation::trafficCarriedIntensity` — attribute
- `ISQInformation::TrafficCarriedIntensityUnit` — attribute def
- `ISQInformation::MeanQueueLengthValue` — attribute def
- `ISQInformation::meanQueueLength` — attribute
- `ISQInformation::LossProbabilityValue` — attribute def
- `ISQInformation::lossProbability` — attribute
- `ISQInformation::WaitingProbabilityValue` — attribute def
- `ISQInformation::waitingProbability` — attribute
- `ISQInformation::CallIntensityValue` — attribute def
- `ISQInformation::callIntensity` — attribute
- `ISQInformation::CallIntensityUnit` — attribute def
- `ISQInformation::CallIntensityUnit::durationPF` — attribute
- `ISQInformation::CompletedCallIntensityValue` — attribute def
- `ISQInformation::completedCallIntensity` — attribute
- `ISQInformation::CompletedCallIntensityUnit` — attribute def
- `ISQInformation::CompletedCallIntensityUnit::durationPF` — attribute
- `ISQInformation::StorageCapacityValue` — attribute def
- `ISQInformation::storageCapacity` — attribute
- `ISQInformation::StorageCapacityUnit` — attribute def
- `ISQInformation::EquivalentBinaryStorageCapacityValue` — attribute def
- `ISQInformation::equivalentBinaryStorageCapacity` — attribute
- `ISQInformation::EquivalentBinaryStorageCapacityUnit` — attribute def
- `ISQInformation::TransferRateValue` — attribute def
- `ISQInformation::transferRate` — attribute
- `ISQInformation::TransferRateUnit` — attribute def
- `ISQInformation::TransferRateUnit::durationPF` — attribute
- `ISQInformation::periodOfDataElements` — attribute
- `ISQInformation::BinaryDigitRateValue` — attribute def
- `ISQInformation::binaryDigitRate` — attribute
- `ISQInformation::BinaryDigitRateUnit` — attribute def
- `ISQInformation::BinaryDigitRateUnit::durationPF` — attribute
- `ISQInformation::periodOfBinaryDigits` — attribute
- `ISQInformation::EquivalentBinaryDigitRateValue` — attribute def
- `ISQInformation::equivalentBinaryDigitRate` — attribute
- `ISQInformation::EquivalentBinaryDigitRateUnit` — attribute def
- `ISQInformation::EquivalentBinaryDigitRateUnit::durationPF` — attribute
- `ISQInformation::ModulationRateValue` — attribute def
- `ISQInformation::modulationRate` — attribute
- `ISQInformation::ModulationRateUnit` — attribute def
- `ISQInformation::ModulationRateUnit::durationPF` — attribute
- `ISQInformation::quantizingDistortionRate` — attribute
- `ISQInformation::carrierPower` — attribute
- `ISQInformation::signalEnergyPerBinaryDigit` — attribute
- `ISQInformation::ErrorProbabilityValue` — attribute def
- `ISQInformation::errorProbability` — attribute
- `ISQInformation::hammingDistance` — attribute
- `ISQInformation::clockFrequency` — attribute
- `ISQInformation::DecisionContentValue` — attribute def
- `ISQInformation::decisionContent` — attribute
- `ISQInformation::InformationContentValue` — attribute def
- `ISQInformation::informationContent` — attribute
- `ISQInformation::InformationContentUnit` — attribute def
- `ISQInformation::EntropyForInformationScienceValue` — attribute def
- `ISQInformation::entropyForInformationScience` — attribute
- `ISQInformation::EntropyForInformationScienceUnit` — attribute def
- `ISQInformation::MaximumEntropyValue` — attribute def
- `ISQInformation::maximumEntropy` — attribute
- `ISQInformation::MaximumEntropyUnit` — attribute def
- `ISQInformation::RelativeEntropyValue` — attribute def
- `ISQInformation::relativeEntropy` — attribute
- `ISQInformation::RedundancyValue` — attribute def
- `ISQInformation::redundancy` — attribute
- `ISQInformation::RedundancyUnit` — attribute def
- `ISQInformation::RelativeRedundancyValue` — attribute def
- `ISQInformation::relativeRedundancy` — attribute
- `ISQInformation::JointInformationContentValue` — attribute def
- `ISQInformation::jointInformationContent` — attribute
- `ISQInformation::JointInformationContentUnit` — attribute def
- `ISQInformation::ConditionalInformationContentValue` — attribute def
- `ISQInformation::conditionalInformationContent` — attribute
- `ISQInformation::ConditionalInformationContentUnit` — attribute def
- `ISQInformation::ConditionalEntropyValue` — attribute def
- `ISQInformation::conditionalEntropy` — attribute
- `ISQInformation::ConditionalEntropyUnit` — attribute def
- `ISQInformation::EquivocationValue` — attribute def
- `ISQInformation::equivocation` — attribute
- `ISQInformation::EquivocationUnit` — attribute def
- `ISQInformation::IrrelevanceValue` — attribute def
- `ISQInformation::irrelevance` — attribute
- `ISQInformation::IrrelevanceUnit` — attribute def
- `ISQInformation::TransinformationContentValue` — attribute def
- `ISQInformation::transinformationContent` — attribute
- `ISQInformation::TransinformationContentUnit` — attribute def
- `ISQInformation::MeanTransinformationContentValue` — attribute def
- `ISQInformation::meanTransinformationContent` — attribute
- `ISQInformation::MeanTransinformationContentUnit` — attribute def
- `ISQInformation::CharacterMeanEntropyValue` — attribute def
- `ISQInformation::characterMeanEntropy` — attribute
- `ISQInformation::CharacterMeanEntropyUnit` — attribute def
- `ISQInformation::AverageInformationRateValue` — attribute def
- `ISQInformation::averageInformationRate` — attribute
- `ISQInformation::AverageInformationRateUnit` — attribute def
- `ISQInformation::AverageInformationRateUnit::durationPF` — attribute
- `ISQInformation::CharacterMeanTransinformationContentValue` — attribute def
- `ISQInformation::characterMeanTransinformationContent` — attribute
- `ISQInformation::CharacterMeanTransinformationContentUnit` — attribute def
- `ISQInformation::AverageTransinformationRateValue` — attribute def
- `ISQInformation::averageTransinformationRate` — attribute
- `ISQInformation::AverageTransinformationRateUnit` — attribute def
- `ISQInformation::AverageTransinformationRateUnit::durationPF` — attribute
- `ISQInformation::ChannelCapacityPerCharacterValue` — attribute def
- `ISQInformation::channelCapacityPerCharacter` — attribute
- `ISQInformation::ChannelCapacityPerCharacterUnit` — attribute def
- `ISQInformation::ChannelTimeCapacityValue` — attribute def
- `ISQInformation::channelTimeCapacity` — attribute
- `ISQInformation::ChannelTimeCapacityUnit` — attribute def
- `ISQInformation::ChannelTimeCapacityUnit::durationPF` — attribute
