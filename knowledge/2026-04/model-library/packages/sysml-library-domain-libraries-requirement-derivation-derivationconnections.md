---
name: DerivationConnections
kind: model-library-file
language: SysML
source: sysml.library/Domain Libraries/Requirement Derivation/DerivationConnections.sysml
declares: [DerivationConnections, DerivationConnections::originalRequirements, DerivationConnections::derivedRequirements, DerivationConnections::Derivation, DerivationConnections::Derivation::originalRequirement, DerivationConnections::Derivation::originalNotDerived, DerivationConnections::Derivation::originalImpliesDerived, DerivationConnections::derivations]
license: EPL-2.0
---

# DerivationConnections

Verbatim SysML standard-library source from `sysml.library/Domain Libraries/Requirement Derivation/DerivationConnections.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `DerivationConnections` — standard library package
- `DerivationConnections::originalRequirements` — requirement
- `DerivationConnections::derivedRequirements` — requirement
- `DerivationConnections::Derivation` — connection def
- `DerivationConnections::Derivation::originalRequirement` — requirement
- `DerivationConnections::Derivation::originalNotDerived` — assert constraint
- `DerivationConnections::Derivation::originalImpliesDerived` — assert constraint
- `DerivationConnections::derivations` — connection
