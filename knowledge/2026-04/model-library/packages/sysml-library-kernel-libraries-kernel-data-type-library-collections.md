...
language: KerML
source: sysml.library/Kernel Libraries/Kernel Data Type Library/Collections.kerml
declares: [Collections, Collections::Collection, Collections::Collection::elements, Collections::OrderedCollection, Collections::OrderedCollection::elements, Collections::UniqueCollection, Collections::UniqueCollection::elements, Collections::Array, Collections::Array::dimensions, Collections::Array::rank, Collections::Array::flattenedSize, Collections::Bag, Collections::Set, Collections::OrderedSet, Collections::OrderedSet::elements, Collections::List, Collections::KeyValuePair, Collections::KeyValuePair::key, Collections::KeyValuePair::val, Collections::Map, Collections::Map::elements, Collections::OrderedMap, Collections::OrderedMap::elements]
license: EPL-2.0
---

# Collections

Verbatim KerML standard-library source from `sysml.library/Kernel Libraries/Kernel Data Type Library/Collections.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `Collections` — standard library package
- `Collections::Collection` — datatype
- `Collections::Collection::elements` — feature
- `Collections::OrderedCollection` — datatype
- `Collections::OrderedCollection::elements` — feature
- `Collections::UniqueCollection` — datatype
- `Collections::UniqueCollection::elements` — feature
- `Collections::Array` — datatype
- `Collections::Array::dimensions` — feature
- `Collections::Array::rank` — feature
- `Collections::Array::flattenedSize` — feature
- `Collections::Bag` — datatype
- `Collections::Set` — datatype
- `Collections::OrderedSet` — datatype
- `Collections::OrderedSet::elements` — feature
- `Collections::List` — datatype
- `Collections::KeyValuePair` — datatype
- `Collections::KeyValuePair::key` — feature
- `Collections::KeyValuePair::val` — feature
- `Collections::Map` — datatype
- `Collections::Map::elements` — feature
- `Collections::OrderedMap` — datatype
- `Collections::OrderedMap::elements` — feature
