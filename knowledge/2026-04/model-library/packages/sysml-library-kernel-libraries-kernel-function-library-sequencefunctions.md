...
language: KerML
source: sysml.library/Kernel Libraries/Kernel Function Library/SequenceFunctions.kerml
declares: [SequenceFunctions, SequenceFunctions::#, SequenceFunctions::equals, SequenceFunctions::same, SequenceFunctions::size, SequenceFunctions::isEmpty, SequenceFunctions::notEmpty, SequenceFunctions::includes, SequenceFunctions::includesOnly, SequenceFunctions::excludes, SequenceFunctions::union, SequenceFunctions::intersection, SequenceFunctions::including, SequenceFunctions::includingAt, SequenceFunctions::excluding, SequenceFunctions::excludingAt, SequenceFunctions::subsequence, SequenceFunctions::head, SequenceFunctions::tail, SequenceFunctions::last, SequenceFunctions::add, SequenceFunctions::add::newSeq, SequenceFunctions::addAt, SequenceFunctions::addAt::newSeq, SequenceFunctions::remove, SequenceFunctions::remove::newSeq, SequenceFunctions::removeAt, SequenceFunctions::removeAt::newSeq]
license: EPL-2.0
---

# SequenceFunctions

Verbatim KerML standard-library source from `sysml.library/Kernel Libraries/Kernel Function Library/SequenceFunctions.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `SequenceFunctions` — standard library package
- `SequenceFunctions::#` — function
- `SequenceFunctions::equals` — function
- `SequenceFunctions::same` — function
- `SequenceFunctions::size` — function
- `SequenceFunctions::isEmpty` — function
- `SequenceFunctions::notEmpty` — function
- `SequenceFunctions::includes` — function
- `SequenceFunctions::includesOnly` — function
- `SequenceFunctions::excludes` — function
- `SequenceFunctions::union` — function
- `SequenceFunctions::intersection` — function
- `SequenceFunctions::including` — function
- `SequenceFunctions::includingAt` — function
- `SequenceFunctions::excluding` — function
- `SequenceFunctions::excludingAt` — function
- `SequenceFunctions::subsequence` — function
- `SequenceFunctions::head` — function
- `SequenceFunctions::tail` — function
- `SequenceFunctions::last` — function
- `SequenceFunctions::add` — behavior
- `SequenceFunctions::add::newSeq` — feature
- `SequenceFunctions::addAt` — behavior
- `SequenceFunctions::addAt::newSeq` — feature
- `SequenceFunctions::remove` — behavior
- `SequenceFunctions::remove::newSeq` — feature
- `SequenceFunctions::removeAt` — behavior
- `SequenceFunctions::removeAt::newSeq` — feature
