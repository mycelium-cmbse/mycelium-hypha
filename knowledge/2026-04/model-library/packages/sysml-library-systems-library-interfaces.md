...
language: SysML
source: sysml.library/Systems Library/Interfaces.sysml
declares: [Interfaces, Interfaces::excludingOnce, Interfaces::excludingOnce::position, Interfaces::Interface, Interfaces::BinaryInterface, Interfaces::BinaryInterface::source, Interfaces::BinaryInterface::target, Interfaces::interfaces, Interfaces::binaryInterfaces]
license: EPL-2.0
---

# Interfaces

Verbatim SysML standard-library source from `sysml.library/Systems Library/Interfaces.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `Interfaces` — standard library package
- `Interfaces::excludingOnce` — calc def
- `Interfaces::excludingOnce::position` — attribute
- `Interfaces::Interface` — interface def
- `Interfaces::BinaryInterface` — interface def
- `Interfaces::BinaryInterface::source` — port
- `Interfaces::BinaryInterface::target` — port
- `Interfaces::interfaces` — interface
- `Interfaces::binaryInterfaces` — interface
