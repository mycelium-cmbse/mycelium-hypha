...
language: KerML
source: sysml.library/Kernel Libraries/Kernel Semantic Library/Base.kerml
declares: [Base, Base::Anything, Base::Anything::self, Base::DataValue, Base::DataValue::self, Base::things, Base::things::that, Base::dataValues, Base::naturals]
license: EPL-2.0
---

# Base

Verbatim KerML standard-library source from `sysml.library/Kernel Libraries/Kernel Semantic Library/Base.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `Base` — standard library package
- `Base::Anything` — classifier
- `Base::Anything::self` — feature
- `Base::DataValue` — datatype
- `Base::DataValue::self` — feature
- `Base::things` — feature
- `Base::things::that` — feature
- `Base::dataValues` — feature
- `Base::naturals` — feature
