---
name: ISQChemistryMolecular
kind: model-library-file
language: SysML
source: sysml.library/Domain Libraries/Quantities and Units/ISQChemistryMolecular.sysml
declares: [ISQChemistryMolecular, ISQChemistryMolecular::numberOfEntities, ISQChemistryMolecular::RelativeAtomicMassValue, ISQChemistryMolecular::relativeAtomicMass, ISQChemistryMolecular::MolarMassValue, ISQChemistryMolecular::molarMass, ISQChemistryMolecular::MolarMassUnit, ISQChemistryMolecular::MolarMassUnit::massPF, ISQChemistryMolecular::MolarMassUnit::amountOfSubstancePF, ISQChemistryMolecular::MolarVolumeValue, ISQChemistryMolecular::molarVolume, ISQChemistryMolecular::MolarVolumeUnit, ISQChemistryMolecular::MolarVolumeUnit::lengthPF, ISQChemistryMolecular::MolarVolumeUnit::amountOfSubstancePF, ISQChemistryMolecular::MolarInternalEnergyValue, ISQChemistryMolecular::molarInternalEnergy, ISQChemistryMolecular::MolarInternalEnergyUnit, ISQChemistryMolecular::MolarInternalEnergyUnit::lengthPF, ISQChemistryMolecular::MolarInternalEnergyUnit::massPF, ISQChemistryMolecular::MolarInternalEnergyUnit::durationPF, ISQChemistryMolecular::MolarInternalEnergyUnit::amountOfSubstancePF, ISQChemistryMolecular::MolarEnthalpyValue, ISQChemistryMolecular::molarEnthalpy, ISQChemistryMolecular::MolarEnthalpyUnit, ISQChemistryMolecular::MolarEnthalpyUnit::lengthPF, ISQChemistryMolecular::MolarEnthalpyUnit::massPF, ISQChemistryMolecular::MolarEnthalpyUnit::durationPF, ISQChemistryMolecular::MolarEnthalpyUnit::amountOfSubstancePF, ISQChemistryMolecular::MolarHelmholtzEnergyValue, ISQChemistryMolecular::molarHelmholtzEnergy, ISQChemistryMolecular::MolarHelmholtzEnergyUnit, ISQChemistryMolecular::MolarHelmholtzEnergyUnit::lengthPF, ISQChemistryMolecular::MolarHelmholtzEnergyUnit::massPF, ISQChemistryMolecular::MolarHelmholtzEnergyUnit::durationPF, ISQChemistryMolecular::MolarHelmholtzEnergyUnit::amountOfSubstancePF, ISQChemistryMolecular::MolarGibbsEnergyValue, ISQChemistryMolecular::molarGibbsEnergy, ISQChemistryMolecular::MolarGibbsEnergyUnit, ISQChemistryMolecular::MolarGibbsEnergyUnit::lengthPF, ISQChemistryMolecular::MolarGibbsEnergyUnit::massPF, ISQChemistryMolecular::MolarGibbsEnergyUnit::durationPF, ISQChemistryMolecular::MolarGibbsEnergyUnit::amountOfSubstancePF, ISQChemistryMolecular::MolarHeatCapacityValue, ISQChemistryMolecular::molarHeatCapacity, ISQChemistryMolecular::MolarHeatCapacityUnit, ISQChemistryMolecular::MolarHeatCapacityUnit::lengthPF, ISQChemistryMolecular::MolarHeatCapacityUnit::massPF, ISQChemistryMolecular::MolarHeatCapacityUnit::durationPF, ISQChemistryMolecular::MolarHeatCapacityUnit::thermodynamicTemperaturePF, ISQChemistryMolecular::MolarHeatCapacityUnit::amountOfSubstancePF, ISQChemistryMolecular::MolarEntropyValue, ISQChemistryMolecular::molarEntropy, ISQChemistryMolecular::MolarEntropyUnit, ISQChemistryMolecular::MolarEntropyUnit::lengthPF, ISQChemistryMolecular::MolarEntropyUnit::massPF, ISQChemistryMolecular::MolarEntropyUnit::durationPF, ISQChemistryMolecular::MolarEntropyUnit::thermodynamicTemperaturePF, ISQChemistryMolecular::MolarEntropyUnit::amountOfSubstancePF, ISQChemistryMolecular::ParticleConcentrationValue, ISQChemistryMolecular::particleConcentration, ISQChemistryMolecular::ParticleConcentrationUnit, ISQChemistryMolecular::ParticleConcentrationUnit::lengthPF, ISQChemistryMolecular::molecularConcentration, ISQChemistryMolecular::MassConcentrationValue, ISQChemistryMolecular::massConcentration, ISQChemistryMolecular::MassConcentrationUnit, ISQChemistryMolecular::MassConcentrationUnit::lengthPF, ISQChemistryMolecular::MassConcentrationUnit::massPF, ISQChemistryMolecular::MassFractionValue, ISQChemistryMolecular::massFraction, ISQChemistryMolecular::AmountOfSubstanceConcentrationValue, ISQChemistryMolecular::amountOfSubstanceConcentration, ISQChemistryMolecular::AmountOfSubstanceConcentrationUnit, ISQChemistryMolecular::AmountOfSubstanceConcentrationUnit::lengthPF, ISQChemistryMolecular::AmountOfSubstanceConcentrationUnit::amountOfSubstancePF, ISQChemistryMolecular::standardAmountOfSubstanceConcentration, ISQChemistryMolecular::AmountOfSubstanceFractionMoleFractionValue, ISQChemistryMolecular::amountOfSubstanceFractionMoleFraction, ISQChemistryMolecular::VolumeFractionValue, ISQChemistryMolecular::volumeFraction, ISQChemistryMolecular::VolumeFractionUnit, ISQChemistryMolecular::MolalityValue, ISQChemistryMolecular::molality, ISQChemistryMolecular::MolalityUnit, ISQChemistryMolecular::MolalityUnit::massPF, ISQChemistryMolecular::MolalityUnit::amountOfSubstancePF, ISQChemistryMolecular::latentHeatOfPhaseTransition, ISQChemistryMolecular::ChemicalPotentialValue, ISQChemistryMolecular::chemicalPotential, ISQChemistryMolecular::ChemicalPotentialUnit, ISQChemistryMolecular::ChemicalPotentialUnit::lengthPF, ISQChemistryMolecular::ChemicalPotentialUnit::massPF, ISQChemistryMolecular::ChemicalPotentialUnit::durationPF, ISQChemistryMolecular::ChemicalPotentialUnit::amountOfSubstancePF, ISQChemistryMolecular::AbsoluteActivityValue, ISQChemistryMolecular::absoluteActivity, ISQChemistryMolecular::PartialPressureValue, ISQChemistryMolecular::partialPressure, ISQChemistryMolecular::PartialPressureUnit, ISQChemistryMolecular::PartialPressureUnit::lengthPF, ISQChemistryMolecular::PartialPressureUnit::massPF, ISQChemistryMolecular::PartialPressureUnit::durationPF, ISQChemistryMolecular::FugacityValue, ISQChemistryMolecular::fugacity, ISQChemistryMolecular::FugacityUnit, ISQChemistryMolecular::FugacityUnit::lengthPF, ISQChemistryMolecular::FugacityUnit::massPF, ISQChemistryMolecular::FugacityUnit::durationPF, ISQChemistryMolecular::StandardChemicalPotentialValue, ISQChemistryMolecular::standardChemicalPotential, ISQChemistryMolecular::StandardChemicalPotentialUnit, ISQChemistryMolecular::StandardChemicalPotentialUnit::lengthPF, ISQChemistryMolecular::StandardChemicalPotentialUnit::massPF, ISQChemistryMolecular::StandardChemicalPotentialUnit::durationPF, ISQChemistryMolecular::StandardChemicalPotentialUnit::amountOfSubstancePF, ISQChemistryMolecular::ActivityFactorValue, ISQChemistryMolecular::activityFactor, ISQChemistryMolecular::StandardAbsoluteActivityInMixtureValue, ISQChemistryMolecular::standardAbsoluteActivityInMixture, ISQChemistryMolecular::ActivityOfSoluteValue, ISQChemistryMolecular::activityOfSolute, ISQChemistryMolecular::ActivityCoefficientValue, ISQChemistryMolecular::activityCoefficient, ISQChemistryMolecular::StandardAbsoluteActivityInSolutionValue, ISQChemistryMolecular::standardAbsoluteActivityInSolution, ISQChemistryMolecular::ActivityOfSolventValue, ISQChemistryMolecular::activityOfSolvent, ISQChemistryMolecular::OsmoticFactorOfSolventValue, ISQChemistryMolecular::osmoticFactorOfSolvent, ISQChemistryMolecular::StandardAbsoluteActivityOfSolventValue, ISQChemistryMolecular::standardAbsoluteActivityOfSolvent, ISQChemistryMolecular::OsmoticPressureValue, ISQChemistryMolecular::osmoticPressure, ISQChemistryMolecular::OsmoticPressureUnit, ISQChemistryMolecular::OsmoticPressureUnit::lengthPF, ISQChemistryMolecular::OsmoticPressureUnit::massPF, ISQChemistryMolecular::OsmoticPressureUnit::durationPF, ISQChemistryMolecular::StoichiometricNumberOfSubstanceValue, ISQChemistryMolecular::stoichiometricNumberOfSubstance, ISQChemistryMolecular::AffinityOfAChemicalReactionValue, ISQChemistryMolecular::affinityOfAChemicalReaction, ISQChemistryMolecular::AffinityOfAChemicalReactionUnit, ISQChemistryMolecular::AffinityOfAChemicalReactionUnit::lengthPF, ISQChemistryMolecular::AffinityOfAChemicalReactionUnit::massPF, ISQChemistryMolecular::AffinityOfAChemicalReactionUnit::durationPF, ISQChemistryMolecular::AffinityOfAChemicalReactionUnit::amountOfSubstancePF, ISQChemistryMolecular::extentOfReaction, ISQChemistryMolecular::StandardEquilibriumConstantValue, ISQChemistryMolecular::standardEquilibriumConstant, ISQChemistryMolecular::EquilibriumConstantOnPressureBasisValue, ISQChemistryMolecular::equilibriumConstantOnPressureBasis, ISQChemistryMolecular::EquilibriumConstantOnPressureBasisUnit, ISQChemistryMolecular::EquilibriumConstantOnPressureBasisUnit::lengthPF, ISQChemistryMolecular::EquilibriumConstantOnPressureBasisUnit::massPF, ISQChemistryMolecular::EquilibriumConstantOnPressureBasisUnit::durationPF, ISQChemistryMolecular::EquilibriumConstantOnConcentrationBasisValue, ISQChemistryMolecular::equilibriumConstantOnConcentrationBasis, ISQChemistryMolecular::EquilibriumConstantOnConcentrationBasisUnit, ISQChemistryMolecular::EquilibriumConstantOnConcentrationBasisUnit::lengthPF, ISQChemistryMolecular::EquilibriumConstantOnConcentrationBasisUnit::amountOfSubstancePF, ISQChemistryMolecular::microcanonicalPartitionFunction, ISQChemistryMolecular::CanonicalPartitionFunctionValue, ISQChemistryMolecular::canonicalPartitionFunction, ISQChemistryMolecular::GrandCanonicalPartitionFunctionValue, ISQChemistryMolecular::grandCanonicalPartitionFunction, ISQChemistryMolecular::MolecularPartitionFunctionValue, ISQChemistryMolecular::molecularPartitionFunction, ISQChemistryMolecular::statisticalWeightOfSubsystem, ISQChemistryMolecular::DegeneracyValue, ISQChemistryMolecular::degeneracy, ISQChemistryMolecular::MolarGasConstantValue, ISQChemistryMolecular::molarGasConstant, ISQChemistryMolecular::MolarGasConstantUnit, ISQChemistryMolecular::MolarGasConstantUnit::lengthPF, ISQChemistryMolecular::MolarGasConstantUnit::massPF, ISQChemistryMolecular::MolarGasConstantUnit::durationPF, ISQChemistryMolecular::MolarGasConstantUnit::thermodynamicTemperaturePF, ISQChemistryMolecular::MolarGasConstantUnit::amountOfSubstancePF, ISQChemistryMolecular::meanFreePath, ISQChemistryMolecular::DiffusionCoefficientValue, ISQChemistryMolecular::diffusionCoefficient, ISQChemistryMolecular::DiffusionCoefficientUnit, ISQChemistryMolecular::DiffusionCoefficientUnit::lengthPF, ISQChemistryMolecular::DiffusionCoefficientUnit::durationPF, ISQChemistryMolecular::ThermalDiffusionRatioValue, ISQChemistryMolecular::thermalDiffusionRatio, ISQChemistryMolecular::ThermalDiffusionFactorValue, ISQChemistryMolecular::thermalDiffusionFactor, ISQChemistryMolecular::ThermalDiffusionCoefficientValue, ISQChemistryMolecular::thermalDiffusionCoefficient, ISQChemistryMolecular::ThermalDiffusionCoefficientUnit, ISQChemistryMolecular::ThermalDiffusionCoefficientUnit::lengthPF, ISQChemistryMolecular::ThermalDiffusionCoefficientUnit::durationPF, ISQChemistryMolecular::IonicStrengthValue, ISQChemistryMolecular::ionicStrength, ISQChemistryMolecular::IonicStrengthUnit, ISQChemistryMolecular::IonicStrengthUnit::massPF, ISQChemistryMolecular::IonicStrengthUnit::amountOfSubstancePF, ISQChemistryMolecular::DegreeOfDissociationValue, ISQChemistryMolecular::degreeOfDissociation, ISQChemistryMolecular::ElectrolyticConductivityValue, ISQChemistryMolecular::electrolyticConductivity, ISQChemistryMolecular::ElectrolyticConductivityUnit, ISQChemistryMolecular::ElectrolyticConductivityUnit::lengthPF, ISQChemistryMolecular::ElectrolyticConductivityUnit::massPF, ISQChemistryMolecular::ElectrolyticConductivityUnit::durationPF, ISQChemistryMolecular::ElectrolyticConductivityUnit::electricCurrentPF, ISQChemistryMolecular::MolarConductivityValue, ISQChemistryMolecular::molarConductivity, ISQChemistryMolecular::MolarConductivityUnit, ISQChemistryMolecular::MolarConductivityUnit::massPF, ISQChemistryMolecular::MolarConductivityUnit::durationPF, ISQChemistryMolecular::MolarConductivityUnit::electricCurrentPF, ISQChemistryMolecular::MolarConductivityUnit::amountOfSubstancePF, ISQChemistryMolecular::TransportNumberOfTheIonBValue, ISQChemistryMolecular::transportNumberOfTheIonB, ISQChemistryMolecular::angleOfOpticalRotation, ISQChemistryMolecular::MolarOpticalRotatoryPowerValue, ISQChemistryMolecular::molarOpticalRotatoryPower, ISQChemistryMolecular::MolarOpticalRotatoryPowerUnit, ISQChemistryMolecular::MolarOpticalRotatoryPowerUnit::lengthPF, ISQChemistryMolecular::MolarOpticalRotatoryPowerUnit::amountOfSubstancePF, ISQChemistryMolecular::SpecificOpticalRotatoryPowerValue, ISQChemistryMolecular::specificOpticalRotatoryPower, ISQChemistryMolecular::SpecificOpticalRotatoryPowerUnit, ISQChemistryMolecular::SpecificOpticalRotatoryPowerUnit::lengthPF, ISQChemistryMolecular::SpecificOpticalRotatoryPowerUnit::massPF]
license: EPL-2.0
---

# ISQChemistryMolecular

Verbatim SysML standard-library source from `sysml.library/Domain Libraries/Quantities and Units/ISQChemistryMolecular.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `ISQChemistryMolecular` — standard library package
- `ISQChemistryMolecular::numberOfEntities` — attribute
- `ISQChemistryMolecular::RelativeAtomicMassValue` — attribute def
- `ISQChemistryMolecular::relativeAtomicMass` — attribute
- `ISQChemistryMolecular::MolarMassValue` — attribute def
- `ISQChemistryMolecular::molarMass` — attribute
- `ISQChemistryMolecular::MolarMassUnit` — attribute def
- `ISQChemistryMolecular::MolarMassUnit::massPF` — attribute
- `ISQChemistryMolecular::MolarMassUnit::amountOfSubstancePF` — attribute
- `ISQChemistryMolecular::MolarVolumeValue` — attribute def
- `ISQChemistryMolecular::molarVolume` — attribute
- `ISQChemistryMolecular::MolarVolumeUnit` — attribute def
- `ISQChemistryMolecular::MolarVolumeUnit::lengthPF` — attribute
- `ISQChemistryMolecular::MolarVolumeUnit::amountOfSubstancePF` — attribute
- `ISQChemistryMolecular::MolarInternalEnergyValue` — attribute def
- `ISQChemistryMolecular::molarInternalEnergy` — attribute
- `ISQChemistryMolecular::MolarInternalEnergyUnit` — attribute def
- `ISQChemistryMolecular::MolarInternalEnergyUnit::lengthPF` — attribute
- `ISQChemistryMolecular::MolarInternalEnergyUnit::massPF` — attribute
- `ISQChemistryMolecular::MolarInternalEnergyUnit::durationPF` — attribute
- `ISQChemistryMolecular::MolarInternalEnergyUnit::amountOfSubstancePF` — attribute
- `ISQChemistryMolecular::MolarEnthalpyValue` — attribute def
- `ISQChemistryMolecular::molarEnthalpy` — attribute
- `ISQChemistryMolecular::MolarEnthalpyUnit` — attribute def
- `ISQChemistryMolecular::MolarEnthalpyUnit::lengthPF` — attribute
- `ISQChemistryMolecular::MolarEnthalpyUnit::massPF` — attribute
- `ISQChemistryMolecular::MolarEnthalpyUnit::durationPF` — attribute
- `ISQChemistryMolecular::MolarEnthalpyUnit::amountOfSubstancePF` — attribute
- `ISQChemistryMolecular::MolarHelmholtzEnergyValue` — attribute def
- `ISQChemistryMolecular::molarHelmholtzEnergy` — attribute
- `ISQChemistryMolecular::MolarHelmholtzEnergyUnit` — attribute def
- `ISQChemistryMolecular::MolarHelmholtzEnergyUnit::lengthPF` — attribute
- `ISQChemistryMolecular::MolarHelmholtzEnergyUnit::massPF` — attribute
- `ISQChemistryMolecular::MolarHelmholtzEnergyUnit::durationPF` — attribute
- `ISQChemistryMolecular::MolarHelmholtzEnergyUnit::amountOfSubstancePF` — attribute
- `ISQChemistryMolecular::MolarGibbsEnergyValue` — attribute def
- `ISQChemistryMolecular::molarGibbsEnergy` — attribute
- `ISQChemistryMolecular::MolarGibbsEnergyUnit` — attribute def
- `ISQChemistryMolecular::MolarGibbsEnergyUnit::lengthPF` — attribute
- `ISQChemistryMolecular::MolarGibbsEnergyUnit::massPF` — attribute
- `ISQChemistryMolecular::MolarGibbsEnergyUnit::durationPF` — attribute
- `ISQChemistryMolecular::MolarGibbsEnergyUnit::amountOfSubstancePF` — attribute
- `ISQChemistryMolecular::MolarHeatCapacityValue` — attribute def
- `ISQChemistryMolecular::molarHeatCapacity` — attribute
- `ISQChemistryMolecular::MolarHeatCapacityUnit` — attribute def
- `ISQChemistryMolecular::MolarHeatCapacityUnit::lengthPF` — attribute
- `ISQChemistryMolecular::MolarHeatCapacityUnit::massPF` — attribute
- `ISQChemistryMolecular::MolarHeatCapacityUnit::durationPF` — attribute
- `ISQChemistryMolecular::MolarHeatCapacityUnit::thermodynamicTemperaturePF` — attribute
- `ISQChemistryMolecular::MolarHeatCapacityUnit::amountOfSubstancePF` — attribute
- `ISQChemistryMolecular::MolarEntropyValue` — attribute def
- `ISQChemistryMolecular::molarEntropy` — attribute
- `ISQChemistryMolecular::MolarEntropyUnit` — attribute def
- `ISQChemistryMolecular::MolarEntropyUnit::lengthPF` — attribute
- `ISQChemistryMolecular::MolarEntropyUnit::massPF` — attribute
- `ISQChemistryMolecular::MolarEntropyUnit::durationPF` — attribute
- `ISQChemistryMolecular::MolarEntropyUnit::thermodynamicTemperaturePF` — attribute
- `ISQChemistryMolecular::MolarEntropyUnit::amountOfSubstancePF` — attribute
- `ISQChemistryMolecular::ParticleConcentrationValue` — attribute def
- `ISQChemistryMolecular::particleConcentration` — attribute
- `ISQChemistryMolecular::ParticleConcentrationUnit` — attribute def
- `ISQChemistryMolecular::ParticleConcentrationUnit::lengthPF` — attribute
- `ISQChemistryMolecular::molecularConcentration` — attribute
- `ISQChemistryMolecular::MassConcentrationValue` — attribute def
- `ISQChemistryMolecular::massConcentration` — attribute
- `ISQChemistryMolecular::MassConcentrationUnit` — attribute def
- `ISQChemistryMolecular::MassConcentrationUnit::lengthPF` — attribute
- `ISQChemistryMolecular::MassConcentrationUnit::massPF` — attribute
- `ISQChemistryMolecular::MassFractionValue` — attribute def
- `ISQChemistryMolecular::massFraction` — attribute
- `ISQChemistryMolecular::AmountOfSubstanceConcentrationValue` — attribute def
- `ISQChemistryMolecular::amountOfSubstanceConcentration` — attribute
- `ISQChemistryMolecular::AmountOfSubstanceConcentrationUnit` — attribute def
- `ISQChemistryMolecular::AmountOfSubstanceConcentrationUnit::lengthPF` — attribute
- `ISQChemistryMolecular::AmountOfSubstanceConcentrationUnit::amountOfSubstancePF` — attribute
- `ISQChemistryMolecular::standardAmountOfSubstanceConcentration` — attribute
- `ISQChemistryMolecular::AmountOfSubstanceFractionMoleFractionValue` — attribute def
- `ISQChemistryMolecular::amountOfSubstanceFractionMoleFraction` — attribute
- `ISQChemistryMolecular::VolumeFractionValue` — attribute def
- `ISQChemistryMolecular::volumeFraction` — attribute
- `ISQChemistryMolecular::VolumeFractionUnit` — attribute def
- `ISQChemistryMolecular::MolalityValue` — attribute def
- `ISQChemistryMolecular::molality` — attribute
- `ISQChemistryMolecular::MolalityUnit` — attribute def
- `ISQChemistryMolecular::MolalityUnit::massPF` — attribute
- `ISQChemistryMolecular::MolalityUnit::amountOfSubstancePF` — attribute
- `ISQChemistryMolecular::latentHeatOfPhaseTransition` — attribute
- `ISQChemistryMolecular::ChemicalPotentialValue` — attribute def
- `ISQChemistryMolecular::chemicalPotential` — attribute
- `ISQChemistryMolecular::ChemicalPotentialUnit` — attribute def
- `ISQChemistryMolecular::ChemicalPotentialUnit::lengthPF` — attribute
- `ISQChemistryMolecular::ChemicalPotentialUnit::massPF` — attribute
- `ISQChemistryMolecular::ChemicalPotentialUnit::durationPF` — attribute
- `ISQChemistryMolecular::ChemicalPotentialUnit::amountOfSubstancePF` — attribute
- `ISQChemistryMolecular::AbsoluteActivityValue` — attribute def
- `ISQChemistryMolecular::absoluteActivity` — attribute
- `ISQChemistryMolecular::PartialPressureValue` — attribute def
- `ISQChemistryMolecular::partialPressure` — attribute
- `ISQChemistryMolecular::PartialPressureUnit` — attribute def
- `ISQChemistryMolecular::PartialPressureUnit::lengthPF` — attribute
- `ISQChemistryMolecular::PartialPressureUnit::massPF` — attribute
- `ISQChemistryMolecular::PartialPressureUnit::durationPF` — attribute
- `ISQChemistryMolecular::FugacityValue` — attribute def
- `ISQChemistryMolecular::fugacity` — attribute
- `ISQChemistryMolecular::FugacityUnit` — attribute def
- `ISQChemistryMolecular::FugacityUnit::lengthPF` — attribute
- `ISQChemistryMolecular::FugacityUnit::massPF` — attribute
- `ISQChemistryMolecular::FugacityUnit::durationPF` — attribute
- `ISQChemistryMolecular::StandardChemicalPotentialValue` — attribute def
- `ISQChemistryMolecular::standardChemicalPotential` — attribute
- `ISQChemistryMolecular::StandardChemicalPotentialUnit` — attribute def
- `ISQChemistryMolecular::StandardChemicalPotentialUnit::lengthPF` — attribute
- `ISQChemistryMolecular::StandardChemicalPotentialUnit::massPF` — attribute
- `ISQChemistryMolecular::StandardChemicalPotentialUnit::durationPF` — attribute
- `ISQChemistryMolecular::StandardChemicalPotentialUnit::amountOfSubstancePF` — attribute
- `ISQChemistryMolecular::ActivityFactorValue` — attribute def
- `ISQChemistryMolecular::activityFactor` — attribute
- `ISQChemistryMolecular::StandardAbsoluteActivityInMixtureValue` — attribute def
- `ISQChemistryMolecular::standardAbsoluteActivityInMixture` — attribute
- `ISQChemistryMolecular::ActivityOfSoluteValue` — attribute def
- `ISQChemistryMolecular::activityOfSolute` — attribute
- `ISQChemistryMolecular::ActivityCoefficientValue` — attribute def
- `ISQChemistryMolecular::activityCoefficient` — attribute
- `ISQChemistryMolecular::StandardAbsoluteActivityInSolutionValue` — attribute def
- `ISQChemistryMolecular::standardAbsoluteActivityInSolution` — attribute
- `ISQChemistryMolecular::ActivityOfSolventValue` — attribute def
- `ISQChemistryMolecular::activityOfSolvent` — attribute
- `ISQChemistryMolecular::OsmoticFactorOfSolventValue` — attribute def
- `ISQChemistryMolecular::osmoticFactorOfSolvent` — attribute
- `ISQChemistryMolecular::StandardAbsoluteActivityOfSolventValue` — attribute def
- `ISQChemistryMolecular::standardAbsoluteActivityOfSolvent` — attribute
- `ISQChemistryMolecular::OsmoticPressureValue` — attribute def
- `ISQChemistryMolecular::osmoticPressure` — attribute
- `ISQChemistryMolecular::OsmoticPressureUnit` — attribute def
- `ISQChemistryMolecular::OsmoticPressureUnit::lengthPF` — attribute
- `ISQChemistryMolecular::OsmoticPressureUnit::massPF` — attribute
- `ISQChemistryMolecular::OsmoticPressureUnit::durationPF` — attribute
- `ISQChemistryMolecular::StoichiometricNumberOfSubstanceValue` — attribute def
- `ISQChemistryMolecular::stoichiometricNumberOfSubstance` — attribute
- `ISQChemistryMolecular::AffinityOfAChemicalReactionValue` — attribute def
- `ISQChemistryMolecular::affinityOfAChemicalReaction` — attribute
- `ISQChemistryMolecular::AffinityOfAChemicalReactionUnit` — attribute def
- `ISQChemistryMolecular::AffinityOfAChemicalReactionUnit::lengthPF` — attribute
- `ISQChemistryMolecular::AffinityOfAChemicalReactionUnit::massPF` — attribute
- `ISQChemistryMolecular::AffinityOfAChemicalReactionUnit::durationPF` — attribute
- `ISQChemistryMolecular::AffinityOfAChemicalReactionUnit::amountOfSubstancePF` — attribute
- `ISQChemistryMolecular::extentOfReaction` — attribute
- `ISQChemistryMolecular::StandardEquilibriumConstantValue` — attribute def
- `ISQChemistryMolecular::standardEquilibriumConstant` — attribute
- `ISQChemistryMolecular::EquilibriumConstantOnPressureBasisValue` — attribute def
- `ISQChemistryMolecular::equilibriumConstantOnPressureBasis` — attribute
- `ISQChemistryMolecular::EquilibriumConstantOnPressureBasisUnit` — attribute def
- `ISQChemistryMolecular::EquilibriumConstantOnPressureBasisUnit::lengthPF` — attribute
- `ISQChemistryMolecular::EquilibriumConstantOnPressureBasisUnit::massPF` — attribute
- `ISQChemistryMolecular::EquilibriumConstantOnPressureBasisUnit::durationPF` — attribute
- `ISQChemistryMolecular::EquilibriumConstantOnConcentrationBasisValue` — attribute def
- `ISQChemistryMolecular::equilibriumConstantOnConcentrationBasis` — attribute
- `ISQChemistryMolecular::EquilibriumConstantOnConcentrationBasisUnit` — attribute def
- `ISQChemistryMolecular::EquilibriumConstantOnConcentrationBasisUnit::lengthPF` — attribute
- `ISQChemistryMolecular::EquilibriumConstantOnConcentrationBasisUnit::amountOfSubstancePF` — attribute
- `ISQChemistryMolecular::microcanonicalPartitionFunction` — attribute
- `ISQChemistryMolecular::CanonicalPartitionFunctionValue` — attribute def
- `ISQChemistryMolecular::canonicalPartitionFunction` — attribute
- `ISQChemistryMolecular::GrandCanonicalPartitionFunctionValue` — attribute def
- `ISQChemistryMolecular::grandCanonicalPartitionFunction` — attribute
- `ISQChemistryMolecular::MolecularPartitionFunctionValue` — attribute def
- `ISQChemistryMolecular::molecularPartitionFunction` — attribute
- `ISQChemistryMolecular::statisticalWeightOfSubsystem` — attribute
- `ISQChemistryMolecular::DegeneracyValue` — attribute def
- `ISQChemistryMolecular::degeneracy` — attribute
- `ISQChemistryMolecular::MolarGasConstantValue` — attribute def
- `ISQChemistryMolecular::molarGasConstant` — attribute
- `ISQChemistryMolecular::MolarGasConstantUnit` — attribute def
- `ISQChemistryMolecular::MolarGasConstantUnit::lengthPF` — attribute
- `ISQChemistryMolecular::MolarGasConstantUnit::massPF` — attribute
- `ISQChemistryMolecular::MolarGasConstantUnit::durationPF` — attribute
- `ISQChemistryMolecular::MolarGasConstantUnit::thermodynamicTemperaturePF` — attribute
- `ISQChemistryMolecular::MolarGasConstantUnit::amountOfSubstancePF` — attribute
- `ISQChemistryMolecular::meanFreePath` — attribute
- `ISQChemistryMolecular::DiffusionCoefficientValue` — attribute def
- `ISQChemistryMolecular::diffusionCoefficient` — attribute
- `ISQChemistryMolecular::DiffusionCoefficientUnit` — attribute def
- `ISQChemistryMolecular::DiffusionCoefficientUnit::lengthPF` — attribute
- `ISQChemistryMolecular::DiffusionCoefficientUnit::durationPF` — attribute
- `ISQChemistryMolecular::ThermalDiffusionRatioValue` — attribute def
- `ISQChemistryMolecular::thermalDiffusionRatio` — attribute
- `ISQChemistryMolecular::ThermalDiffusionFactorValue` — attribute def
- `ISQChemistryMolecular::thermalDiffusionFactor` — attribute
- `ISQChemistryMolecular::ThermalDiffusionCoefficientValue` — attribute def
- `ISQChemistryMolecular::thermalDiffusionCoefficient` — attribute
- `ISQChemistryMolecular::ThermalDiffusionCoefficientUnit` — attribute def
- `ISQChemistryMolecular::ThermalDiffusionCoefficientUnit::lengthPF` — attribute
- `ISQChemistryMolecular::ThermalDiffusionCoefficientUnit::durationPF` — attribute
- `ISQChemistryMolecular::IonicStrengthValue` — attribute def
- `ISQChemistryMolecular::ionicStrength` — attribute
- `ISQChemistryMolecular::IonicStrengthUnit` — attribute def
- `ISQChemistryMolecular::IonicStrengthUnit::massPF` — attribute
- `ISQChemistryMolecular::IonicStrengthUnit::amountOfSubstancePF` — attribute
- `ISQChemistryMolecular::DegreeOfDissociationValue` — attribute def
- `ISQChemistryMolecular::degreeOfDissociation` — attribute
- `ISQChemistryMolecular::ElectrolyticConductivityValue` — attribute def
- `ISQChemistryMolecular::electrolyticConductivity` — attribute
- `ISQChemistryMolecular::ElectrolyticConductivityUnit` — attribute def
- `ISQChemistryMolecular::ElectrolyticConductivityUnit::lengthPF` — attribute
- `ISQChemistryMolecular::ElectrolyticConductivityUnit::massPF` — attribute
- `ISQChemistryMolecular::ElectrolyticConductivityUnit::durationPF` — attribute
- `ISQChemistryMolecular::ElectrolyticConductivityUnit::electricCurrentPF` — attribute
- `ISQChemistryMolecular::MolarConductivityValue` — attribute def
- `ISQChemistryMolecular::molarConductivity` — attribute
- `ISQChemistryMolecular::MolarConductivityUnit` — attribute def
- `ISQChemistryMolecular::MolarConductivityUnit::massPF` — attribute
- `ISQChemistryMolecular::MolarConductivityUnit::durationPF` — attribute
- `ISQChemistryMolecular::MolarConductivityUnit::electricCurrentPF` — attribute
- `ISQChemistryMolecular::MolarConductivityUnit::amountOfSubstancePF` — attribute
- `ISQChemistryMolecular::TransportNumberOfTheIonBValue` — attribute def
- `ISQChemistryMolecular::transportNumberOfTheIonB` — attribute
- `ISQChemistryMolecular::angleOfOpticalRotation` — attribute
- `ISQChemistryMolecular::MolarOpticalRotatoryPowerValue` — attribute def
- `ISQChemistryMolecular::molarOpticalRotatoryPower` — attribute
- `ISQChemistryMolecular::MolarOpticalRotatoryPowerUnit` — attribute def
- `ISQChemistryMolecular::MolarOpticalRotatoryPowerUnit::lengthPF` — attribute
- `ISQChemistryMolecular::MolarOpticalRotatoryPowerUnit::amountOfSubstancePF` — attribute
- `ISQChemistryMolecular::SpecificOpticalRotatoryPowerValue` — attribute def
- `ISQChemistryMolecular::specificOpticalRotatoryPower` — attribute
- `ISQChemistryMolecular::SpecificOpticalRotatoryPowerUnit` — attribute def
- `ISQChemistryMolecular::SpecificOpticalRotatoryPowerUnit::lengthPF` — attribute
- `ISQChemistryMolecular::SpecificOpticalRotatoryPowerUnit::massPF` — attribute
