---
name: MeasurementReferences
kind: model-library-file
language: SysML
source: sysml.library/Domain Libraries/Quantities and Units/MeasurementReferences.sysml
declares: [MeasurementReferences, MeasurementReferences::TensorMeasurementReference, MeasurementReferences::TensorMeasurementReference::isBound, MeasurementReferences::TensorMeasurementReference::order, MeasurementReferences::TensorMeasurementReference::mRefs, MeasurementReferences::TensorMeasurementReference::definitionalQuantityValues, MeasurementReferences::VectorMeasurementReference, MeasurementReferences::VectorMeasurementReference::isOrthogonal, MeasurementReferences::ScalarMeasurementReference, MeasurementReferences::ScalarMeasurementReference::quantityDimension, MeasurementReferences::CoordinateFrame, MeasurementReferences::CoordinateFrame::transformation, MeasurementReferences::3dCoordinateFrame, MeasurementReferences::CoordinateTransformation, MeasurementReferences::CoordinateTransformation::source, MeasurementReferences::CoordinateTransformation::target, MeasurementReferences::CoordinateTransformation::validSourceTargetDimensions, MeasurementReferences::CoordinateFramePlacement, MeasurementReferences::CoordinateFramePlacement::origin, MeasurementReferences::CoordinateFramePlacement::basisDirections, MeasurementReferences::CoordinateFramePlacement::validOriginDimensions, MeasurementReferences::CoordinateFramePlacement::validateBasisDirections, MeasurementReferences::TranslationOrRotation, MeasurementReferences::Translation, MeasurementReferences::Translation::translationVector, MeasurementReferences::Rotation, MeasurementReferences::Rotation::axisDirection, MeasurementReferences::Rotation::angle, MeasurementReferences::Rotation::isIntrinsic, MeasurementReferences::TranslationRotationSequence, MeasurementReferences::AffineTransformationMatrix3d, MeasurementReferences::AffineTransformationMatrix3d::rotationMatrix, MeasurementReferences::AffineTransformationMatrix3d::translationVector, MeasurementReferences::AffineTransformationMatrix3d::validSourceDimensions, MeasurementReferences::NullTransformation, MeasurementReferences::nullTransformation, MeasurementReferences::MeasurementUnit, MeasurementReferences::MeasurementUnit::unitPowerFactors, MeasurementReferences::MeasurementUnit::unitConversion, MeasurementReferences::MeasurementUnit::hasValidUnitPowerFactors, MeasurementReferences::SimpleUnit, MeasurementReferences::SimpleUnit::simpleUnitSelf, MeasurementReferences::SimpleUnit::unit, MeasurementReferences::SimpleUnit::exponent, MeasurementReferences::DerivedUnit, MeasurementReferences::UnitPowerFactor, MeasurementReferences::UnitPowerFactor::unit, MeasurementReferences::UnitPowerFactor::exponent, MeasurementReferences::UnitConversion, MeasurementReferences::UnitConversion::referenceUnit, MeasurementReferences::UnitConversion::conversionFactor, MeasurementReferences::UnitConversion::isExact, MeasurementReferences::ConversionByConvention, MeasurementReferences::ConversionByPrefix, MeasurementReferences::ConversionByPrefix::prefix, MeasurementReferences::ConversionByPrefix::conversionFactor, MeasurementReferences::UnitPrefix, MeasurementReferences::UnitPrefix::longName, MeasurementReferences::UnitPrefix::symbol, MeasurementReferences::UnitPrefix::conversionFactor, MeasurementReferences::MeasurementScale, MeasurementReferences::MeasurementScale::unit, MeasurementReferences::MeasurementScale::quantityValueMapping, MeasurementReferences::OrdinalScale, MeasurementReferences::IntervalScale, MeasurementReferences::CyclicRatioScale, MeasurementReferences::CyclicRatioScale::modulus, MeasurementReferences::LogarithmicScale, MeasurementReferences::LogarithmicScale::logarithmBase, MeasurementReferences::LogarithmicScale::factor, MeasurementReferences::LogarithmicScale::exponent, MeasurementReferences::LogarithmicScale::referenceQuantity, MeasurementReferences::QuantityValueMapping, MeasurementReferences::QuantityValueMapping::mappedQuantityValue, MeasurementReferences::QuantityValueMapping::referenceQuantityValue, MeasurementReferences::DefinitionalQuantityValue, MeasurementReferences::DefinitionalQuantityValue::num, MeasurementReferences::DefinitionalQuantityValue::definition, MeasurementReferences::DimensionOneUnit, MeasurementReferences::DimensionOneValue, MeasurementReferences::dimensionOneQuantities, MeasurementReferences::one, MeasurementReferences::CountValue, MeasurementReferences::countQuantities, MeasurementReferences::SystemOfUnits, MeasurementReferences::SystemOfUnits::longName, MeasurementReferences::SystemOfUnits::systemOfQuantities, MeasurementReferences::SystemOfUnits::baseUnits, MeasurementReferences::VerifyUnitPowerFactors]
license: EPL-2.0
---

# MeasurementReferences

Verbatim SysML standard-library source from `sysml.library/Domain Libraries/Quantities and Units/MeasurementReferences.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `MeasurementReferences` — standard library package
- `MeasurementReferences::TensorMeasurementReference` — attribute def
- `MeasurementReferences::TensorMeasurementReference::isBound` — attribute
- `MeasurementReferences::TensorMeasurementReference::order` — attribute
- `MeasurementReferences::TensorMeasurementReference::mRefs` — attribute
- `MeasurementReferences::TensorMeasurementReference::definitionalQuantityValues` — attribute
- `MeasurementReferences::VectorMeasurementReference` — attribute def
- `MeasurementReferences::VectorMeasurementReference::isOrthogonal` — attribute
- `MeasurementReferences::ScalarMeasurementReference` — attribute def
- `MeasurementReferences::ScalarMeasurementReference::quantityDimension` — attribute
- `MeasurementReferences::CoordinateFrame` — attribute def
- `MeasurementReferences::CoordinateFrame::transformation` — attribute
- `MeasurementReferences::3dCoordinateFrame` — attribute def
- `MeasurementReferences::CoordinateTransformation` — attribute def
- `MeasurementReferences::CoordinateTransformation::source` — attribute
- `MeasurementReferences::CoordinateTransformation::target` — attribute
- `MeasurementReferences::CoordinateTransformation::validSourceTargetDimensions` — assert constraint
- `MeasurementReferences::CoordinateFramePlacement` — attribute def
- `MeasurementReferences::CoordinateFramePlacement::origin` — attribute
- `MeasurementReferences::CoordinateFramePlacement::basisDirections` — attribute
- `MeasurementReferences::CoordinateFramePlacement::validOriginDimensions` — assert constraint
- `MeasurementReferences::CoordinateFramePlacement::validateBasisDirections` — assert constraint
- `MeasurementReferences::TranslationOrRotation` — attribute def
- `MeasurementReferences::Translation` — attribute def
- `MeasurementReferences::Translation::translationVector` — attribute
- `MeasurementReferences::Rotation` — attribute def
- `MeasurementReferences::Rotation::axisDirection` — attribute
- `MeasurementReferences::Rotation::angle` — attribute
- `MeasurementReferences::Rotation::isIntrinsic` — attribute
- `MeasurementReferences::TranslationRotationSequence` — attribute def
- `MeasurementReferences::AffineTransformationMatrix3d` — attribute def
- `MeasurementReferences::AffineTransformationMatrix3d::rotationMatrix` — attribute
- `MeasurementReferences::AffineTransformationMatrix3d::translationVector` — attribute
- `MeasurementReferences::AffineTransformationMatrix3d::validSourceDimensions` — assert constraint
- `MeasurementReferences::NullTransformation` — attribute def
- `MeasurementReferences::nullTransformation` — attribute
- `MeasurementReferences::MeasurementUnit` — attribute def
- `MeasurementReferences::MeasurementUnit::unitPowerFactors` — attribute
- `MeasurementReferences::MeasurementUnit::unitConversion` — attribute
- `MeasurementReferences::MeasurementUnit::hasValidUnitPowerFactors` — assert constraint
- `MeasurementReferences::SimpleUnit` — attribute def
- `MeasurementReferences::SimpleUnit::simpleUnitSelf` — attribute
- `MeasurementReferences::SimpleUnit::unit` — attribute
- `MeasurementReferences::SimpleUnit::exponent` — attribute
- `MeasurementReferences::DerivedUnit` — attribute def
- `MeasurementReferences::UnitPowerFactor` — attribute def
- `MeasurementReferences::UnitPowerFactor::unit` — attribute
- `MeasurementReferences::UnitPowerFactor::exponent` — attribute
- `MeasurementReferences::UnitConversion` — attribute def
- `MeasurementReferences::UnitConversion::referenceUnit` — attribute
- `MeasurementReferences::UnitConversion::conversionFactor` — attribute
- `MeasurementReferences::UnitConversion::isExact` — attribute
- `MeasurementReferences::ConversionByConvention` — attribute def
- `MeasurementReferences::ConversionByPrefix` — attribute def
- `MeasurementReferences::ConversionByPrefix::prefix` — attribute
- `MeasurementReferences::ConversionByPrefix::conversionFactor` — attribute
- `MeasurementReferences::UnitPrefix` — attribute def
- `MeasurementReferences::UnitPrefix::longName` — attribute
- `MeasurementReferences::UnitPrefix::symbol` — attribute
- `MeasurementReferences::UnitPrefix::conversionFactor` — attribute
- `MeasurementReferences::MeasurementScale` — attribute def
- `MeasurementReferences::MeasurementScale::unit` — attribute
- `MeasurementReferences::MeasurementScale::quantityValueMapping` — attribute
- `MeasurementReferences::OrdinalScale` — attribute def
- `MeasurementReferences::IntervalScale` — attribute def
- `MeasurementReferences::CyclicRatioScale` — attribute def
- `MeasurementReferences::CyclicRatioScale::modulus` — attribute
- `MeasurementReferences::LogarithmicScale` — attribute def
- `MeasurementReferences::LogarithmicScale::logarithmBase` — attribute
- `MeasurementReferences::LogarithmicScale::factor` — attribute
- `MeasurementReferences::LogarithmicScale::exponent` — attribute
- `MeasurementReferences::LogarithmicScale::referenceQuantity` — attribute
- `MeasurementReferences::QuantityValueMapping` — attribute def
- `MeasurementReferences::QuantityValueMapping::mappedQuantityValue` — attribute
- `MeasurementReferences::QuantityValueMapping::referenceQuantityValue` — attribute
- `MeasurementReferences::DefinitionalQuantityValue` — attribute def
- `MeasurementReferences::DefinitionalQuantityValue::num` — attribute
- `MeasurementReferences::DefinitionalQuantityValue::definition` — attribute
- `MeasurementReferences::DimensionOneUnit` — attribute def
- `MeasurementReferences::DimensionOneValue` — attribute def
- `MeasurementReferences::dimensionOneQuantities` — attribute
- `MeasurementReferences::one` — attribute
- `MeasurementReferences::CountValue` — attribute def
- `MeasurementReferences::countQuantities` — attribute
- `MeasurementReferences::SystemOfUnits` — attribute def
- `MeasurementReferences::SystemOfUnits::longName` — attribute
- `MeasurementReferences::SystemOfUnits::systemOfQuantities` — attribute
- `MeasurementReferences::SystemOfUnits::baseUnits` — attribute
- `MeasurementReferences::VerifyUnitPowerFactors` — constraint def
