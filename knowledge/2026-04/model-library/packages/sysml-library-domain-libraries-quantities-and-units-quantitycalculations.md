---
name: QuantityCalculations
kind: model-library-file
language: SysML
source: sysml.library/Domain Libraries/Quantities and Units/QuantityCalculations.sysml
declares: [QuantityCalculations, QuantityCalculations::[, QuantityCalculations::isZero, QuantityCalculations::isUnit, QuantityCalculations::abs, QuantityCalculations::+, QuantityCalculations::-, QuantityCalculations::*, QuantityCalculations::/, QuantityCalculations::**, QuantityCalculations::^, QuantityCalculations::<, QuantityCalculations::>, QuantityCalculations::<=, QuantityCalculations::>=, QuantityCalculations::max, QuantityCalculations::min, QuantityCalculations::==, QuantityCalculations::sqrt, QuantityCalculations::floor, QuantityCalculations::round, QuantityCalculations::ToString, QuantityCalculations::ToInteger, QuantityCalculations::ToRational, QuantityCalculations::ToReal, QuantityCalculations::ToDimensionOneValue, QuantityCalculations::sum, QuantityCalculations::sum::zero, QuantityCalculations::product, QuantityCalculations::product::one, QuantityCalculations::ConvertQuantity]
license: EPL-2.0
---

# QuantityCalculations

Verbatim SysML standard-library source from `sysml.library/Domain Libraries/Quantities and Units/QuantityCalculations.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `QuantityCalculations` — standard library package
- `QuantityCalculations::[` — calc def
- `QuantityCalculations::isZero` — calc def
- `QuantityCalculations::isUnit` — calc def
- `QuantityCalculations::abs` — calc def
- `QuantityCalculations::+` — calc def
- `QuantityCalculations::-` — calc def
- `QuantityCalculations::*` — calc def
- `QuantityCalculations::/` — calc def
...
- `QuantityCalculations::<=` — calc def
- `QuantityCalculations::>=` — calc def
- `QuantityCalculations::max` — calc def
- `QuantityCalculations::min` — calc def
- `QuantityCalculations::==` — calc def
- `QuantityCalculations::sqrt` — calc def
- `QuantityCalculations::floor` — calc def
- `QuantityCalculations::round` — calc def
- `QuantityCalculations::ToString` — calc def
- `QuantityCalculations::ToInteger` — calc def
- `QuantityCalculations::ToRational` — calc def
- `QuantityCalculations::ToReal` — calc def
- `QuantityCalculations::ToDimensionOneValue` — calc def
- `QuantityCalculations::sum` — calc def
- `QuantityCalculations::sum::zero` — attribute
- `QuantityCalculations::product` — calc def
- `QuantityCalculations::product::one` — attribute
- `QuantityCalculations::ConvertQuantity` — calc def
