...
language: KerML
source: sysml.library/Kernel Libraries/Kernel Semantic Library/Triggers.kerml
declares: [Triggers, Triggers::TimeSignal, Triggers::TimeSignal::signalTime, Triggers::TimeSignal::signalClock, Triggers::TriggerWhen, Triggers::TriggerWhen::condition, Triggers::TriggerWhen::receiver, Triggers::TriggerWhen::monitor, Triggers::TriggerWhen::changeSignal, Triggers::TriggerAt, Triggers::TriggerAt::timeInstant, Triggers::TriggerAt::receiver, Triggers::TriggerAt::clock, Triggers::TriggerAt::monitor, Triggers::TriggerAt::timeSignal, Triggers::TriggerAfter, Triggers::TriggerAfter::delay, Triggers::TriggerAfter::receiver, Triggers::TriggerAfter::clock, Triggers::TriggerAfter::monitor]
license: EPL-2.0
---

# Triggers

Verbatim KerML standard-library source from `sysml.library/Kernel Libraries/Kernel Semantic Library/Triggers.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `Triggers` — standard library package
- `Triggers::TimeSignal` — struct
- `Triggers::TimeSignal::signalTime` — feature
- `Triggers::TimeSignal::signalClock` — feature
- `Triggers::TriggerWhen` — function
- `Triggers::TriggerWhen::condition` — bool
- `Triggers::TriggerWhen::receiver` — feature
- `Triggers::TriggerWhen::monitor` — feature
- `Triggers::TriggerWhen::changeSignal` — feature
- `Triggers::TriggerAt` — function
- `Triggers::TriggerAt::timeInstant` — feature
- `Triggers::TriggerAt::receiver` — feature
- `Triggers::TriggerAt::clock` — feature
- `Triggers::TriggerAt::monitor` — feature
- `Triggers::TriggerAt::timeSignal` — feature
- `Triggers::TriggerAfter` — function
- `Triggers::TriggerAfter::delay` — feature
- `Triggers::TriggerAfter::receiver` — feature
- `Triggers::TriggerAfter::clock` — feature
- `Triggers::TriggerAfter::monitor` — feature
