...
language: KerML
source: sysml.library/Kernel Libraries/Kernel Data Type Library/VectorValues.kerml
declares: [VectorValues, VectorValues::VectorValue, VectorValues::NumericalVectorValue, VectorValues::NumericalVectorValue::dimension, VectorValues::CartesianVectorValue, VectorValues::ThreeVectorValue, VectorValues::CartesianThreeVectorValue]
license: EPL-2.0
---

# VectorValues

Verbatim KerML standard-library source from `sysml.library/Kernel Libraries/Kernel Data Type Library/VectorValues.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `VectorValues` — standard library package
- `VectorValues::VectorValue` — datatype
- `VectorValues::NumericalVectorValue` — datatype
- `VectorValues::NumericalVectorValue::dimension` — feature
- `VectorValues::CartesianVectorValue` — datatype
- `VectorValues::ThreeVectorValue` — datatype
- `VectorValues::CartesianThreeVectorValue` — datatype
