...
language: KerML
source: sysml.library/Kernel Libraries/Kernel Function Library/BaseFunctions.kerml
declares: [BaseFunctions, BaseFunctions::==, BaseFunctions::!=, BaseFunctions::===, BaseFunctions::!==, BaseFunctions::ToString, BaseFunctions::[, BaseFunctions::#, BaseFunctions::,, BaseFunctions::all, BaseFunctions::istype, BaseFunctions::hastype, BaseFunctions::@, BaseFunctions::@@, BaseFunctions::as, BaseFunctions::meta]
license: EPL-2.0
---

# BaseFunctions

Verbatim KerML standard-library source from `sysml.library/Kernel Libraries/Kernel Function Library/BaseFunctions.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `BaseFunctions` — standard library package
- `BaseFunctions::==` — function
- `BaseFunctions::!=` — function
- `BaseFunctions::===` — function
- `BaseFunctions::!==` — function
- `BaseFunctions::ToString` — function
- `BaseFunctions::[` — function
- `BaseFunctions::#` — function
- `BaseFunctions::,` — function
- `BaseFunctions::all` — function
- `BaseFunctions::istype` — function
- `BaseFunctions::hastype` — function
- `BaseFunctions::@` — function
- `BaseFunctions::@@` — function
- `BaseFunctions::as` — function
- `BaseFunctions::meta` — function
