...
language: SysML
source: sysml.library/Systems Library/Connections.sysml
declares: [Connections, Connections::Connection, Connections::BinaryConnection, Connections::connections, Connections::binaryConnections]
license: EPL-2.0
---

# Connections

Verbatim SysML standard-library source from `sysml.library/Systems Library/Connections.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `Connections` — standard library package
- `Connections::Connection` — connection def
- `Connections::BinaryConnection` — connection def
- `Connections::connections` — connection
- `Connections::binaryConnections` — connection
