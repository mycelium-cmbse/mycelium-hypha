...
kind: example
language: SysML
source: sysml/src/examples/Room Model/RoomModel.sysml
elements: [FlowUsage, ItemUsage, PartDefinition, PartUsage, PortDefinition, PortUsage]
license: EPL-2.0
---

# RoomModel

Verbatim SysML model from `sysml/src/examples/Room Model/RoomModel.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
