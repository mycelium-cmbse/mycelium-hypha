...
kind: example
language: SysML
source: sysml/src/examples/Simple Tests/EnumerationTest.sysml
elements: [AttributeDefinition, AttributeUsage, EnumerationUsage]
license: EPL-2.0
---

# EnumerationTest

Verbatim SysML model from `sysml/src/examples/Simple Tests/EnumerationTest.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
