...
kind: example
language: SysML
source: sysml/src/validation/15-Properties-Values-Expressions/15_07-System of Units and Scales.sysml
elements: [AttributeUsage, ReferenceUsage]
license: EPL-2.0
---

# 15_07-System of Units and Scales

Verbatim SysML model from `sysml/src/validation/15-Properties-Values-Expressions/15_07-System of Units and Scales.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
