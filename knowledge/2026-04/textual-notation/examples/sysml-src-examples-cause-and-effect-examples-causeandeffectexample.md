...
kind: example
language: SysML
source: sysml/src/examples/Cause and Effect Examples/CauseAndEffectExample.sysml
elements: [ActionUsage, ConnectionDefinition, ConnectionUsage, ItemUsage, OccurrenceUsage, PartDefinition, PartUsage]
license: EPL-2.0
---

# CauseAndEffectExample

Verbatim SysML model from `sysml/src/examples/Cause and Effect Examples/CauseAndEffectExample.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
