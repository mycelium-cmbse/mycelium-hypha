...
kind: example
language: KerML
source: kerml/src/examples/Individuals Examples/JohnIndividualExample.kerml
elements: [ConstraintUsage]
license: EPL-2.0
---

# JohnIndividualExample

Verbatim KerML model from `kerml/src/examples/Individuals Examples/JohnIndividualExample.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
