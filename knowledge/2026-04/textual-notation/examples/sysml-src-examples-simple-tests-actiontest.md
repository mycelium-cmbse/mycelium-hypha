...
kind: example
language: SysML
source: sysml/src/examples/Simple Tests/ActionTest.sysml
elements: [ActionDefinition, ActionUsage, AttributeDefinition, AttributeUsage, FlowUsage, PartUsage]
license: EPL-2.0
---

# ActionTest

Verbatim SysML model from `sysml/src/examples/Simple Tests/ActionTest.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
