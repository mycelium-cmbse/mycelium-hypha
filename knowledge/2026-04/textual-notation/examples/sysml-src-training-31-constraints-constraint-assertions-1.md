...
kind: example
language: SysML
source: sysml/src/training/31. Constraints/Constraint Assertions-1.sysml
...
Verbatim SysML model from `sysml/src/training/31. Constraints/Constraint Assertions-1.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
