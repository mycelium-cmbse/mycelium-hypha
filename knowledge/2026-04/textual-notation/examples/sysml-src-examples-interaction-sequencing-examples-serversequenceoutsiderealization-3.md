...
kind: example
language: SysML
source: sysml/src/examples/Interaction Sequencing Examples/ServerSequenceOutsideRealization-3.sysml
elements: [ActionUsage, AttributeUsage, FlowUsage, InterfaceDefinition, InterfaceUsage, ItemUsage, PartUsage, PerformActionUsage, PortDefinition, PortUsage]
license: EPL-2.0
---

# ServerSequenceOutsideRealization-3

Verbatim SysML model from `sysml/src/examples/Interaction Sequencing Examples/ServerSequenceOutsideRealization-3.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
