...
kind: example
language: SysML
source: sysml/src/validation/15-Properties-Values-Expressions/15_01-Constants.sysml
elements: [AssertConstraintUsage, AttributeUsage, ConstraintUsage, ReferenceUsage]
license: EPL-2.0
---

# 15_01-Constants

Verbatim SysML model from `sysml/src/validation/15-Properties-Values-Expressions/15_01-Constants.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
