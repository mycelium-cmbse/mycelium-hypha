...
kind: example
language: SysML
source: sysml/src/validation/15-Properties-Values-Expressions/15_10-Primitive Data Types.sysml
elements: [AssertConstraintUsage, AttributeDefinition, AttributeUsage, ConstraintUsage, EnumerationUsage]
license: EPL-2.0
---

# 15_10-Primitive Data Types

Verbatim SysML model from `sysml/src/validation/15-Properties-Values-Expressions/15_10-Primitive Data Types.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- [EnumerationUsage](../metamodel/elements/EnumerationUsage.md)
