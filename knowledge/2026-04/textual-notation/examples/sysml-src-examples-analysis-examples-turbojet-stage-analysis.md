...
kind: example
language: SysML
source: sysml/src/examples/Analysis Examples/Turbojet Stage Analysis.sysml
elements: [ActionDefinition, ActionUsage, AttributeUsage, ConstraintUsage, FlowUsage, PartDefinition, PartUsage]
license: EPL-2.0
---

# Turbojet Stage Analysis

Verbatim SysML model from `sysml/src/examples/Analysis Examples/Turbojet Stage Analysis.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
