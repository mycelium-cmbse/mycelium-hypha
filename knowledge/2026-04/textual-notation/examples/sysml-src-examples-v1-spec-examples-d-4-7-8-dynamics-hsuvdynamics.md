...
kind: example
language: SysML
source: sysml/src/examples/v1 Spec Examples/D.4.7.8 Dynamics/HSUVDynamics.sysml
elements: [AttributeDefinition, AttributeUsage, ConstraintDefinition, ConstraintUsage]
license: EPL-2.0
---

# HSUVDynamics

Verbatim SysML model from `sysml/src/examples/v1 Spec Examples/D.4.7.8 Dynamics/HSUVDynamics.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
