...
kind: example
language: SysML
source: sysml/src/validation/18-Use Case/18-Use Case.sysml
elements: [AssertConstraintUsage, CaseUsage, ConstraintUsage, PartDefinition, PartUsage, ReferenceUsage, UseCaseUsage]
license: EPL-2.0
---

# 18-Use Case

Verbatim SysML model from `sysml/src/validation/18-Use Case/18-Use Case.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
