...
kind: example
language: SysML
source: sysml/src/validation/03-Function-based Behavior/3a-Function-based Behavior-1.sysml
elements: [AcceptActionUsage, ActionDefinition, ActionUsage, AttributeDefinition, AttributeUsage, CaseUsage, ConnectionUsage, FlowUsage, ItemUsage]
license: EPL-2.0
---

# 3a-Function-based Behavior-1

Verbatim SysML model from `sysml/src/validation/03-Function-based Behavior/3a-Function-based Behavior-1.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- [AcceptActionUsage](../metamodel/elements/AcceptActionUsage.md)
