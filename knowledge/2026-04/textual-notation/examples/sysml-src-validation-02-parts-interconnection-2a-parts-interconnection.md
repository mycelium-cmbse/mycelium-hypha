...
kind: example
language: SysML
source: sysml/src/validation/02-Parts Interconnection/2a-Parts Interconnection.sysml
elements: [ConnectionUsage, InterfaceDefinition, InterfaceUsage, PartDefinition, PartUsage, PortDefinition, PortUsage, ReferenceUsage]
license: EPL-2.0
---

# 2a-Parts Interconnection

Verbatim SysML model from `sysml/src/validation/02-Parts Interconnection/2a-Parts Interconnection.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
