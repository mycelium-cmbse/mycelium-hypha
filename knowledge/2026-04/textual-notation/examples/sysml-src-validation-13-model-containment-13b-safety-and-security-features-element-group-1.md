...
kind: example
language: SysML
source: sysml/src/validation/13-Model Containment/13b-Safety and Security Features Element Group-1.sysml
elements: [AttributeUsage, MetadataDefinition, MetadataUsage, PartUsage]
license: EPL-2.0
---

# 13b-Safety and Security Features Element Group-1

Verbatim SysML model from `sysml/src/validation/13-Model Containment/13b-Safety and Security Features Element Group-1.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
