...
kind: example
language: SysML
source: sysml/src/validation/07-Variant Configuration/7b-Variant Configurations.sysml
elements: [AssertConstraintUsage, ConstraintUsage, PartDefinition, PartUsage, PortDefinition, PortUsage, RequirementDefinition, RequirementUsage]
license: EPL-2.0
---

# 7b-Variant Configurations

Verbatim SysML model from `sysml/src/validation/07-Variant Configuration/7b-Variant Configurations.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
