...
kind: example
language: SysML
source: sysml/src/training/30. Calculations/Calculation Usages-2.sysml
...
Verbatim SysML model from `sysml/src/training/30. Calculations/Calculation Usages-2.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
