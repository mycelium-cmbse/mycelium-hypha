...
kind: example
language: SysML
source: sysml/src/validation/04-Functional Allocation/4a-Functional Allocation.sysml
elements: [ActionUsage, AttributeUsage, FlowUsage, PartUsage, PortUsage]
license: EPL-2.0
---

# 4a-Functional Allocation

Verbatim SysML model from `sysml/src/validation/04-Functional Allocation/4a-Functional Allocation.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
