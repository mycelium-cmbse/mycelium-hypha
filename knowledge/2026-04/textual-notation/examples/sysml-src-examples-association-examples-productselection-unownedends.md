...
kind: example
language: SysML
source: sysml/src/examples/Association Examples/ProductSelection_UnownedEnds.sysml
...
Verbatim SysML model from `sysml/src/examples/Association Examples/ProductSelection_UnownedEnds.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
