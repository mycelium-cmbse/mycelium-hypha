...
kind: example
language: SysML
source: sysml/src/validation/15-Properties-Values-Expressions/15_13-Discretely Sampled Function Value.sysml
elements: [AttributeDefinition, AttributeUsage, ReferenceUsage]
license: EPL-2.0
---

# 15_13-Discretely Sampled Function Value

Verbatim SysML model from `sysml/src/validation/15-Properties-Values-Expressions/15_13-Discretely Sampled Function Value.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
