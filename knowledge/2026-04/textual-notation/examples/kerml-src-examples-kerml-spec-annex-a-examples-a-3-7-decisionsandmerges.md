---
name: A-3-7-DecisionsAndMerges
kind: example
language: KerML
source: kerml/src/examples/KerML Spec Annex A Examples/A-3-7-DecisionsAndMerges.kerml
elements: []
license: EPL-2.0
---

# A-3-7-DecisionsAndMerges

Verbatim KerML model from `kerml/src/examples/KerML Spec Annex A Examples/A-3-7-DecisionsAndMerges.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
