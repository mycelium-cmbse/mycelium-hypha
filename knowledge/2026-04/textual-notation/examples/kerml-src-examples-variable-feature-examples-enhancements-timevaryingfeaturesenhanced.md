---
name: TimeVaryingFeaturesEnhanced
kind: example
language: KerML
source: kerml/src/examples/Variable Feature Examples/Enhancements/TimeVaryingFeaturesEnhanced.kerml
elements: []
license: EPL-2.0
---

# TimeVaryingFeaturesEnhanced

Verbatim KerML model from `kerml/src/examples/Variable Feature Examples/Enhancements/TimeVaryingFeaturesEnhanced.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
