...
kind: example
language: KerML
source: kerml/src/examples/Variable Feature Examples/Enhancements/Moments.kerml
elements: [OccurrenceUsage]
license: EPL-2.0
---

# Moments

Verbatim KerML model from `kerml/src/examples/Variable Feature Examples/Enhancements/Moments.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
