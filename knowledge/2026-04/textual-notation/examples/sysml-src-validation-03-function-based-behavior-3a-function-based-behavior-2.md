...
kind: example
language: SysML
source: sysml/src/validation/03-Function-based Behavior/3a-Function-based Behavior-2.sysml
elements: [ActionDefinition, ActionUsage, AttributeDefinition, AttributeUsage, FlowUsage]
license: EPL-2.0
---

# 3a-Function-based Behavior-2

Verbatim SysML model from `sysml/src/validation/03-Function-based Behavior/3a-Function-based Behavior-2.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
