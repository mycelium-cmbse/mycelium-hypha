...
kind: example
language: SysML
source: sysml/src/validation/15-Properties-Values-Expressions/15_19a-Materials with Properties.sysml
elements: [AttributeDefinition, AttributeUsage]
license: EPL-2.0
---

# 15_19a-Materials with Properties

Verbatim SysML model from `sysml/src/validation/15-Properties-Values-Expressions/15_19a-Materials with Properties.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
