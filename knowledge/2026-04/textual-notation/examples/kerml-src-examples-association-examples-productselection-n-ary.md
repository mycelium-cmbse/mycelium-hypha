...
kind: example
language: KerML
source: kerml/src/examples/Association Examples/ProductSelection_N_ary.kerml
elements: []
license: EPL-2.0
---
...
Verbatim KerML model from `kerml/src/examples/Association Examples/ProductSelection_N_ary.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
