...
kind: example
language: SysML
source: sysml/src/examples/State Space Representation Examples/EVSample.sysml
elements: [ActionUsage, AttributeDefinition, AttributeUsage, ConstraintUsage, FlowUsage, PartDefinition, PartUsage, RequirementDefinition, RequirementUsage]
license: EPL-2.0
---

# EVSample

Verbatim SysML model from `sysml/src/examples/State Space Representation Examples/EVSample.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
