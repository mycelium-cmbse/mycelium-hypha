...
kind: example
language: SysML
source: sysml/src/validation/03-Function-based Behavior/3d-Function-based Behavior-item.sysml
elements: [ActionDefinition, ActionUsage, AttributeUsage, FlowUsage, ItemDefinition, ItemUsage, PartDefinition, PartUsage, PerformActionUsage, PortDefinition, PortUsage]
license: EPL-2.0
---

# 3d-Function-based Behavior-item

Verbatim SysML model from `sysml/src/validation/03-Function-based Behavior/3d-Function-based Behavior-item.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
