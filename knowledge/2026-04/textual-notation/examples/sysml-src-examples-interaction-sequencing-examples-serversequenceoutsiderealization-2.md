...
kind: example
language: SysML
source: sysml/src/examples/Interaction Sequencing Examples/ServerSequenceOutsideRealization-2.sysml
elements: [ActionUsage, AttributeUsage, ExhibitStateUsage, FlowUsage, InterfaceUsage, ItemUsage, PartUsage, PerformActionUsage, PortDefinition, PortUsage, StateUsage, TransitionUsage]
license: EPL-2.0
---

# ServerSequenceOutsideRealization-2

Verbatim SysML model from `sysml/src/examples/Interaction Sequencing Examples/ServerSequenceOutsideRealization-2.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
