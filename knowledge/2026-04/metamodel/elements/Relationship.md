...
name: Relationship
package: Elements
fully qualified name: KerML::Root::Elements::Relationship
isAbstract: true
visibility: public
generalizes: [Element]
...
`+` [Element](Element.md) · `[0..*]` · *composite, ordered*

The relatedElements of this Relationship that are owned by the Relationship.

Subsets [relatedElement](#relatedelement)

### owningRelatedElement

`+` [Element](Element.md) · `[0..1]`
