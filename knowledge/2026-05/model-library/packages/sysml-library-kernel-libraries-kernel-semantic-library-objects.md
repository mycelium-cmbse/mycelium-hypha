...
language: KerML
source: sysml.library/Kernel Libraries/Kernel Semantic Library/Objects.kerml
declares: [Objects, Objects::Object, Objects::Object::self, Objects::Object::subobjects, Objects::Object::involvingPerformances, Objects::Object::enactedPerformances, Objects::Object::ownedPerformances, Objects::LinkObject, Objects::BinaryLinkObject, Objects::objects, Objects::linkObjects, Objects::binaryLinkObjects, Objects::Body, Objects::Surface, Objects::Surface::genus, Objects::Curve, Objects::Point, Objects::StructuredSpaceObject, Objects::StructuredSpaceObject::structuredSpaceObjectCells, Objects::StructuredSpaceObject::structuredSpaceObjectCells::cellOrientation, Objects::StructuredSpaceObject::StructuredSurface, Objects::StructuredSpaceObject::StructuredCurve, Objects::StructuredSpaceObject::StructuredPoint, Objects::StructuredSpaceObject::faces, Objects::StructuredSpaceObject::edges, Objects::StructuredSpaceObject::vertices]
license: EPL-2.0
---

# Objects

Verbatim KerML standard-library source from `sysml.library/Kernel Libraries/Kernel Semantic Library/Objects.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `Objects` — standard library package
- `Objects::Object` — struct
- `Objects::Object::self` — feature
- `Objects::Object::subobjects` — feature
- `Objects::Object::involvingPerformances` — feature
- `Objects::Object::enactedPerformances` — step
- `Objects::Object::ownedPerformances` — step
- `Objects::LinkObject` — assoc struct
- `Objects::BinaryLinkObject` — assoc struct
- `Objects::objects` — feature
- `Objects::linkObjects` — feature
- `Objects::binaryLinkObjects` — feature
- `Objects::Body` — struct
- `Objects::Surface` — struct
- `Objects::Surface::genus` — feature
- `Objects::Curve` — struct
- `Objects::Point` — struct
- `Objects::StructuredSpaceObject` — struct
- `Objects::StructuredSpaceObject::structuredSpaceObjectCells` — feature
- `Objects::StructuredSpaceObject::structuredSpaceObjectCells::cellOrientation` — feature
- `Objects::StructuredSpaceObject::StructuredSurface` — struct
- `Objects::StructuredSpaceObject::StructuredCurve` — struct
- `Objects::StructuredSpaceObject::StructuredPoint` — struct
- `Objects::StructuredSpaceObject::faces` — feature
- `Objects::StructuredSpaceObject::edges` — feature
- `Objects::StructuredSpaceObject::vertices` — feature
