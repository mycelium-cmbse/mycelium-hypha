...
language: SysML
source: sysml.library/Domain Libraries/Quantities and Units/ISQBase.sysml
declares: [ISQBase, ISQBase::LengthValue, ISQBase::length, ISQBase::LengthUnit, ISQBase::LengthUnit::lengthPF, ISQBase::DurationValue, ISQBase::duration, ISQBase::DurationUnit, ISQBase::DurationUnit::durationPF, ISQBase::MassValue, ISQBase::mass, ISQBase::MassUnit, ISQBase::MassUnit::massPF, ISQBase::ThermodynamicTemperatureValue, ISQBase::thermodynamicTemperature, ISQBase::ThermodynamicTemperatureUnit, ISQBase::ThermodynamicTemperatureUnit::thermodynamicTemperaturePF, ISQBase::ElectricCurrentValue, ISQBase::electricCurrent, ISQBase::ElectricCurrentUnit, ISQBase::ElectricCurrentUnit::electricCurrentPF, ISQBase::LuminousIntensityValue, ISQBase::luminousIntensity, ISQBase::LuminousIntensityUnit, ISQBase::LuminousIntensityUnit::luminousIntensityPF, ISQBase::AmountOfSubstanceValue, ISQBase::amountOfSubstance, ISQBase::AmountOfSubstanceUnit, ISQBase::AmountOfSubstanceUnit::amountOfSubstancePF, ISQBase::L, ISQBase::M, ISQBase::T, ISQBase::I, ISQBase::Θ, ISQBase::N, ISQBase::J]
license: EPL-2.0
---

# ISQBase

Verbatim SysML standard-library source from `sysml.library/Domain Libraries/Quantities and Units/ISQBase.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `ISQBase` — standard library package
- `ISQBase::LengthValue` — attribute def
- `ISQBase::length` — attribute
- `ISQBase::LengthUnit` — attribute def
- `ISQBase::LengthUnit::lengthPF` — attribute
- `ISQBase::DurationValue` — attribute def
- `ISQBase::duration` — attribute
- `ISQBase::DurationUnit` — attribute def
- `ISQBase::DurationUnit::durationPF` — attribute
- `ISQBase::MassValue` — attribute def
- `ISQBase::mass` — attribute
- `ISQBase::MassUnit` — attribute def
- `ISQBase::MassUnit::massPF` — attribute
- `ISQBase::ThermodynamicTemperatureValue` — attribute def
- `ISQBase::thermodynamicTemperature` — attribute
- `ISQBase::ThermodynamicTemperatureUnit` — attribute def
- `ISQBase::ThermodynamicTemperatureUnit::thermodynamicTemperaturePF` — attribute
- `ISQBase::ElectricCurrentValue` — attribute def
- `ISQBase::electricCurrent` — attribute
- `ISQBase::ElectricCurrentUnit` — attribute def
- `ISQBase::ElectricCurrentUnit::electricCurrentPF` — attribute
- `ISQBase::LuminousIntensityValue` — attribute def
- `ISQBase::luminousIntensity` — attribute
- `ISQBase::LuminousIntensityUnit` — attribute def
- `ISQBase::LuminousIntensityUnit::luminousIntensityPF` — attribute
- `ISQBase::AmountOfSubstanceValue` — attribute def
- `ISQBase::amountOfSubstance` — attribute
- `ISQBase::AmountOfSubstanceUnit` — attribute def
- `ISQBase::AmountOfSubstanceUnit::amountOfSubstancePF` — attribute
- `ISQBase::L` — attribute
- `ISQBase::M` — attribute
- `ISQBase::T` — attribute
- `ISQBase::I` — attribute
