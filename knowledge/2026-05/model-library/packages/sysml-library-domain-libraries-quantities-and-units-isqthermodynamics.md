---
name: ISQThermodynamics
kind: model-library-file
language: SysML
source: sysml.library/Domain Libraries/Quantities and Units/ISQThermodynamics.sysml
declares: [ISQThermodynamics, ISQThermodynamics::CelsiusTemperatureValue, ISQThermodynamics::celsiusTemperature, ISQThermodynamics::CelsiusTemperatureUnit, ISQThermodynamics::CelsiusTemperatureUnit::thermodynamicTemperaturePF, ISQThermodynamics::LinearExpansionCoefficientValue, ISQThermodynamics::linearExpansionCoefficient, ISQThermodynamics::LinearExpansionCoefficientUnit, ISQThermodynamics::LinearExpansionCoefficientUnit::thermodynamicTemperaturePF, ISQThermodynamics::CubicExpansionCoefficientValue, ISQThermodynamics::cubicExpansionCoefficient, ISQThermodynamics::CubicExpansionCoefficientUnit, ISQThermodynamics::CubicExpansionCoefficientUnit::thermodynamicTemperaturePF, ISQThermodynamics::RelativePressureCoefficientValue, ISQThermodynamics::relativePressureCoefficient, ISQThermodynamics::RelativePressureCoefficientUnit, ISQThermodynamics::RelativePressureCoefficientUnit::thermodynamicTemperaturePF, ISQThermodynamics::PressureCoefficientValue, ISQThermodynamics::pressureCoefficient, ISQThermodynamics::PressureCoefficientUnit, ISQThermodynamics::PressureCoefficientUnit::lengthPF, ISQThermodynamics::PressureCoefficientUnit::massPF, ISQThermodynamics::PressureCoefficientUnit::durationPF, ISQThermodynamics::PressureCoefficientUnit::thermodynamicTemperaturePF, ISQThermodynamics::IsothermalCompressibilityValue, ISQThermodynamics::isothermalCompressibility, ISQThermodynamics::IsothermalCompressibilityUnit, ISQThermodynamics::IsothermalCompressibilityUnit::lengthPF, ISQThermodynamics::IsothermalCompressibilityUnit::massPF, ISQThermodynamics::IsothermalCompressibilityUnit::durationPF, ISQThermodynamics::IsentropicCompressibilityValue, ISQThermodynamics::isentropicCompressibility, ISQThermodynamics::IsentropicCompressibilityUnit, ISQThermodynamics::IsentropicCompressibilityUnit::lengthPF, ISQThermodynamics::IsentropicCompressibilityUnit::massPF, ISQThermodynamics::IsentropicCompressibilityUnit::durationPF, ISQThermodynamics::heat, ISQThermodynamics::latentHeat, ISQThermodynamics::HeatFlowRateValue, ISQThermodynamics::heatFlowRate, ISQThermodynamics::HeatFlowRateUnit, ISQThermodynamics::HeatFlowRateUnit::lengthPF, ISQThermodynamics::HeatFlowRateUnit::massPF, ISQThermodynamics::HeatFlowRateUnit::durationPF, ISQThermodynamics::DensityOfHeatFlowRateValue, ISQThermodynamics::densityOfHeatFlowRate, ISQThermodynamics::DensityOfHeatFlowRateUnit, ISQThermodynamics::DensityOfHeatFlowRateUnit::massPF, ISQThermodynamics::DensityOfHeatFlowRateUnit::durationPF, ISQThermodynamics::ThermalConductivityValue, ISQThermodynamics::thermalConductivity, ISQThermodynamics::ThermalConductivityUnit, ISQThermodynamics::ThermalConductivityUnit::lengthPF, ISQThermodynamics::ThermalConductivityUnit::massPF, ISQThermodynamics::ThermalConductivityUnit::durationPF, ISQThermodynamics::ThermalConductivityUnit::thermodynamicTemperaturePF, ISQThermodynamics::CoefficientOfHeatTransferValue, ISQThermodynamics::coefficientOfHeatTransfer, ISQThermodynamics::CoefficientOfHeatTransferUnit, ISQThermodynamics::CoefficientOfHeatTransferUnit::massPF, ISQThermodynamics::CoefficientOfHeatTransferUnit::durationPF, ISQThermodynamics::CoefficientOfHeatTransferUnit::thermodynamicTemperaturePF, ISQThermodynamics::SurfaceCoefficientOfHeatTransferValue, ISQThermodynamics::surfaceCoefficientOfHeatTransfer, ISQThermodynamics::SurfaceCoefficientOfHeatTransferUnit, ISQThermodynamics::SurfaceCoefficientOfHeatTransferUnit::massPF, ISQThermodynamics::SurfaceCoefficientOfHeatTransferUnit::durationPF, ISQThermodynamics::SurfaceCoefficientOfHeatTransferUnit::thermodynamicTemperaturePF, ISQThermodynamics::ThermalInsulanceValue, ISQThermodynamics::thermalInsulance, ISQThermodynamics::ThermalInsulanceUnit, ISQThermodynamics::ThermalInsulanceUnit::massPF, ISQThermodynamics::ThermalInsulanceUnit::durationPF, ISQThermodynamics::ThermalInsulanceUnit::thermodynamicTemperaturePF, ISQThermodynamics::ThermalResistanceValue, ISQThermodynamics::thermalResistance, ISQThermodynamics::ThermalResistanceUnit, ISQThermodynamics::ThermalResistanceUnit::lengthPF, ISQThermodynamics::ThermalResistanceUnit::massPF, ISQThermodynamics::ThermalResistanceUnit::durationPF, ISQThermodynamics::ThermalResistanceUnit::thermodynamicTemperaturePF, ISQThermodynamics::ThermalConductanceValue, ISQThermodynamics::thermalConductance, ISQThermodynamics::ThermalConductanceUnit, ISQThermodynamics::ThermalConductanceUnit::lengthPF, ISQThermodynamics::ThermalConductanceUnit::massPF, ISQThermodynamics::ThermalConductanceUnit::durationPF, ISQThermodynamics::ThermalConductanceUnit::thermodynamicTemperaturePF, ISQThermodynamics::ThermalDiffusivityValue, ISQThermodynamics::thermalDiffusivity, ISQThermodynamics::ThermalDiffusivityUnit, ISQThermodynamics::ThermalDiffusivityUnit::lengthPF, ISQThermodynamics::ThermalDiffusivityUnit::durationPF, ISQThermodynamics::HeatCapacityValue, ISQThermodynamics::heatCapacity, ISQThermodynamics::HeatCapacityUnit, ISQThermodynamics::HeatCapacityUnit::lengthPF, ISQThermodynamics::HeatCapacityUnit::massPF, ISQThermodynamics::HeatCapacityUnit::durationPF, ISQThermodynamics::HeatCapacityUnit::thermodynamicTemperaturePF, ISQThermodynamics::SpecificHeatCapacityValue, ISQThermodynamics::specificHeatCapacity, ISQThermodynamics::SpecificHeatCapacityUnit, ISQThermodynamics::SpecificHeatCapacityUnit::lengthPF, ISQThermodynamics::SpecificHeatCapacityUnit::durationPF, ISQThermodynamics::SpecificHeatCapacityUnit::thermodynamicTemperaturePF, ISQThermodynamics::SpecificHeatCapacityAtConstantPressureValue, ISQThermodynamics::specificHeatCapacityAtConstantPressure, ISQThermodynamics::SpecificHeatCapacityAtConstantPressureUnit, ISQThermodynamics::SpecificHeatCapacityAtConstantPressureUnit::lengthPF, ISQThermodynamics::SpecificHeatCapacityAtConstantPressureUnit::durationPF, ISQThermodynamics::SpecificHeatCapacityAtConstantPressureUnit::thermodynamicTemperaturePF, ISQThermodynamics::SpecificHeatCapacityAtConstantVolumeValue, ISQThermodynamics::specificHeatCapacityAtConstantVolume, ISQThermodynamics::SpecificHeatCapacityAtConstantVolumeUnit, ISQThermodynamics::SpecificHeatCapacityAtConstantVolumeUnit::lengthPF, ISQThermodynamics::SpecificHeatCapacityAtConstantVolumeUnit::durationPF, ISQThermodynamics::SpecificHeatCapacityAtConstantVolumeUnit::thermodynamicTemperaturePF, ISQThermodynamics::SpecificHeatCapacityAtSaturatedVapourPressureValue, ISQThermodynamics::specificHeatCapacityAtSaturatedVapourPressure, ISQThermodynamics::SpecificHeatCapacityAtSaturatedVapourPressureUnit, ISQThermodynamics::SpecificHeatCapacityAtSaturatedVapourPressureUnit::lengthPF, ISQThermodynamics::SpecificHeatCapacityAtSaturatedVapourPressureUnit::durationPF, ISQThermodynamics::SpecificHeatCapacityAtSaturatedVapourPressureUnit::thermodynamicTemperaturePF, ISQThermodynamics::RatioOfSpecificHeatCapacitiesValue, ISQThermodynamics::ratioOfSpecificHeatCapacities, ISQThermodynamics::IsentropicExponentValue, ISQThermodynamics::isentropicExponent, ISQThermodynamics::EntropyValue, ISQThermodynamics::entropy, ISQThermodynamics::EntropyUnit, ISQThermodynamics::EntropyUnit::lengthPF, ISQThermodynamics::EntropyUnit::massPF, ISQThermodynamics::EntropyUnit::durationPF, ISQThermodynamics::EntropyUnit::thermodynamicTemperaturePF, ISQThermodynamics::SpecificEntropyValue, ISQThermodynamics::specificEntropy, ISQThermodynamics::SpecificEntropyUnit, ISQThermodynamics::SpecificEntropyUnit::lengthPF, ISQThermodynamics::SpecificEntropyUnit::durationPF, ISQThermodynamics::SpecificEntropyUnit::thermodynamicTemperaturePF, ISQThermodynamics::EnergyValue, ISQThermodynamics::energy, ISQThermodynamics::EnergyUnit, ISQThermodynamics::EnergyUnit::lengthPF, ISQThermodynamics::EnergyUnit::massPF, ISQThermodynamics::EnergyUnit::durationPF, ISQThermodynamics::internalEnergy, ISQThermodynamics::enthalpy, ISQThermodynamics::helmholtzEnergy, ISQThermodynamics::gibbsEnergy, ISQThermodynamics::SpecificEnergyValue, ISQThermodynamics::specificEnergy, ISQThermodynamics::SpecificEnergyUnit, ISQThermodynamics::SpecificEnergyUnit::lengthPF, ISQThermodynamics::SpecificEnergyUnit::durationPF, ISQThermodynamics::specificInternalEnergy, ISQThermodynamics::SpecificEnthalpyValue, ISQThermodynamics::specificEnthalpy, ISQThermodynamics::SpecificEnthalpyUnit, ISQThermodynamics::SpecificEnthalpyUnit::lengthPF, ISQThermodynamics::SpecificEnthalpyUnit::durationPF, ISQThermodynamics::specificHelmholtzEnergy, ISQThermodynamics::specificGibbsEnergy, ISQThermodynamics::MassieuFunctionValue, ISQThermodynamics::massieuFunction, ISQThermodynamics::MassieuFunctionUnit, ISQThermodynamics::MassieuFunctionUnit::lengthPF, ISQThermodynamics::MassieuFunctionUnit::massPF, ISQThermodynamics::MassieuFunctionUnit::durationPF, ISQThermodynamics::MassieuFunctionUnit::thermodynamicTemperaturePF, ISQThermodynamics::PlanckFunctionValue, ISQThermodynamics::planckFunction, ISQThermodynamics::PlanckFunctionUnit, ISQThermodynamics::PlanckFunctionUnit::lengthPF, ISQThermodynamics::PlanckFunctionUnit::massPF, ISQThermodynamics::PlanckFunctionUnit::durationPF, ISQThermodynamics::PlanckFunctionUnit::thermodynamicTemperaturePF, ISQThermodynamics::JouleThomsonCoefficientValue, ISQThermodynamics::jouleThomsonCoefficient, ISQThermodynamics::JouleThomsonCoefficientUnit, ISQThermodynamics::JouleThomsonCoefficientUnit::lengthPF, ISQThermodynamics::JouleThomsonCoefficientUnit::massPF, ISQThermodynamics::JouleThomsonCoefficientUnit::durationPF, ISQThermodynamics::JouleThomsonCoefficientUnit::thermodynamicTemperaturePF, ISQThermodynamics::ThermalEfficiencyValue, ISQThermodynamics::thermalEfficiency, ISQThermodynamics::MaximumThermalEfficiencyValue, ISQThermodynamics::maximumThermalEfficiency, ISQThermodynamics::SpecificGasConstantValue, ISQThermodynamics::specificGasConstant, ISQThermodynamics::SpecificGasConstantUnit, ISQThermodynamics::SpecificGasConstantUnit::lengthPF, ISQThermodynamics::SpecificGasConstantUnit::durationPF, ISQThermodynamics::SpecificGasConstantUnit::thermodynamicTemperaturePF, ISQThermodynamics::MassConcentrationOfWaterValue, ISQThermodynamics::massConcentrationOfWater, ISQThermodynamics::MassConcentrationOfWaterUnit, ISQThermodynamics::MassConcentrationOfWaterUnit::lengthPF, ISQThermodynamics::MassConcentrationOfWaterUnit::massPF, ISQThermodynamics::MassConcentrationOfWaterVapourAbsoluteHumidityValue, ISQThermodynamics::massConcentrationOfWaterVapourAbsoluteHumidity, ISQThermodynamics::MassConcentrationOfWaterVapourAbsoluteHumidityUnit, ISQThermodynamics::MassConcentrationOfWaterVapourAbsoluteHumidityUnit::lengthPF, ISQThermodynamics::MassConcentrationOfWaterVapourAbsoluteHumidityUnit::massPF, ISQThermodynamics::MassRatioOfWaterToDryMatterValue, ISQThermodynamics::massRatioOfWaterToDryMatter, ISQThermodynamics::MassRatioOfWaterVapourToDryGasValue, ISQThermodynamics::massRatioOfWaterVapourToDryGas, ISQThermodynamics::MassFractionOfWaterValue, ISQThermodynamics::massFractionOfWater, ISQThermodynamics::MassFractionOfDryMatterValue, ISQThermodynamics::massFractionOfDryMatter, ISQThermodynamics::RelativeHumidityValue, ISQThermodynamics::relativeHumidity, ISQThermodynamics::RelativeMassConcentrationOfVapourValue, ISQThermodynamics::relativeMassConcentrationOfVapour, ISQThermodynamics::RelativeMassRatioOfVapourValue, ISQThermodynamics::relativeMassRatioOfVapour, ISQThermodynamics::dewPointTemperature]
license: EPL-2.0
---

# ISQThermodynamics

Verbatim SysML standard-library source from `sysml.library/Domain Libraries/Quantities and Units/ISQThermodynamics.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `ISQThermodynamics` — standard library package
- `ISQThermodynamics::CelsiusTemperatureValue` — attribute def
- `ISQThermodynamics::celsiusTemperature` — attribute
- `ISQThermodynamics::CelsiusTemperatureUnit` — attribute def
- `ISQThermodynamics::CelsiusTemperatureUnit::thermodynamicTemperaturePF` — attribute
- `ISQThermodynamics::LinearExpansionCoefficientValue` — attribute def
- `ISQThermodynamics::linearExpansionCoefficient` — attribute
- `ISQThermodynamics::LinearExpansionCoefficientUnit` — attribute def
- `ISQThermodynamics::LinearExpansionCoefficientUnit::thermodynamicTemperaturePF` — attribute
- `ISQThermodynamics::CubicExpansionCoefficientValue` — attribute def
- `ISQThermodynamics::cubicExpansionCoefficient` — attribute
- `ISQThermodynamics::CubicExpansionCoefficientUnit` — attribute def
- `ISQThermodynamics::CubicExpansionCoefficientUnit::thermodynamicTemperaturePF` — attribute
- `ISQThermodynamics::RelativePressureCoefficientValue` — attribute def
- `ISQThermodynamics::relativePressureCoefficient` — attribute
- `ISQThermodynamics::RelativePressureCoefficientUnit` — attribute def
- `ISQThermodynamics::RelativePressureCoefficientUnit::thermodynamicTemperaturePF` — attribute
- `ISQThermodynamics::PressureCoefficientValue` — attribute def
- `ISQThermodynamics::pressureCoefficient` — attribute
- `ISQThermodynamics::PressureCoefficientUnit` — attribute def
- `ISQThermodynamics::PressureCoefficientUnit::lengthPF` — attribute
- `ISQThermodynamics::PressureCoefficientUnit::massPF` — attribute
- `ISQThermodynamics::PressureCoefficientUnit::durationPF` — attribute
- `ISQThermodynamics::PressureCoefficientUnit::thermodynamicTemperaturePF` — attribute
- `ISQThermodynamics::IsothermalCompressibilityValue` — attribute def
- `ISQThermodynamics::isothermalCompressibility` — attribute
- `ISQThermodynamics::IsothermalCompressibilityUnit` — attribute def
- `ISQThermodynamics::IsothermalCompressibilityUnit::lengthPF` — attribute
- `ISQThermodynamics::IsothermalCompressibilityUnit::massPF` — attribute
- `ISQThermodynamics::IsothermalCompressibilityUnit::durationPF` — attribute
- `ISQThermodynamics::IsentropicCompressibilityValue` — attribute def
- `ISQThermodynamics::isentropicCompressibility` — attribute
- `ISQThermodynamics::IsentropicCompressibilityUnit` — attribute def
- `ISQThermodynamics::IsentropicCompressibilityUnit::lengthPF` — attribute
- `ISQThermodynamics::IsentropicCompressibilityUnit::massPF` — attribute
- `ISQThermodynamics::IsentropicCompressibilityUnit::durationPF` — attribute
- `ISQThermodynamics::heat` — attribute
- `ISQThermodynamics::latentHeat` — attribute
- `ISQThermodynamics::HeatFlowRateValue` — attribute def
- `ISQThermodynamics::heatFlowRate` — attribute
- `ISQThermodynamics::HeatFlowRateUnit` — attribute def
- `ISQThermodynamics::HeatFlowRateUnit::lengthPF` — attribute
- `ISQThermodynamics::HeatFlowRateUnit::massPF` — attribute
- `ISQThermodynamics::HeatFlowRateUnit::durationPF` — attribute
- `ISQThermodynamics::DensityOfHeatFlowRateValue` — attribute def
- `ISQThermodynamics::densityOfHeatFlowRate` — attribute
- `ISQThermodynamics::DensityOfHeatFlowRateUnit` — attribute def
- `ISQThermodynamics::DensityOfHeatFlowRateUnit::massPF` — attribute
- `ISQThermodynamics::DensityOfHeatFlowRateUnit::durationPF` — attribute
- `ISQThermodynamics::ThermalConductivityValue` — attribute def
- `ISQThermodynamics::thermalConductivity` — attribute
- `ISQThermodynamics::ThermalConductivityUnit` — attribute def
- `ISQThermodynamics::ThermalConductivityUnit::lengthPF` — attribute
- `ISQThermodynamics::ThermalConductivityUnit::massPF` — attribute
- `ISQThermodynamics::ThermalConductivityUnit::durationPF` — attribute
- `ISQThermodynamics::ThermalConductivityUnit::thermodynamicTemperaturePF` — attribute
- `ISQThermodynamics::CoefficientOfHeatTransferValue` — attribute def
- `ISQThermodynamics::coefficientOfHeatTransfer` — attribute
- `ISQThermodynamics::CoefficientOfHeatTransferUnit` — attribute def
- `ISQThermodynamics::CoefficientOfHeatTransferUnit::massPF` — attribute
- `ISQThermodynamics::CoefficientOfHeatTransferUnit::durationPF` — attribute
- `ISQThermodynamics::CoefficientOfHeatTransferUnit::thermodynamicTemperaturePF` — attribute
- `ISQThermodynamics::SurfaceCoefficientOfHeatTransferValue` — attribute def
- `ISQThermodynamics::surfaceCoefficientOfHeatTransfer` — attribute
- `ISQThermodynamics::SurfaceCoefficientOfHeatTransferUnit` — attribute def
- `ISQThermodynamics::SurfaceCoefficientOfHeatTransferUnit::massPF` — attribute
- `ISQThermodynamics::SurfaceCoefficientOfHeatTransferUnit::durationPF` — attribute
- `ISQThermodynamics::SurfaceCoefficientOfHeatTransferUnit::thermodynamicTemperaturePF` — attribute
- `ISQThermodynamics::ThermalInsulanceValue` — attribute def
- `ISQThermodynamics::thermalInsulance` — attribute
- `ISQThermodynamics::ThermalInsulanceUnit` — attribute def
- `ISQThermodynamics::ThermalInsulanceUnit::massPF` — attribute
- `ISQThermodynamics::ThermalInsulanceUnit::durationPF` — attribute
- `ISQThermodynamics::ThermalInsulanceUnit::thermodynamicTemperaturePF` — attribute
- `ISQThermodynamics::ThermalResistanceValue` — attribute def
- `ISQThermodynamics::thermalResistance` — attribute
- `ISQThermodynamics::ThermalResistanceUnit` — attribute def
- `ISQThermodynamics::ThermalResistanceUnit::lengthPF` — attribute
- `ISQThermodynamics::ThermalResistanceUnit::massPF` — attribute
- `ISQThermodynamics::ThermalResistanceUnit::durationPF` — attribute
- `ISQThermodynamics::ThermalResistanceUnit::thermodynamicTemperaturePF` — attribute
- `ISQThermodynamics::ThermalConductanceValue` — attribute def
- `ISQThermodynamics::thermalConductance` — attribute
- `ISQThermodynamics::ThermalConductanceUnit` — attribute def
- `ISQThermodynamics::ThermalConductanceUnit::lengthPF` — attribute
- `ISQThermodynamics::ThermalConductanceUnit::massPF` — attribute
- `ISQThermodynamics::ThermalConductanceUnit::durationPF` — attribute
- `ISQThermodynamics::ThermalConductanceUnit::thermodynamicTemperaturePF` — attribute
- `ISQThermodynamics::ThermalDiffusivityValue` — attribute def
- `ISQThermodynamics::thermalDiffusivity` — attribute
- `ISQThermodynamics::ThermalDiffusivityUnit` — attribute def
- `ISQThermodynamics::ThermalDiffusivityUnit::lengthPF` — attribute
- `ISQThermodynamics::ThermalDiffusivityUnit::durationPF` — attribute
- `ISQThermodynamics::HeatCapacityValue` — attribute def
- `ISQThermodynamics::heatCapacity` — attribute
- `ISQThermodynamics::HeatCapacityUnit` — attribute def
- `ISQThermodynamics::HeatCapacityUnit::lengthPF` — attribute
- `ISQThermodynamics::HeatCapacityUnit::massPF` — attribute
- `ISQThermodynamics::HeatCapacityUnit::durationPF` — attribute
- `ISQThermodynamics::HeatCapacityUnit::thermodynamicTemperaturePF` — attribute
- `ISQThermodynamics::SpecificHeatCapacityValue` — attribute def
- `ISQThermodynamics::specificHeatCapacity` — attribute
- `ISQThermodynamics::SpecificHeatCapacityUnit` — attribute def
- `ISQThermodynamics::SpecificHeatCapacityUnit::lengthPF` — attribute
- `ISQThermodynamics::SpecificHeatCapacityUnit::durationPF` — attribute
- `ISQThermodynamics::SpecificHeatCapacityUnit::thermodynamicTemperaturePF` — attribute
- `ISQThermodynamics::SpecificHeatCapacityAtConstantPressureValue` — attribute def
- `ISQThermodynamics::specificHeatCapacityAtConstantPressure` — attribute
- `ISQThermodynamics::SpecificHeatCapacityAtConstantPressureUnit` — attribute def
- `ISQThermodynamics::SpecificHeatCapacityAtConstantPressureUnit::lengthPF` — attribute
- `ISQThermodynamics::SpecificHeatCapacityAtConstantPressureUnit::durationPF` — attribute
- `ISQThermodynamics::SpecificHeatCapacityAtConstantPressureUnit::thermodynamicTemperaturePF` — attribute
- `ISQThermodynamics::SpecificHeatCapacityAtConstantVolumeValue` — attribute def
- `ISQThermodynamics::specificHeatCapacityAtConstantVolume` — attribute
- `ISQThermodynamics::SpecificHeatCapacityAtConstantVolumeUnit` — attribute def
- `ISQThermodynamics::SpecificHeatCapacityAtConstantVolumeUnit::lengthPF` — attribute
- `ISQThermodynamics::SpecificHeatCapacityAtConstantVolumeUnit::durationPF` — attribute
- `ISQThermodynamics::SpecificHeatCapacityAtConstantVolumeUnit::thermodynamicTemperaturePF` — attribute
- `ISQThermodynamics::SpecificHeatCapacityAtSaturatedVapourPressureValue` — attribute def
- `ISQThermodynamics::specificHeatCapacityAtSaturatedVapourPressure` — attribute
- `ISQThermodynamics::SpecificHeatCapacityAtSaturatedVapourPressureUnit` — attribute def
- `ISQThermodynamics::SpecificHeatCapacityAtSaturatedVapourPressureUnit::lengthPF` — attribute
- `ISQThermodynamics::SpecificHeatCapacityAtSaturatedVapourPressureUnit::durationPF` — attribute
- `ISQThermodynamics::SpecificHeatCapacityAtSaturatedVapourPressureUnit::thermodynamicTemperaturePF` — attribute
- `ISQThermodynamics::RatioOfSpecificHeatCapacitiesValue` — attribute def
- `ISQThermodynamics::ratioOfSpecificHeatCapacities` — attribute
- `ISQThermodynamics::IsentropicExponentValue` — attribute def
- `ISQThermodynamics::isentropicExponent` — attribute
- `ISQThermodynamics::EntropyValue` — attribute def
- `ISQThermodynamics::entropy` — attribute
- `ISQThermodynamics::EntropyUnit` — attribute def
- `ISQThermodynamics::EntropyUnit::lengthPF` — attribute
- `ISQThermodynamics::EntropyUnit::massPF` — attribute
- `ISQThermodynamics::EntropyUnit::durationPF` — attribute
- `ISQThermodynamics::EntropyUnit::thermodynamicTemperaturePF` — attribute
- `ISQThermodynamics::SpecificEntropyValue` — attribute def
- `ISQThermodynamics::specificEntropy` — attribute
- `ISQThermodynamics::SpecificEntropyUnit` — attribute def
- `ISQThermodynamics::SpecificEntropyUnit::lengthPF` — attribute
- `ISQThermodynamics::SpecificEntropyUnit::durationPF` — attribute
- `ISQThermodynamics::SpecificEntropyUnit::thermodynamicTemperaturePF` — attribute
- `ISQThermodynamics::EnergyValue` — attribute def
- `ISQThermodynamics::energy` — attribute
- `ISQThermodynamics::EnergyUnit` — attribute def
- `ISQThermodynamics::EnergyUnit::lengthPF` — attribute
- `ISQThermodynamics::EnergyUnit::massPF` — attribute
- `ISQThermodynamics::EnergyUnit::durationPF` — attribute
- `ISQThermodynamics::internalEnergy` — attribute
- `ISQThermodynamics::enthalpy` — attribute
- `ISQThermodynamics::helmholtzEnergy` — attribute
- `ISQThermodynamics::gibbsEnergy` — attribute
- `ISQThermodynamics::SpecificEnergyValue` — attribute def
- `ISQThermodynamics::specificEnergy` — attribute
- `ISQThermodynamics::SpecificEnergyUnit` — attribute def
- `ISQThermodynamics::SpecificEnergyUnit::lengthPF` — attribute
- `ISQThermodynamics::SpecificEnergyUnit::durationPF` — attribute
- `ISQThermodynamics::specificInternalEnergy` — attribute
- `ISQThermodynamics::SpecificEnthalpyValue` — attribute def
- `ISQThermodynamics::specificEnthalpy` — attribute
- `ISQThermodynamics::SpecificEnthalpyUnit` — attribute def
- `ISQThermodynamics::SpecificEnthalpyUnit::lengthPF` — attribute
- `ISQThermodynamics::SpecificEnthalpyUnit::durationPF` — attribute
- `ISQThermodynamics::specificHelmholtzEnergy` — attribute
- `ISQThermodynamics::specificGibbsEnergy` — attribute
- `ISQThermodynamics::MassieuFunctionValue` — attribute def
- `ISQThermodynamics::massieuFunction` — attribute
- `ISQThermodynamics::MassieuFunctionUnit` — attribute def
- `ISQThermodynamics::MassieuFunctionUnit::lengthPF` — attribute
- `ISQThermodynamics::MassieuFunctionUnit::massPF` — attribute
- `ISQThermodynamics::MassieuFunctionUnit::durationPF` — attribute
- `ISQThermodynamics::MassieuFunctionUnit::thermodynamicTemperaturePF` — attribute
- `ISQThermodynamics::PlanckFunctionValue` — attribute def
- `ISQThermodynamics::planckFunction` — attribute
- `ISQThermodynamics::PlanckFunctionUnit` — attribute def
- `ISQThermodynamics::PlanckFunctionUnit::lengthPF` — attribute
- `ISQThermodynamics::PlanckFunctionUnit::massPF` — attribute
- `ISQThermodynamics::PlanckFunctionUnit::durationPF` — attribute
- `ISQThermodynamics::PlanckFunctionUnit::thermodynamicTemperaturePF` — attribute
- `ISQThermodynamics::JouleThomsonCoefficientValue` — attribute def
- `ISQThermodynamics::jouleThomsonCoefficient` — attribute
- `ISQThermodynamics::JouleThomsonCoefficientUnit` — attribute def
- `ISQThermodynamics::JouleThomsonCoefficientUnit::lengthPF` — attribute
- `ISQThermodynamics::JouleThomsonCoefficientUnit::massPF` — attribute
- `ISQThermodynamics::JouleThomsonCoefficientUnit::durationPF` — attribute
- `ISQThermodynamics::JouleThomsonCoefficientUnit::thermodynamicTemperaturePF` — attribute
- `ISQThermodynamics::ThermalEfficiencyValue` — attribute def
- `ISQThermodynamics::thermalEfficiency` — attribute
- `ISQThermodynamics::MaximumThermalEfficiencyValue` — attribute def
- `ISQThermodynamics::maximumThermalEfficiency` — attribute
- `ISQThermodynamics::SpecificGasConstantValue` — attribute def
- `ISQThermodynamics::specificGasConstant` — attribute
- `ISQThermodynamics::SpecificGasConstantUnit` — attribute def
- `ISQThermodynamics::SpecificGasConstantUnit::lengthPF` — attribute
- `ISQThermodynamics::SpecificGasConstantUnit::durationPF` — attribute
- `ISQThermodynamics::SpecificGasConstantUnit::thermodynamicTemperaturePF` — attribute
- `ISQThermodynamics::MassConcentrationOfWaterValue` — attribute def
- `ISQThermodynamics::massConcentrationOfWater` — attribute
- `ISQThermodynamics::MassConcentrationOfWaterUnit` — attribute def
- `ISQThermodynamics::MassConcentrationOfWaterUnit::lengthPF` — attribute
- `ISQThermodynamics::MassConcentrationOfWaterUnit::massPF` — attribute
- `ISQThermodynamics::MassConcentrationOfWaterVapourAbsoluteHumidityValue` — attribute def
- `ISQThermodynamics::massConcentrationOfWaterVapourAbsoluteHumidity` — attribute
- `ISQThermodynamics::MassConcentrationOfWaterVapourAbsoluteHumidityUnit` — attribute def
- `ISQThermodynamics::MassConcentrationOfWaterVapourAbsoluteHumidityUnit::lengthPF` — attribute
- `ISQThermodynamics::MassConcentrationOfWaterVapourAbsoluteHumidityUnit::massPF` — attribute
- `ISQThermodynamics::MassRatioOfWaterToDryMatterValue` — attribute def
- `ISQThermodynamics::massRatioOfWaterToDryMatter` — attribute
- `ISQThermodynamics::MassRatioOfWaterVapourToDryGasValue` — attribute def
- `ISQThermodynamics::massRatioOfWaterVapourToDryGas` — attribute
- `ISQThermodynamics::MassFractionOfWaterValue` — attribute def
- `ISQThermodynamics::massFractionOfWater` — attribute
- `ISQThermodynamics::MassFractionOfDryMatterValue` — attribute def
- `ISQThermodynamics::massFractionOfDryMatter` — attribute
- `ISQThermodynamics::RelativeHumidityValue` — attribute def
- `ISQThermodynamics::relativeHumidity` — attribute
- `ISQThermodynamics::RelativeMassConcentrationOfVapourValue` — attribute def
- `ISQThermodynamics::relativeMassConcentrationOfVapour` — attribute
- `ISQThermodynamics::RelativeMassRatioOfVapourValue` — attribute def
- `ISQThermodynamics::relativeMassRatioOfVapour` — attribute
- `ISQThermodynamics::dewPointTemperature` — attribute
