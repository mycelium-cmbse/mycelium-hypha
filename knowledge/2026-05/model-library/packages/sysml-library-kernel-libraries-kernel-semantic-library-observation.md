...
language: KerML
source: sysml.library/Kernel Libraries/Kernel Semantic Library/Observation.kerml
declares: [Observation, Observation::DefaultMonitorLife, Observation::defaultMonitor, Observation::ChangeSignal, Observation::ChangeSignal::signalCondition, Observation::ChangeSignal::signalMonitor, Observation::ObserveChange, Observation::ObserveChange::changeObserver, Observation::ObserveChange::changeSignal, Observation::ObserveChange::wait, Observation::ObserveChange::wait::onOccurrence, Observation::ObserveChange::transfer, Observation::ObserveChange::transfer::source, Observation::ObserveChange::transfer::target, Observation::ChangeMonitor, Observation::ChangeMonitor::observations, Observation::ChangeMonitor::AssignObservations, Observation::ChangeMonitor::AssignObservations::monitor, Observation::ChangeMonitor::startObservation, Observation::ChangeMonitor::startObservation::observation, Observation::ChangeMonitor::startObservation::addObservation, Observation::ChangeMonitor::cancelObservation, Observation::ChangeMonitor::cancelObservation::observations, Observation::ChangeMonitor::cancelObservation::removeObservation]
license: EPL-2.0
---

# Observation

Verbatim KerML standard-library source from `sysml.library/Kernel Libraries/Kernel Semantic Library/Observation.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `Observation` — standard library package
- `Observation::DefaultMonitorLife` — struct
- `Observation::defaultMonitor` — feature
- `Observation::ChangeSignal` — struct
- `Observation::ChangeSignal::signalCondition` — bool
- `Observation::ChangeSignal::signalMonitor` — feature
- `Observation::ObserveChange` — behavior
- `Observation::ObserveChange::changeObserver` — feature
- `Observation::ObserveChange::changeSignal` — feature
- `Observation::ObserveChange::wait` — step
- `Observation::ObserveChange::wait::onOccurrence` — bool
- `Observation::ObserveChange::transfer` — step
- `Observation::ObserveChange::transfer::source` — feature
- `Observation::ObserveChange::transfer::target` — feature
- `Observation::ChangeMonitor` — struct
- `Observation::ChangeMonitor::observations` — feature
- `Observation::ChangeMonitor::AssignObservations` — behavior
- `Observation::ChangeMonitor::AssignObservations::monitor` — feature
- `Observation::ChangeMonitor::startObservation` — step
- `Observation::ChangeMonitor::startObservation::observation` — step
- `Observation::ChangeMonitor::startObservation::addObservation` — step
- `Observation::ChangeMonitor::cancelObservation` — step
- `Observation::ChangeMonitor::cancelObservation::observations` — feature
- `Observation::ChangeMonitor::cancelObservation::removeObservation` — step
