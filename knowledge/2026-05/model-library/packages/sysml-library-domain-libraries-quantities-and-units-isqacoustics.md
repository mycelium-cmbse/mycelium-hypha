...
language: SysML
source: sysml.library/Domain Libraries/Quantities and Units/ISQAcoustics.sysml
declares: [ISQAcoustics, ISQAcoustics::LogarithmicFrequencyRangeValue, ISQAcoustics::logarithmicFrequencyRange, ISQAcoustics::LogarithmicFrequencyRangeUnit, ISQAcoustics::staticPressure, ISQAcoustics::soundPressure, ISQAcoustics::CartesianSoundParticleDisplacement3dVector, ISQAcoustics::cartesianSoundParticleDisplacement3dVector, ISQAcoustics::CartesianSoundParticleVelocity3dVector, ISQAcoustics::cartesianSoundParticleVelocity3dVector, ISQAcoustics::CartesianSoundParticleAcceleration3dVector, ISQAcoustics::cartesianSoundParticleAcceleration3dVector, ISQAcoustics::volumeVelocity, ISQAcoustics::SoundEnergyDensityValue, ISQAcoustics::soundEnergyDensity, ISQAcoustics::SoundEnergyDensityUnit, ISQAcoustics::SoundEnergyDensityUnit::lengthPF, ISQAcoustics::SoundEnergyDensityUnit::massPF, ISQAcoustics::SoundEnergyDensityUnit::durationPF, ISQAcoustics::soundEnergy, ISQAcoustics::soundPower, ISQAcoustics::SoundIntensityValue, ISQAcoustics::soundIntensity, ISQAcoustics::SoundIntensityUnit, ISQAcoustics::SoundIntensityUnit::massPF, ISQAcoustics::SoundIntensityUnit::durationPF, ISQAcoustics::CartesianSoundIntensity3dVector, ISQAcoustics::cartesianSoundIntensity3dVector, ISQAcoustics::CartesianSoundIntensity3dCoordinateFrame, ISQAcoustics::SoundExposureValue, ISQAcoustics::soundExposure, ISQAcoustics::SoundExposureUnit, ISQAcoustics::SoundExposureUnit::lengthPF, ISQAcoustics::SoundExposureUnit::massPF, ISQAcoustics::SoundExposureUnit::durationPF, ISQAcoustics::CharacteristicImpedanceOfAMediumForLongitudinalWavesValue, ISQAcoustics::characteristicImpedanceOfAMediumForLongitudinalWaves, ISQAcoustics::CharacteristicImpedanceOfAMediumForLongitudinalWavesUnit, ISQAcoustics::CharacteristicImpedanceOfAMediumForLongitudinalWavesUnit::lengthPF, ISQAcoustics::CharacteristicImpedanceOfAMediumForLongitudinalWavesUnit::massPF, ISQAcoustics::CharacteristicImpedanceOfAMediumForLongitudinalWavesUnit::durationPF, ISQAcoustics::AcousticImpedanceValue, ISQAcoustics::acousticImpedance, ISQAcoustics::AcousticImpedanceUnit, ISQAcoustics::AcousticImpedanceUnit::lengthPF, ISQAcoustics::AcousticImpedanceUnit::massPF, ISQAcoustics::AcousticImpedanceUnit::durationPF, ISQAcoustics::SoundPressureLevelValue, ISQAcoustics::soundPressureLevel, ISQAcoustics::SoundPressureLevelUnit, ISQAcoustics::SoundPowerLevelValue, ISQAcoustics::soundPowerLevel, ISQAcoustics::SoundPowerLevelUnit, ISQAcoustics::SoundExposureLevelValue, ISQAcoustics::soundExposureLevel, ISQAcoustics::SoundExposureLevelUnit, ISQAcoustics::reverberationTime]
license: EPL-2.0
---

# ISQAcoustics

Verbatim SysML standard-library source from `sysml.library/Domain Libraries/Quantities and Units/ISQAcoustics.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `ISQAcoustics` — standard library package
- `ISQAcoustics::LogarithmicFrequencyRangeValue` — attribute def
- `ISQAcoustics::logarithmicFrequencyRange` — attribute
- `ISQAcoustics::LogarithmicFrequencyRangeUnit` — attribute def
- `ISQAcoustics::staticPressure` — attribute
- `ISQAcoustics::soundPressure` — attribute
- `ISQAcoustics::CartesianSoundParticleDisplacement3dVector` — attribute def
- `ISQAcoustics::cartesianSoundParticleDisplacement3dVector` — attribute
- `ISQAcoustics::CartesianSoundParticleVelocity3dVector` — attribute def
- `ISQAcoustics::cartesianSoundParticleVelocity3dVector` — attribute
- `ISQAcoustics::CartesianSoundParticleAcceleration3dVector` — attribute def
- `ISQAcoustics::cartesianSoundParticleAcceleration3dVector` — attribute
- `ISQAcoustics::volumeVelocity` — attribute
- `ISQAcoustics::SoundEnergyDensityValue` — attribute def
- `ISQAcoustics::soundEnergyDensity` — attribute
- `ISQAcoustics::SoundEnergyDensityUnit` — attribute def
- `ISQAcoustics::SoundEnergyDensityUnit::lengthPF` — attribute
- `ISQAcoustics::SoundEnergyDensityUnit::massPF` — attribute
- `ISQAcoustics::SoundEnergyDensityUnit::durationPF` — attribute
- `ISQAcoustics::soundEnergy` — attribute
- `ISQAcoustics::soundPower` — attribute
- `ISQAcoustics::SoundIntensityValue` — attribute def
- `ISQAcoustics::soundIntensity` — attribute
- `ISQAcoustics::SoundIntensityUnit` — attribute def
- `ISQAcoustics::SoundIntensityUnit::massPF` — attribute
- `ISQAcoustics::SoundIntensityUnit::durationPF` — attribute
- `ISQAcoustics::CartesianSoundIntensity3dVector` — attribute def
- `ISQAcoustics::cartesianSoundIntensity3dVector` — attribute
- `ISQAcoustics::CartesianSoundIntensity3dCoordinateFrame` — attribute def
- `ISQAcoustics::SoundExposureValue` — attribute def
- `ISQAcoustics::soundExposure` — attribute
- `ISQAcoustics::SoundExposureUnit` — attribute def
- `ISQAcoustics::SoundExposureUnit::lengthPF` — attribute
- `ISQAcoustics::SoundExposureUnit::massPF` — attribute
- `ISQAcoustics::SoundExposureUnit::durationPF` — attribute
- `ISQAcoustics::CharacteristicImpedanceOfAMediumForLongitudinalWavesValue` — attribute def
- `ISQAcoustics::characteristicImpedanceOfAMediumForLongitudinalWaves` — attribute
- `ISQAcoustics::CharacteristicImpedanceOfAMediumForLongitudinalWavesUnit` — attribute def
- `ISQAcoustics::CharacteristicImpedanceOfAMediumForLongitudinalWavesUnit::lengthPF` — attribute
- `ISQAcoustics::CharacteristicImpedanceOfAMediumForLongitudinalWavesUnit::massPF` — attribute
- `ISQAcoustics::CharacteristicImpedanceOfAMediumForLongitudinalWavesUnit::durationPF` — attribute
- `ISQAcoustics::AcousticImpedanceValue` — attribute def
- `ISQAcoustics::acousticImpedance` — attribute
- `ISQAcoustics::AcousticImpedanceUnit` — attribute def
- `ISQAcoustics::AcousticImpedanceUnit::lengthPF` — attribute
- `ISQAcoustics::AcousticImpedanceUnit::massPF` — attribute
- `ISQAcoustics::AcousticImpedanceUnit::durationPF` — attribute
- `ISQAcoustics::SoundPressureLevelValue` — attribute def
- `ISQAcoustics::soundPressureLevel` — attribute
- `ISQAcoustics::SoundPressureLevelUnit` — attribute def
- `ISQAcoustics::SoundPowerLevelValue` — attribute def
- `ISQAcoustics::soundPowerLevel` — attribute
- `ISQAcoustics::SoundPowerLevelUnit` — attribute def
- `ISQAcoustics::SoundExposureLevelValue` — attribute def
- `ISQAcoustics::soundExposureLevel` — attribute
- `ISQAcoustics::SoundExposureLevelUnit` — attribute def
- `ISQAcoustics::reverberationTime` — attribute
