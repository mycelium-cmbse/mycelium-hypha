...
language: SysML
source: sysml.library/Systems Library/Actions.sysml
declares: [Actions, Actions::Action, Actions::Action::self, Actions::Action::incomingTransfers, Actions::Action::start, Actions::Action::done, Actions::Action::subactions, Actions::Action::sendSubactions, Actions::Action::acceptSubactions, Actions::Action::terminateSubactions, Actions::Action::controls, Actions::Action::merges, Actions::Action::decisions, Actions::Action::joins, Actions::Action::forks, Actions::Action::transitions, Actions::Action::decisionTransitions, Actions::Action::assignments, Actions::Action::ifSubactions, Actions::Action::loops, Actions::Action::whileLoops, Actions::Action::forLoops, Actions::actions, Actions::SendAction, Actions::sendActions, Actions::AcceptMessageAction, Actions::AcceptAction, Actions::AcceptAction::aState, Actions::AcceptAction::aState::aTransition, Actions::acceptActions, Actions::TerminateAction, Actions::TerminateAction::terminatedOccurrence, Actions::TerminateAction::terminateOccurrence, Actions::terminateActions, Actions::terminateActions::terminatedOccurrence, Actions::ControlAction, Actions::MergeAction, Actions::DecisionAction, Actions::JoinAction, Actions::ForkAction, Actions::TransitionAction, Actions::TransitionAction::accepter, Actions::TransitionAction::effect, Actions::DecisionTransitionAction, Actions::transitionActions, Actions::AssignmentAction, Actions::assignmentActions, Actions::IfThenAction, Actions::IfThenAction::thenClause, Actions::IfThenElseAction, Actions::IfThenElseAction::thenClause, Actions::IfThenElseAction::elseClause, Actions::ifThenActions, Actions::ifThenElseActions, Actions::LoopAction, Actions::LoopAction::body, Actions::WhileLoopAction, Actions::WhileLoopAction::body, Actions::ForLoopAction, Actions::ForLoopAction::body, Actions::ForLoopAction::index, Actions::ForLoopAction::initialization, Actions::ForLoopAction::whileLoop, Actions::loopActions, Actions::whileLoopActions, Actions::forLoopActions]
license: EPL-2.0
---

# Actions

Verbatim SysML standard-library source from `sysml.library/Systems Library/Actions.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `Actions` — standard library package
- `Actions::Action` — action def
- `Actions::Action::self` — action
- `Actions::Action::incomingTransfers` — action
- `Actions::Action::start` — action
- `Actions::Action::done` — action
- `Actions::Action::subactions` — action
- `Actions::Action::sendSubactions` — action
- `Actions::Action::acceptSubactions` — action
- `Actions::Action::terminateSubactions` — action
- `Actions::Action::controls` — action
- `Actions::Action::merges` — action
- `Actions::Action::decisions` — action
- `Actions::Action::joins` — action
- `Actions::Action::forks` — action
- `Actions::Action::transitions` — action
- `Actions::Action::decisionTransitions` — action
- `Actions::Action::assignments` — action
- `Actions::Action::ifSubactions` — action
- `Actions::Action::loops` — action
- `Actions::Action::whileLoops` — action
- `Actions::Action::forLoops` — action
- `Actions::actions` — action
- `Actions::SendAction` — action def
- `Actions::sendActions` — action
- `Actions::AcceptMessageAction` — action def
- `Actions::AcceptAction` — action def
- `Actions::AcceptAction::aState` — state
- `Actions::AcceptAction::aState::aTransition` — transition
- `Actions::acceptActions` — action
- `Actions::TerminateAction` — action def
- `Actions::TerminateAction::terminatedOccurrence` — occurrence
- `Actions::TerminateAction::terminateOccurrence` — action
- `Actions::terminateActions` — action
- `Actions::terminateActions::terminatedOccurrence` — occurrence
- `Actions::ControlAction` — action def
- `Actions::MergeAction` — action def
- `Actions::DecisionAction` — action def
- `Actions::JoinAction` — action def
- `Actions::ForkAction` — action def
- `Actions::TransitionAction` — action def
- `Actions::TransitionAction::accepter` — action
- `Actions::TransitionAction::effect` — action
- `Actions::DecisionTransitionAction` — action def
- `Actions::transitionActions` — action
- `Actions::AssignmentAction` — action def
- `Actions::assignmentActions` — action
- `Actions::IfThenAction` — action def
- `Actions::IfThenAction::thenClause` — action
- `Actions::IfThenElseAction` — action def
- `Actions::IfThenElseAction::thenClause` — action
- `Actions::IfThenElseAction::elseClause` — action
- `Actions::ifThenActions` — action
- `Actions::ifThenElseActions` — action
- `Actions::LoopAction` — action def
- `Actions::LoopAction::body` — action
- `Actions::WhileLoopAction` — action def
- `Actions::WhileLoopAction::body` — action
- `Actions::ForLoopAction` — action def
- `Actions::ForLoopAction::body` — action
- `Actions::ForLoopAction::index` — attribute
- `Actions::ForLoopAction::initialization` — action
- `Actions::ForLoopAction::whileLoop` — action
- `Actions::loopActions` — action
- `Actions::whileLoopActions` — action
- `Actions::forLoopActions` — action
