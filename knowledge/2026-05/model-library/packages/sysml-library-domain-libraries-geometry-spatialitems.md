...
language: SysML
source: sysml.library/Domain Libraries/Geometry/SpatialItems.sysml
declares: [SpatialItems, SpatialItems::SpatialItem, SpatialItems::SpatialItem::coordinateFrame, SpatialItems::SpatialItem::originPoint, SpatialItems::SpatialItem::originPointConstraint, SpatialItems::SpatialItem::subSpatialItems, SpatialItems::SpatialItem::subSpatialParts, SpatialItems::SpatialItem::componentItems, SpatialItems::SpatialItem::cunionNum, SpatialItems::SpatialItem::componentUnion, SpatialItems::SpatialItem::componentParts, SpatialItems::PositionOf, SpatialItems::CurrentPositionOf, SpatialItems::DisplacementOf, SpatialItems::CurrentDisplacementOf]
license: EPL-2.0
---

# SpatialItems

Verbatim SysML standard-library source from `sysml.library/Domain Libraries/Geometry/SpatialItems.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `SpatialItems` — standard library package
- `SpatialItems::SpatialItem` — item def
- `SpatialItems::SpatialItem::coordinateFrame` — attribute
- `SpatialItems::SpatialItem::originPoint` — item
- `SpatialItems::SpatialItem::originPointConstraint` — assert constraint
- `SpatialItems::SpatialItem::subSpatialItems` — item
- `SpatialItems::SpatialItem::subSpatialParts` — part
- `SpatialItems::SpatialItem::componentItems` — item
- `SpatialItems::SpatialItem::cunionNum` — attribute
- `SpatialItems::SpatialItem::componentUnion` — attribute
- `SpatialItems::SpatialItem::componentParts` — part
- `SpatialItems::PositionOf` — calc def
- `SpatialItems::CurrentPositionOf` — calc def
- `SpatialItems::DisplacementOf` — calc def
- `SpatialItems::CurrentDisplacementOf` — calc def
