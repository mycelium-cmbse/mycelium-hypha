---
name: ISQCondensedMatter
kind: model-library-file
language: SysML
source: sysml.library/Domain Libraries/Quantities and Units/ISQCondensedMatter.sysml
declares: [ISQCondensedMatter, ISQCondensedMatter::CartesianLattice3dVector, ISQCondensedMatter::cartesianLattice3dVector, ISQCondensedMatter::CartesianFundamentalLattice3dVector, ISQCondensedMatter::cartesianFundamentalLattice3dVector, ISQCondensedMatter::AngularReciprocalLatticeVectorMagnitudeValue, ISQCondensedMatter::angularReciprocalLatticeVectorMagnitude, ISQCondensedMatter::AngularReciprocalLatticeVectorMagnitudeUnit, ISQCondensedMatter::AngularReciprocalLatticeVectorMagnitudeUnit::lengthPF, ISQCondensedMatter::CartesianAngularReciprocalLattice3dVector, ISQCondensedMatter::cartesianAngularReciprocalLattice3dVector, ISQCondensedMatter::CartesianAngularReciprocalLattice3dCoordinateFrame, ISQCondensedMatter::FundamentalReciprocalLatticeVectorMagnitudeValue, ISQCondensedMatter::fundamentalReciprocalLatticeVectorMagnitude, ISQCondensedMatter::FundamentalReciprocalLatticeVectorMagnitudeUnit, ISQCondensedMatter::FundamentalReciprocalLatticeVectorMagnitudeUnit::lengthPF, ISQCondensedMatter::CartesianFundamentalReciprocalLattice3dVector, ISQCondensedMatter::cartesianFundamentalReciprocalLattice3dVector, ISQCondensedMatter::CartesianFundamentalReciprocalLattice3dCoordinateFrame, ISQCondensedMatter::latticePlaneSpacing, ISQCondensedMatter::braggAngle, ISQCondensedMatter::ShortRangeOrderParameterValue, ISQCondensedMatter::shortRangeOrderParameter, ISQCondensedMatter::LongRangeOrderParameterValue, ISQCondensedMatter::longRangeOrderParameter, ISQCondensedMatter::AtomicScatteringFactorValue, ISQCondensedMatter::atomicScatteringFactor, ISQCondensedMatter::StructureFactorValue, ISQCondensedMatter::structureFactor, ISQCondensedMatter::CartesianBurgers3dVector, ISQCondensedMatter::cartesianBurgers3dVector, ISQCondensedMatter::CartesianParticlePosition3dVector, ISQCondensedMatter::cartesianParticlePosition3dVector, ISQCondensedMatter::CartesianEquilibriumPosition3dVector, ISQCondensedMatter::cartesianEquilibriumPosition3dVector, ISQCondensedMatter::CartesianDisplacement3dVector, ISQCondensedMatter::cartesianDisplacement3dVector, ISQCondensedMatter::DebyeWallerFactorValue, ISQCondensedMatter::debyeWallerFactor, ISQCondensedMatter::angularWavenumber, ISQCondensedMatter::fermiAngularWavenumber, ISQCondensedMatter::debyeAngularWavenumber, ISQCondensedMatter::debyeAngularFrequency, ISQCondensedMatter::debyeTemperature, ISQCondensedMatter::DensityOfVibrationalStatesValue, ISQCondensedMatter::densityOfVibrationalStates, ISQCondensedMatter::DensityOfVibrationalStatesUnit, ISQCondensedMatter::DensityOfVibrationalStatesUnit::lengthPF, ISQCondensedMatter::DensityOfVibrationalStatesUnit::durationPF, ISQCondensedMatter::ThermodynamicGrüneisenParameterValue, ISQCondensedMatter::thermodynamicGrüneisenParameter, ISQCondensedMatter::GrüneisenParameterValue, ISQCondensedMatter::grüneisenParameter, ISQCondensedMatter::meanFreePathOfPhonons, ISQCondensedMatter::meanFreePathOfElectrons, ISQCondensedMatter::EnergyDensityOfStatesValue, ISQCondensedMatter::energyDensityOfStates, ISQCondensedMatter::EnergyDensityOfStatesUnit, ISQCondensedMatter::EnergyDensityOfStatesUnit::lengthPF, ISQCondensedMatter::EnergyDensityOfStatesUnit::massPF, ISQCondensedMatter::EnergyDensityOfStatesUnit::durationPF, ISQCondensedMatter::residualResistivity, ISQCondensedMatter::LorenzCoefficientValue, ISQCondensedMatter::lorenzCoefficient, ISQCondensedMatter::LorenzCoefficientUnit, ISQCondensedMatter::LorenzCoefficientUnit::lengthPF, ISQCondensedMatter::LorenzCoefficientUnit::massPF, ISQCondensedMatter::LorenzCoefficientUnit::durationPF, ISQCondensedMatter::LorenzCoefficientUnit::electricCurrentPF, ISQCondensedMatter::LorenzCoefficientUnit::thermodynamicTemperaturePF, ISQCondensedMatter::HallCoefficientValue, ISQCondensedMatter::hallCoefficient, ISQCondensedMatter::HallCoefficientUnit, ISQCondensedMatter::HallCoefficientUnit::lengthPF, ISQCondensedMatter::HallCoefficientUnit::durationPF, ISQCondensedMatter::HallCoefficientUnit::electricCurrentPF, ISQCondensedMatter::thermoelectricVoltageBetweenSubstancesAAndB, ISQCondensedMatter::SeebeckCoefficientForSubstancesAAndBValue, ISQCondensedMatter::seebeckCoefficientForSubstancesAAndB, ISQCondensedMatter::SeebeckCoefficientForSubstancesAAndBUnit, ISQCondensedMatter::SeebeckCoefficientForSubstancesAAndBUnit::lengthPF, ISQCondensedMatter::SeebeckCoefficientForSubstancesAAndBUnit::massPF, ISQCondensedMatter::SeebeckCoefficientForSubstancesAAndBUnit::durationPF, ISQCondensedMatter::SeebeckCoefficientForSubstancesAAndBUnit::electricCurrentPF, ISQCondensedMatter::SeebeckCoefficientForSubstancesAAndBUnit::thermodynamicTemperaturePF, ISQCondensedMatter::peltierCoefficientForSubstancesAAndB, ISQCondensedMatter::ThomsonCoefficientValue, ISQCondensedMatter::thomsonCoefficient, ISQCondensedMatter::ThomsonCoefficientUnit, ISQCondensedMatter::ThomsonCoefficientUnit::lengthPF, ISQCondensedMatter::ThomsonCoefficientUnit::massPF, ISQCondensedMatter::ThomsonCoefficientUnit::durationPF, ISQCondensedMatter::ThomsonCoefficientUnit::electricCurrentPF, ISQCondensedMatter::ThomsonCoefficientUnit::thermodynamicTemperaturePF, ISQCondensedMatter::workFunction, ISQCondensedMatter::ionizationEnergy, ISQCondensedMatter::electronAffinity, ISQCondensedMatter::RichardsonConstantValue, ISQCondensedMatter::richardsonConstant, ISQCondensedMatter::RichardsonConstantUnit, ISQCondensedMatter::RichardsonConstantUnit::lengthPF, ISQCondensedMatter::RichardsonConstantUnit::electricCurrentPF, ISQCondensedMatter::RichardsonConstantUnit::thermodynamicTemperaturePF, ISQCondensedMatter::fermiEnergy, ISQCondensedMatter::gapEnergy, ISQCondensedMatter::fermiTemperature, ISQCondensedMatter::ElectronDensityValue, ISQCondensedMatter::electronDensity, ISQCondensedMatter::ElectronDensityUnit, ISQCondensedMatter::ElectronDensityUnit::lengthPF, ISQCondensedMatter::HoleDensityValue, ISQCondensedMatter::holeDensity, ISQCondensedMatter::HoleDensityUnit, ISQCondensedMatter::HoleDensityUnit::lengthPF, ISQCondensedMatter::IntrinsicCarrierDensityValue, ISQCondensedMatter::intrinsicCarrierDensity, ISQCondensedMatter::IntrinsicCarrierDensityUnit, ISQCondensedMatter::IntrinsicCarrierDensityUnit::lengthPF, ISQCondensedMatter::DonorDensityValue, ISQCondensedMatter::donorDensity, ISQCondensedMatter::DonorDensityUnit, ISQCondensedMatter::DonorDensityUnit::lengthPF, ISQCondensedMatter::AcceptorDensityValue, ISQCondensedMatter::acceptorDensity, ISQCondensedMatter::AcceptorDensityUnit, ISQCondensedMatter::AcceptorDensityUnit::lengthPF, ISQCondensedMatter::effectiveMass, ISQCondensedMatter::MobilityRatioValue, ISQCondensedMatter::mobilityRatio, ISQCondensedMatter::relaxationTime, ISQCondensedMatter::carrierLifetime, ISQCondensedMatter::diffusionLengthForCondensedMatterPhysics, ISQCondensedMatter::exchangeIntegral, ISQCondensedMatter::curieTemperature, ISQCondensedMatter::néelTemperature, ISQCondensedMatter::superconductionTransitionTemperature, ISQCondensedMatter::thermodynamicCriticalMagneticFluxDensity, ISQCondensedMatter::lowerCriticalMagneticFluxDensity, ISQCondensedMatter::upperCriticalMagneticFluxDensity, ISQCondensedMatter::superconductorEnergyGap, ISQCondensedMatter::londonPenetrationDepth, ISQCondensedMatter::coherenceLength]
license: EPL-2.0
---

# ISQCondensedMatter

Verbatim SysML standard-library source from `sysml.library/Domain Libraries/Quantities and Units/ISQCondensedMatter.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `ISQCondensedMatter` — standard library package
- `ISQCondensedMatter::CartesianLattice3dVector` — attribute def
- `ISQCondensedMatter::cartesianLattice3dVector` — attribute
- `ISQCondensedMatter::CartesianFundamentalLattice3dVector` — attribute def
- `ISQCondensedMatter::cartesianFundamentalLattice3dVector` — attribute
- `ISQCondensedMatter::AngularReciprocalLatticeVectorMagnitudeValue` — attribute def
- `ISQCondensedMatter::angularReciprocalLatticeVectorMagnitude` — attribute
- `ISQCondensedMatter::AngularReciprocalLatticeVectorMagnitudeUnit` — attribute def
- `ISQCondensedMatter::AngularReciprocalLatticeVectorMagnitudeUnit::lengthPF` — attribute
- `ISQCondensedMatter::CartesianAngularReciprocalLattice3dVector` — attribute def
- `ISQCondensedMatter::cartesianAngularReciprocalLattice3dVector` — attribute
- `ISQCondensedMatter::CartesianAngularReciprocalLattice3dCoordinateFrame` — attribute def
- `ISQCondensedMatter::FundamentalReciprocalLatticeVectorMagnitudeValue` — attribute def
- `ISQCondensedMatter::fundamentalReciprocalLatticeVectorMagnitude` — attribute
- `ISQCondensedMatter::FundamentalReciprocalLatticeVectorMagnitudeUnit` — attribute def
- `ISQCondensedMatter::FundamentalReciprocalLatticeVectorMagnitudeUnit::lengthPF` — attribute
- `ISQCondensedMatter::CartesianFundamentalReciprocalLattice3dVector` — attribute def
- `ISQCondensedMatter::cartesianFundamentalReciprocalLattice3dVector` — attribute
- `ISQCondensedMatter::CartesianFundamentalReciprocalLattice3dCoordinateFrame` — attribute def
- `ISQCondensedMatter::latticePlaneSpacing` — attribute
- `ISQCondensedMatter::braggAngle` — attribute
- `ISQCondensedMatter::ShortRangeOrderParameterValue` — attribute def
- `ISQCondensedMatter::shortRangeOrderParameter` — attribute
- `ISQCondensedMatter::LongRangeOrderParameterValue` — attribute def
- `ISQCondensedMatter::longRangeOrderParameter` — attribute
- `ISQCondensedMatter::AtomicScatteringFactorValue` — attribute def
- `ISQCondensedMatter::atomicScatteringFactor` — attribute
- `ISQCondensedMatter::StructureFactorValue` — attribute def
- `ISQCondensedMatter::structureFactor` — attribute
- `ISQCondensedMatter::CartesianBurgers3dVector` — attribute def
- `ISQCondensedMatter::cartesianBurgers3dVector` — attribute
- `ISQCondensedMatter::CartesianParticlePosition3dVector` — attribute def
- `ISQCondensedMatter::cartesianParticlePosition3dVector` — attribute
- `ISQCondensedMatter::CartesianEquilibriumPosition3dVector` — attribute def
- `ISQCondensedMatter::cartesianEquilibriumPosition3dVector` — attribute
- `ISQCondensedMatter::CartesianDisplacement3dVector` — attribute def
- `ISQCondensedMatter::cartesianDisplacement3dVector` — attribute
- `ISQCondensedMatter::DebyeWallerFactorValue` — attribute def
- `ISQCondensedMatter::debyeWallerFactor` — attribute
- `ISQCondensedMatter::angularWavenumber` — attribute
- `ISQCondensedMatter::fermiAngularWavenumber` — attribute
- `ISQCondensedMatter::debyeAngularWavenumber` — attribute
- `ISQCondensedMatter::debyeAngularFrequency` — attribute
- `ISQCondensedMatter::debyeTemperature` — attribute
- `ISQCondensedMatter::DensityOfVibrationalStatesValue` — attribute def
- `ISQCondensedMatter::densityOfVibrationalStates` — attribute
- `ISQCondensedMatter::DensityOfVibrationalStatesUnit` — attribute def
- `ISQCondensedMatter::DensityOfVibrationalStatesUnit::lengthPF` — attribute
- `ISQCondensedMatter::DensityOfVibrationalStatesUnit::durationPF` — attribute
- `ISQCondensedMatter::ThermodynamicGrüneisenParameterValue` — attribute def
- `ISQCondensedMatter::thermodynamicGrüneisenParameter` — attribute
- `ISQCondensedMatter::GrüneisenParameterValue` — attribute def
- `ISQCondensedMatter::grüneisenParameter` — attribute
- `ISQCondensedMatter::meanFreePathOfPhonons` — attribute
- `ISQCondensedMatter::meanFreePathOfElectrons` — attribute
- `ISQCondensedMatter::EnergyDensityOfStatesValue` — attribute def
- `ISQCondensedMatter::energyDensityOfStates` — attribute
- `ISQCondensedMatter::EnergyDensityOfStatesUnit` — attribute def
- `ISQCondensedMatter::EnergyDensityOfStatesUnit::lengthPF` — attribute
- `ISQCondensedMatter::EnergyDensityOfStatesUnit::massPF` — attribute
- `ISQCondensedMatter::EnergyDensityOfStatesUnit::durationPF` — attribute
- `ISQCondensedMatter::residualResistivity` — attribute
- `ISQCondensedMatter::LorenzCoefficientValue` — attribute def
- `ISQCondensedMatter::lorenzCoefficient` — attribute
- `ISQCondensedMatter::LorenzCoefficientUnit` — attribute def
- `ISQCondensedMatter::LorenzCoefficientUnit::lengthPF` — attribute
- `ISQCondensedMatter::LorenzCoefficientUnit::massPF` — attribute
- `ISQCondensedMatter::LorenzCoefficientUnit::durationPF` — attribute
- `ISQCondensedMatter::LorenzCoefficientUnit::electricCurrentPF` — attribute
- `ISQCondensedMatter::LorenzCoefficientUnit::thermodynamicTemperaturePF` — attribute
- `ISQCondensedMatter::HallCoefficientValue` — attribute def
- `ISQCondensedMatter::hallCoefficient` — attribute
- `ISQCondensedMatter::HallCoefficientUnit` — attribute def
- `ISQCondensedMatter::HallCoefficientUnit::lengthPF` — attribute
- `ISQCondensedMatter::HallCoefficientUnit::durationPF` — attribute
- `ISQCondensedMatter::HallCoefficientUnit::electricCurrentPF` — attribute
- `ISQCondensedMatter::thermoelectricVoltageBetweenSubstancesAAndB` — attribute
- `ISQCondensedMatter::SeebeckCoefficientForSubstancesAAndBValue` — attribute def
- `ISQCondensedMatter::seebeckCoefficientForSubstancesAAndB` — attribute
- `ISQCondensedMatter::SeebeckCoefficientForSubstancesAAndBUnit` — attribute def
- `ISQCondensedMatter::SeebeckCoefficientForSubstancesAAndBUnit::lengthPF` — attribute
- `ISQCondensedMatter::SeebeckCoefficientForSubstancesAAndBUnit::massPF` — attribute
- `ISQCondensedMatter::SeebeckCoefficientForSubstancesAAndBUnit::durationPF` — attribute
- `ISQCondensedMatter::SeebeckCoefficientForSubstancesAAndBUnit::electricCurrentPF` — attribute
- `ISQCondensedMatter::SeebeckCoefficientForSubstancesAAndBUnit::thermodynamicTemperaturePF` — attribute
- `ISQCondensedMatter::peltierCoefficientForSubstancesAAndB` — attribute
- `ISQCondensedMatter::ThomsonCoefficientValue` — attribute def
- `ISQCondensedMatter::thomsonCoefficient` — attribute
- `ISQCondensedMatter::ThomsonCoefficientUnit` — attribute def
- `ISQCondensedMatter::ThomsonCoefficientUnit::lengthPF` — attribute
- `ISQCondensedMatter::ThomsonCoefficientUnit::massPF` — attribute
- `ISQCondensedMatter::ThomsonCoefficientUnit::durationPF` — attribute
- `ISQCondensedMatter::ThomsonCoefficientUnit::electricCurrentPF` — attribute
- `ISQCondensedMatter::ThomsonCoefficientUnit::thermodynamicTemperaturePF` — attribute
- `ISQCondensedMatter::workFunction` — attribute
- `ISQCondensedMatter::ionizationEnergy` — attribute
- `ISQCondensedMatter::electronAffinity` — attribute
- `ISQCondensedMatter::RichardsonConstantValue` — attribute def
- `ISQCondensedMatter::richardsonConstant` — attribute
- `ISQCondensedMatter::RichardsonConstantUnit` — attribute def
- `ISQCondensedMatter::RichardsonConstantUnit::lengthPF` — attribute
- `ISQCondensedMatter::RichardsonConstantUnit::electricCurrentPF` — attribute
- `ISQCondensedMatter::RichardsonConstantUnit::thermodynamicTemperaturePF` — attribute
- `ISQCondensedMatter::fermiEnergy` — attribute
- `ISQCondensedMatter::gapEnergy` — attribute
- `ISQCondensedMatter::fermiTemperature` — attribute
- `ISQCondensedMatter::ElectronDensityValue` — attribute def
- `ISQCondensedMatter::electronDensity` — attribute
- `ISQCondensedMatter::ElectronDensityUnit` — attribute def
- `ISQCondensedMatter::ElectronDensityUnit::lengthPF` — attribute
- `ISQCondensedMatter::HoleDensityValue` — attribute def
- `ISQCondensedMatter::holeDensity` — attribute
- `ISQCondensedMatter::HoleDensityUnit` — attribute def
- `ISQCondensedMatter::HoleDensityUnit::lengthPF` — attribute
- `ISQCondensedMatter::IntrinsicCarrierDensityValue` — attribute def
- `ISQCondensedMatter::intrinsicCarrierDensity` — attribute
- `ISQCondensedMatter::IntrinsicCarrierDensityUnit` — attribute def
- `ISQCondensedMatter::IntrinsicCarrierDensityUnit::lengthPF` — attribute
- `ISQCondensedMatter::DonorDensityValue` — attribute def
- `ISQCondensedMatter::donorDensity` — attribute
- `ISQCondensedMatter::DonorDensityUnit` — attribute def
- `ISQCondensedMatter::DonorDensityUnit::lengthPF` — attribute
- `ISQCondensedMatter::AcceptorDensityValue` — attribute def
- `ISQCondensedMatter::acceptorDensity` — attribute
- `ISQCondensedMatter::AcceptorDensityUnit` — attribute def
- `ISQCondensedMatter::AcceptorDensityUnit::lengthPF` — attribute
- `ISQCondensedMatter::effectiveMass` — attribute
- `ISQCondensedMatter::MobilityRatioValue` — attribute def
- `ISQCondensedMatter::mobilityRatio` — attribute
- `ISQCondensedMatter::relaxationTime` — attribute
- `ISQCondensedMatter::carrierLifetime` — attribute
- `ISQCondensedMatter::diffusionLengthForCondensedMatterPhysics` — attribute
- `ISQCondensedMatter::exchangeIntegral` — attribute
- `ISQCondensedMatter::curieTemperature` — attribute
- `ISQCondensedMatter::néelTemperature` — attribute
- `ISQCondensedMatter::superconductionTransitionTemperature` — attribute
- `ISQCondensedMatter::thermodynamicCriticalMagneticFluxDensity` — attribute
- `ISQCondensedMatter::lowerCriticalMagneticFluxDensity` — attribute
- `ISQCondensedMatter::upperCriticalMagneticFluxDensity` — attribute
- `ISQCondensedMatter::superconductorEnergyGap` — attribute
- `ISQCondensedMatter::londonPenetrationDepth` — attribute
- `ISQCondensedMatter::coherenceLength` — attribute
