---
name: ModelingMetadata
kind: model-library-file
language: SysML
source: sysml.library/Domain Libraries/Metadata/ModelingMetadata.sysml
declares: [ModelingMetadata, ModelingMetadata::StatusKind, ModelingMetadata::StatusInfo, ModelingMetadata::StatusInfo::originator, ModelingMetadata::StatusInfo::owner, ModelingMetadata::StatusInfo::status, ModelingMetadata::StatusInfo::risk, ModelingMetadata::Rationale, ModelingMetadata::Rationale::text, ModelingMetadata::Issue, ModelingMetadata::Issue::text]
license: EPL-2.0
---

# ModelingMetadata

Verbatim SysML standard-library source from `sysml.library/Domain Libraries/Metadata/ModelingMetadata.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `ModelingMetadata` — standard library package
- `ModelingMetadata::StatusKind` — enum def
- `ModelingMetadata::StatusInfo` — metadata def
- `ModelingMetadata::StatusInfo::originator` — attribute
- `ModelingMetadata::StatusInfo::owner` — attribute
- `ModelingMetadata::StatusInfo::status` — attribute
- `ModelingMetadata::StatusInfo::risk` — item
- `ModelingMetadata::Rationale` — metadata def
- `ModelingMetadata::Rationale::text` — attribute
- `ModelingMetadata::Issue` — metadata def
- `ModelingMetadata::Issue::text` — attribute
