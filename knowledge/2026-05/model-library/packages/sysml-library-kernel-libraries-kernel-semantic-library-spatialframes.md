...
language: KerML
source: sysml.library/Kernel Libraries/Kernel Semantic Library/SpatialFrames.kerml
declares: [SpatialFrames, SpatialFrames::DefaultFrameLife, SpatialFrames::defaultFrame, SpatialFrames::SpatialFrame, SpatialFrames::PositionOf, SpatialFrames::PositionOf::positionTimePrecondition, SpatialFrames::PositionOf::spacePositionConstraint, SpatialFrames::CurrentPositionOf, SpatialFrames::DisplacementOf, SpatialFrames::DisplacementOf::zeroDisplacementConstraint, SpatialFrames::CurrentDisplacementOf, SpatialFrames::CartesianSpatialFrame, SpatialFrames::CartesianPositionOf, SpatialFrames::CartesianCurrentPositionOf, SpatialFrames::CartesianDisplacementOf, SpatialFrames::CartesianCurrentDisplacementOf]
license: EPL-2.0
---

# SpatialFrames

Verbatim KerML standard-library source from `sysml.library/Kernel Libraries/Kernel Semantic Library/SpatialFrames.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `SpatialFrames` — standard library package
- `SpatialFrames::DefaultFrameLife` — struct
- `SpatialFrames::defaultFrame` — feature
- `SpatialFrames::SpatialFrame` — struct
- `SpatialFrames::PositionOf` — function
- `SpatialFrames::PositionOf::positionTimePrecondition` — inv
- `SpatialFrames::PositionOf::spacePositionConstraint` — inv
- `SpatialFrames::CurrentPositionOf` — function
- `SpatialFrames::DisplacementOf` — function
- `SpatialFrames::DisplacementOf::zeroDisplacementConstraint` — inv
- `SpatialFrames::CurrentDisplacementOf` — function
- `SpatialFrames::CartesianSpatialFrame` — struct
- `SpatialFrames::CartesianPositionOf` — function
- `SpatialFrames::CartesianCurrentPositionOf` — function
- `SpatialFrames::CartesianDisplacementOf` — function
- `SpatialFrames::CartesianCurrentDisplacementOf` — function
