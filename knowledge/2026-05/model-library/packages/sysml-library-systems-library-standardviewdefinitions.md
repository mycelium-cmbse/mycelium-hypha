---
name: StandardViewDefinitions
kind: model-library-file
language: SysML
source: sysml.library/Systems Library/StandardViewDefinitions.sysml
declares: [StandardViewDefinitions]
license: EPL-2.0
---

# StandardViewDefinitions

Verbatim SysML standard-library source from `sysml.library/Systems Library/StandardViewDefinitions.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `StandardViewDefinitions` — standard library package
