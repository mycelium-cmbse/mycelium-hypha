...
language: SysML
source: sysml.library/Domain Libraries/Analysis/TradeStudies.sysml
declares: [TradeStudies, TradeStudies::EvaluationFunction, TradeStudies::EvaluationFunction::result, TradeStudies::TradeStudyObjective, TradeStudies::TradeStudyObjective::selectedAlternative, TradeStudies::TradeStudyObjective::eval, TradeStudies::TradeStudyObjective::best, TradeStudies::MinimizeObjective, TradeStudies::MaximizeObjective, TradeStudies::studyAlternatives, TradeStudies::evaluationFunction, TradeStudies::tradeStudyObjective]
license: EPL-2.0
---

# TradeStudies

Verbatim SysML standard-library source from `sysml.library/Domain Libraries/Analysis/TradeStudies.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `TradeStudies` — standard library package
- `TradeStudies::EvaluationFunction` — calc def
- `TradeStudies::EvaluationFunction::result` — attribute
- `TradeStudies::TradeStudyObjective` — requirement def
- `TradeStudies::TradeStudyObjective::selectedAlternative` — subject
- `TradeStudies::TradeStudyObjective::eval` — calc
- `TradeStudies::TradeStudyObjective::best` — attribute
- `TradeStudies::MinimizeObjective` — requirement def
- `TradeStudies::MaximizeObjective` — requirement def
- `TradeStudies::studyAlternatives` — subject
- `TradeStudies::evaluationFunction` — calc
- `TradeStudies::tradeStudyObjective` — objective
