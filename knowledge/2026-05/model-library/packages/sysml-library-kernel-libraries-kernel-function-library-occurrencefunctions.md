---
name: OccurrenceFunctions
kind: model-library-file
language: KerML
source: sysml.library/Kernel Libraries/Kernel Function Library/OccurrenceFunctions.kerml
declares: [OccurrenceFunctions, OccurrenceFunctions::===, OccurrenceFunctions::isDuring, OccurrenceFunctions::create, OccurrenceFunctions::destroy, OccurrenceFunctions::addNew, OccurrenceFunctions::addNewAt, OccurrenceFunctions::removeOld, OccurrenceFunctions::removeOld::removeStep, OccurrenceFunctions::removeOld::destroyStep, OccurrenceFunctions::removeOldAt, OccurrenceFunctions::removeOldAt::oldOcc, OccurrenceFunctions::removeOldAt::removeStep, OccurrenceFunctions::removeOldAt::destroyStep]
license: EPL-2.0
---

# OccurrenceFunctions

Verbatim KerML standard-library source from `sysml.library/Kernel Libraries/Kernel Function Library/OccurrenceFunctions.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `OccurrenceFunctions` — standard library package
- `OccurrenceFunctions::===` — function
- `OccurrenceFunctions::isDuring` — function
- `OccurrenceFunctions::create` — function
- `OccurrenceFunctions::destroy` — function
- `OccurrenceFunctions::addNew` — function
- `OccurrenceFunctions::addNewAt` — function
- `OccurrenceFunctions::removeOld` — behavior
- `OccurrenceFunctions::removeOld::removeStep` — step
- `OccurrenceFunctions::removeOld::destroyStep` — step
- `OccurrenceFunctions::removeOldAt` — behavior
- `OccurrenceFunctions::removeOldAt::oldOcc` — feature
- `OccurrenceFunctions::removeOldAt::removeStep` — step
- `OccurrenceFunctions::removeOldAt::destroyStep` — step
