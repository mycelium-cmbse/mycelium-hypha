...
language: KerML
source: sysml.library/Kernel Libraries/Kernel Semantic Library/Occurrences.kerml
declares: [Occurrences, Occurrences::Occurrence, Occurrences::Occurrence::portionOfLife, Occurrences::Occurrence::self, Occurrences::Occurrence::sameLifeOccurrences, Occurrences::Occurrence::this, Occurrences::Occurrence::localClock, Occurrences::Occurrence::suboccurrences, Occurrences::Occurrence::superoccurrence, Occurrences::Occurrence::withoutOccurrences, Occurrences::Occurrence::predecessors, Occurrences::Occurrence::successors, Occurrences::Occurrence::successors::earlierOccurrence, Occurrences::Occurrence::successors::laterOccurrence, Occurrences::Occurrence::immediatePredecessors, Occurrences::Occurrence::immediateSuccessors, Occurrences::Occurrence::timeEnclosedOccurrences, Occurrences::Occurrence::timeEnclosedOccurrences::longerOccurrence, Occurrences::Occurrence::timeEnclosedOccurrences::shorterOccurrence, Occurrences::Occurrence::timeCoincidentOccurrences, Occurrences::Occurrence::timeCoincidentOccurrences::thatOccurrence, Occurrences::Occurrence::timeCoincidentOccurrences::thisOccurrence, Occurrences::Occurrence::spaceEnclosedOccurrences, Occurrences::Occurrence::spaceEnclosedOccurrences::largerSpace, Occurrences::Occurrence::spaceEnclosedOccurrences::smallerSpace, Occurrences::Occurrence::spaceTimeEnclosedOccurrences, Occurrences::Occurrence::spaceTimeEnclosedPoints, Occurrences::Occurrence::spaceTimeCoincidentOccurrences, Occurrences::Occurrence::outsideOfOccurrences, Occurrences::Occurrence::justOutsideOfOccurrences, Occurrences::Occurrence::justOutsideOfOccurrences::separateSpaceToo, Occurrences::Occurrence::justOutsideOfOccurrences::separateSpace, Occurrences::Occurrence::matingOccurrences, Occurrences::Occurrence::matingOccurrences::matingSpaceToo, Occurrences::Occurrence::matingOccurrences::matingSpace, Occurrences::Occurrence::matingOccurrences::matingOccurrence, Occurrences::Occurrence::innerSpaceDimension, Occurrences::Occurrence::outerSpaceDimension, Occurrences::Occurrence::portions, Occurrences::Occurrence::portionOf, Occurrences::Occurrence::timeSlices, Occurrences::Occurrence::timeSliceOf, Occurrences::Occurrence::timeSliceOf::timeSliceOccurrence, Occurrences::Occurrence::timeSliceOf::timeSlicedOccurrence, Occurrences::Occurrence::snapshots, Occurrences::Occurrence::snapshotOf, Occurrences::Occurrence::startShot, Occurrences::Occurrence::middleTimeSlice, Occurrences::Occurrence::endShot, Occurrences::Occurrence::endShot::subendshot, Occurrences::Occurrence::endShot::subendshot::superendshot, Occurrences::Occurrence::spaceSlices, Occurrences::Occurrence::spaceSliceOf, Occurrences::Occurrence::spaceSliceOf::spaceSliceOccurrence, Occurrences::Occurrence::spaceSliceOf::spaceSlicedOccurrence, Occurrences::Occurrence::spaceShots, Occurrences::Occurrence::spaceShotOf, Occurrences::Occurrence::spaceShotOf::spaceShotOccurrence, Occurrences::Occurrence::spaceShotOf::spaceShottedOccurrence, Occurrences::Occurrence::unionsOf, Occurrences::Occurrence::unionsOf::union, Occurrences::Occurrence::intersectionsOf, Occurrences::Occurrence::intersectionsOf::notIntersection, Occurrences::Occurrence::intersectionsOf::intersection, Occurrences::Occurrence::differencesOf, Occurrences::Occurrence::differencesOf::difference, Occurrences::Occurrence::differencesOf::minuend, Occurrences::Occurrence::differencesOf::subtrahend, Occurrences::Occurrence::differencesOf::interdiff, Occurrences::Occurrence::differencesOf::interdiff::notSubtrahend, Occurrences::Occurrence::spaceInterior, Occurrences::Occurrence::spaceInteriorOf, Occurrences::Occurrence::spaceBoundary, Occurrences::Occurrence::spaceBoundary::spaceBounder, Occurrences::Occurrence::spaceBoundary::outer, Occurrences::Occurrence::spaceBoundary::inner, Occurrences::Occurrence::spaceBoundaryOf, Occurrences::Occurrence::spaceBoundaryOf::spaceBounderOf, Occurrences::Occurrence::innerSpaceOccurrences, Occurrences::Occurrence::innerSpaceOccurrences::outerSpace, Occurrences::Occurrence::innerSpaceOccurrences::innerSpace, Occurrences::Occurrence::innerSpaceOccurrences::hOccurrence, Occurrences::Occurrence::surroundedByOccurrences, Occurrences::Occurrence::surroundedByOccurrences::surroundedSpace, Occurrences::Occurrence::surroundedByOccurrences::surroundingSpace, Occurrences::Occurrence::isClosed, Occurrences::Occurrence::incomingTransfers, Occurrences::Occurrence::isDispatch, Occurrences::Occurrence::dispatchScope, Occurrences::Occurrence::isRunToCompletion, Occurrences::Occurrence::runToCompletionScope, Occurrences::Occurrence::incomingTransferSort, Occurrences::Occurrence::incomingTransfersToSelf, Occurrences::Occurrence::outgoingTransfers, Occurrences::Occurrence::outgoingTransfersFromSelf, Occurrences::Life, Occurrences::Life::portionOf, Occurrences::occurrences, Occurrences::IncomingTransferSort, Occurrences::earlierFirstIncomingTransferSort, Occurrences::SelfSameLifeLink, Occurrences::SelfSameLifeLink::myselfSameLife, Occurrences::SelfSameLifeLink::selfSameLife, Occurrences::SelfSameLifeLink::sourceOccurrence, Occurrences::SelfSameLifeLink::targetOccurrence, Occurrences::SelfSameLifeLink::sourceDataValue, Occurrences::SelfSameLifeLink::targetDataValue, Occurrences::HappensLink, Occurrences::HappensLink::sourceOccurrence, Occurrences::HappensLink::targetOccurrence, Occurrences::HappensDuring, Occurrences::HappensDuring::shorterOccurrence, Occurrences::HappensDuring::longerOccurrence, Occurrences::HappensWhile, Occurrences::HappensWhile::thisOccurrence, Occurrences::HappensWhile::thatOccurrence, Occurrences::SpaceLink, Occurrences::SpaceLink::sourceOccurrence, Occurrences::SpaceLink::targetOccurrence, Occurrences::InsideOf, Occurrences::InsideOf::smallerSpace, Occurrences::InsideOf::largerSpace, Occurrences::Within, Occurrences::Within::smallerOccurrence, Occurrences::Within::largerOccurrence, Occurrences::WithinBoth, Occurrences::WithinBoth::thisOccurrence, Occurrences::WithinBoth::thatOccurrence, Occurrences::PortionOf, Occurrences::PortionOf::portionOccurrence, Occurrences::PortionOf::portionedOccurrence, Occurrences::TimeSliceOf, Occurrences::TimeSliceOf::timeSliceOccurrence, Occurrences::TimeSliceOf::timeSlicedOccurrence, Occurrences::SnapshotOf, Occurrences::SnapshotOf::snapshotOccurrence, Occurrences::SnapshotOf::snapshottedOccurrence, Occurrences::SpaceSliceOf, Occurrences::SpaceSliceOf::spaceSliceOccurrence, Occurrences::SpaceSliceOf::spaceSlicedOccurrence, Occurrences::SpaceShotOf, Occurrences::SpaceShotOf::spaceShotOccurrence, Occurrences::SpaceShotOf::spaceShottedOccurrence, Occurrences::Without, Occurrences::Without::separateOccurrenceToo, Occurrences::Without::separateOccurrence, Occurrences::HappensBefore, Occurrences::HappensBefore::earlierOccurrence, Occurrences::HappensBefore::laterOccurrence, Occurrences::HappensJustBefore, Occurrences::happensBeforeLinks, Occurrences::happensBeforeLinks::earlierOccurrence, Occurrences::happensBeforeLinks::laterOccurrence, Occurrences::OutsideOf, Occurrences::OutsideOf::separateSpaceToo, Occurrences::OutsideOf::separateSpace, Occurrences::JustOutsideOf, Occurrences::MatesWith, Occurrences::MatesWith::matingSpaceToo, Occurrences::MatesWith::matingSpace, Occurrences::InnerSpaceOf, Occurrences::InnerSpaceOf::outerSpace, Occurrences::InnerSpaceOf::innerSpace, Occurrences::SurroundedBy, Occurrences::SurroundedBy::surroundedSpace, Occurrences::SurroundedBy::surroundingSpace]
license: EPL-2.0
---

# Occurrences

Verbatim KerML standard-library source from `sysml.library/Kernel Libraries/Kernel Semantic Library/Occurrences.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `Occurrences` — standard library package
- `Occurrences::Occurrence` — class
- `Occurrences::Occurrence::portionOfLife` — feature
- `Occurrences::Occurrence::self` — feature
- `Occurrences::Occurrence::sameLifeOccurrences` — feature
- `Occurrences::Occurrence::this` — feature
- `Occurrences::Occurrence::localClock` — feature
- `Occurrences::Occurrence::suboccurrences` — feature
- `Occurrences::Occurrence::superoccurrence` — feature
- `Occurrences::Occurrence::withoutOccurrences` — feature
- `Occurrences::Occurrence::predecessors` — feature
- `Occurrences::Occurrence::successors` — feature
- `Occurrences::Occurrence::successors::earlierOccurrence` — feature
- `Occurrences::Occurrence::successors::laterOccurrence` — feature
- `Occurrences::Occurrence::immediatePredecessors` — feature
- `Occurrences::Occurrence::immediateSuccessors` — feature
- `Occurrences::Occurrence::timeEnclosedOccurrences` — feature
- `Occurrences::Occurrence::timeEnclosedOccurrences::longerOccurrence` — feature
- `Occurrences::Occurrence::timeEnclosedOccurrences::shorterOccurrence` — feature
- `Occurrences::Occurrence::timeCoincidentOccurrences` — feature
- `Occurrences::Occurrence::timeCoincidentOccurrences::thatOccurrence` — feature
- `Occurrences::Occurrence::timeCoincidentOccurrences::thisOccurrence` — feature
- `Occurrences::Occurrence::spaceEnclosedOccurrences` — feature
- `Occurrences::Occurrence::spaceEnclosedOccurrences::largerSpace` — feature
- `Occurrences::Occurrence::spaceEnclosedOccurrences::smallerSpace` — feature
- `Occurrences::Occurrence::spaceTimeEnclosedOccurrences` — feature
- `Occurrences::Occurrence::spaceTimeEnclosedPoints` — feature
- `Occurrences::Occurrence::spaceTimeCoincidentOccurrences` — feature
- `Occurrences::Occurrence::outsideOfOccurrences` — feature
- `Occurrences::Occurrence::justOutsideOfOccurrences` — feature
- `Occurrences::Occurrence::justOutsideOfOccurrences::separateSpaceToo` — feature
- `Occurrences::Occurrence::justOutsideOfOccurrences::separateSpace` — feature
- `Occurrences::Occurrence::matingOccurrences` — feature
- `Occurrences::Occurrence::matingOccurrences::matingSpaceToo` — feature
- `Occurrences::Occurrence::matingOccurrences::matingSpace` — feature
- `Occurrences::Occurrence::matingOccurrences::matingOccurrence` — feature
- `Occurrences::Occurrence::innerSpaceDimension` — feature
- `Occurrences::Occurrence::outerSpaceDimension` — feature
- `Occurrences::Occurrence::portions` — feature
- `Occurrences::Occurrence::portionOf` — feature
- `Occurrences::Occurrence::timeSlices` — feature
- `Occurrences::Occurrence::timeSliceOf` — feature
- `Occurrences::Occurrence::timeSliceOf::timeSliceOccurrence` — feature
- `Occurrences::Occurrence::timeSliceOf::timeSlicedOccurrence` — feature
- `Occurrences::Occurrence::snapshots` — feature
- `Occurrences::Occurrence::snapshotOf` — feature
- `Occurrences::Occurrence::startShot` — feature
- `Occurrences::Occurrence::middleTimeSlice` — feature
- `Occurrences::Occurrence::endShot` — feature
- `Occurrences::Occurrence::endShot::subendshot` — feature
- `Occurrences::Occurrence::endShot::subendshot::superendshot` — feature
- `Occurrences::Occurrence::spaceSlices` — feature
- `Occurrences::Occurrence::spaceSliceOf` — feature
- `Occurrences::Occurrence::spaceSliceOf::spaceSliceOccurrence` — feature
- `Occurrences::Occurrence::spaceSliceOf::spaceSlicedOccurrence` — feature
- `Occurrences::Occurrence::spaceShots` — feature
- `Occurrences::Occurrence::spaceShotOf` — feature
- `Occurrences::Occurrence::spaceShotOf::spaceShotOccurrence` — feature
- `Occurrences::Occurrence::spaceShotOf::spaceShottedOccurrence` — feature
- `Occurrences::Occurrence::unionsOf` — feature
- `Occurrences::Occurrence::unionsOf::union` — feature
- `Occurrences::Occurrence::intersectionsOf` — feature
- `Occurrences::Occurrence::intersectionsOf::notIntersection` — feature
- `Occurrences::Occurrence::intersectionsOf::intersection` — feature
- `Occurrences::Occurrence::differencesOf` — feature
- `Occurrences::Occurrence::differencesOf::difference` — feature
- `Occurrences::Occurrence::differencesOf::minuend` — feature
- `Occurrences::Occurrence::differencesOf::subtrahend` — feature
- `Occurrences::Occurrence::differencesOf::interdiff` — feature
- `Occurrences::Occurrence::differencesOf::interdiff::notSubtrahend` — feature
- `Occurrences::Occurrence::spaceInterior` — feature
- `Occurrences::Occurrence::spaceInteriorOf` — feature
- `Occurrences::Occurrence::spaceBoundary` — feature
- `Occurrences::Occurrence::spaceBoundary::spaceBounder` — feature
- `Occurrences::Occurrence::spaceBoundary::outer` — feature
- `Occurrences::Occurrence::spaceBoundary::inner` — feature
- `Occurrences::Occurrence::spaceBoundaryOf` — feature
- `Occurrences::Occurrence::spaceBoundaryOf::spaceBounderOf` — feature
- `Occurrences::Occurrence::innerSpaceOccurrences` — feature
- `Occurrences::Occurrence::innerSpaceOccurrences::outerSpace` — feature
- `Occurrences::Occurrence::innerSpaceOccurrences::innerSpace` — feature
- `Occurrences::Occurrence::innerSpaceOccurrences::hOccurrence` — feature
- `Occurrences::Occurrence::surroundedByOccurrences` — feature
- `Occurrences::Occurrence::surroundedByOccurrences::surroundedSpace` — feature
- `Occurrences::Occurrence::surroundedByOccurrences::surroundingSpace` — feature
- `Occurrences::Occurrence::isClosed` — feature
- `Occurrences::Occurrence::incomingTransfers` — feature
- `Occurrences::Occurrence::isDispatch` — feature
- `Occurrences::Occurrence::dispatchScope` — feature
- `Occurrences::Occurrence::isRunToCompletion` — feature
- `Occurrences::Occurrence::runToCompletionScope` — feature
- `Occurrences::Occurrence::incomingTransferSort` — feature
- `Occurrences::Occurrence::incomingTransfersToSelf` — feature
- `Occurrences::Occurrence::outgoingTransfers` — feature
- `Occurrences::Occurrence::outgoingTransfersFromSelf` — feature
- `Occurrences::Life` — class
- `Occurrences::Life::portionOf` — binding
- `Occurrences::occurrences` — feature
- `Occurrences::IncomingTransferSort` — predicate
- `Occurrences::earlierFirstIncomingTransferSort` — bool
- `Occurrences::SelfSameLifeLink` — assoc
- `Occurrences::SelfSameLifeLink::myselfSameLife` — feature
- `Occurrences::SelfSameLifeLink::selfSameLife` — feature
- `Occurrences::SelfSameLifeLink::sourceOccurrence` — feature
- `Occurrences::SelfSameLifeLink::targetOccurrence` — feature
- `Occurrences::SelfSameLifeLink::sourceDataValue` — feature
- `Occurrences::SelfSameLifeLink::targetDataValue` — feature
- `Occurrences::HappensLink` — assoc
- `Occurrences::HappensLink::sourceOccurrence` — feature
- `Occurrences::HappensLink::targetOccurrence` — feature
- `Occurrences::HappensDuring` — assoc
- `Occurrences::HappensDuring::shorterOccurrence` — feature
- `Occurrences::HappensDuring::longerOccurrence` — feature
- `Occurrences::HappensWhile` — assoc
- `Occurrences::HappensWhile::thisOccurrence` — feature
- `Occurrences::HappensWhile::thatOccurrence` — feature
- `Occurrences::SpaceLink` — assoc
- `Occurrences::SpaceLink::sourceOccurrence` — feature
- `Occurrences::SpaceLink::targetOccurrence` — feature
- `Occurrences::InsideOf` — assoc
- `Occurrences::InsideOf::smallerSpace` — feature
- `Occurrences::InsideOf::largerSpace` — feature
- `Occurrences::Within` — assoc
- `Occurrences::Within::smallerOccurrence` — feature
- `Occurrences::Within::largerOccurrence` — feature
- `Occurrences::WithinBoth` — assoc
- `Occurrences::WithinBoth::thisOccurrence` — feature
- `Occurrences::WithinBoth::thatOccurrence` — feature
- `Occurrences::PortionOf` — assoc
- `Occurrences::PortionOf::portionOccurrence` — feature
- `Occurrences::PortionOf::portionedOccurrence` — feature
- `Occurrences::TimeSliceOf` — assoc
- `Occurrences::TimeSliceOf::timeSliceOccurrence` — feature
- `Occurrences::TimeSliceOf::timeSlicedOccurrence` — feature
- `Occurrences::SnapshotOf` — assoc
- `Occurrences::SnapshotOf::snapshotOccurrence` — feature
- `Occurrences::SnapshotOf::snapshottedOccurrence` — feature
- `Occurrences::SpaceSliceOf` — assoc
- `Occurrences::SpaceSliceOf::spaceSliceOccurrence` — feature
- `Occurrences::SpaceSliceOf::spaceSlicedOccurrence` — feature
- `Occurrences::SpaceShotOf` — assoc
- `Occurrences::SpaceShotOf::spaceShotOccurrence` — feature
- `Occurrences::SpaceShotOf::spaceShottedOccurrence` — feature
- `Occurrences::Without` — assoc
- `Occurrences::Without::separateOccurrenceToo` — feature
- `Occurrences::Without::separateOccurrence` — feature
- `Occurrences::HappensBefore` — assoc
- `Occurrences::HappensBefore::earlierOccurrence` — feature
- `Occurrences::HappensBefore::laterOccurrence` — feature
- `Occurrences::HappensJustBefore` — assoc
- `Occurrences::happensBeforeLinks` — feature
- `Occurrences::happensBeforeLinks::earlierOccurrence` — feature
- `Occurrences::happensBeforeLinks::laterOccurrence` — feature
- `Occurrences::OutsideOf` — assoc
- `Occurrences::OutsideOf::separateSpaceToo` — feature
- `Occurrences::OutsideOf::separateSpace` — feature
- `Occurrences::JustOutsideOf` — assoc
- `Occurrences::MatesWith` — assoc
- `Occurrences::MatesWith::matingSpaceToo` — feature
- `Occurrences::MatesWith::matingSpace` — feature
- `Occurrences::InnerSpaceOf` — assoc
- `Occurrences::InnerSpaceOf::outerSpace` — feature
- `Occurrences::InnerSpaceOf::innerSpace` — feature
- `Occurrences::SurroundedBy` — assoc
- `Occurrences::SurroundedBy::surroundedSpace` — feature
- `Occurrences::SurroundedBy::surroundingSpace` — feature
