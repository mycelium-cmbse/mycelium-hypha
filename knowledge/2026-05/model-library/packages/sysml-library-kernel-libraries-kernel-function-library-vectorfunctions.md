...
language: KerML
source: sysml.library/Kernel Libraries/Kernel Function Library/VectorFunctions.kerml
declares: [VectorFunctions, VectorFunctions::isZeroVector, VectorFunctions::+, VectorFunctions::+::zeroAddition, VectorFunctions::+::commutivity, VectorFunctions::-, VectorFunctions::-::negation, VectorFunctions::-::difference, VectorFunctions::sum0, VectorFunctions::sum0::precondition, VectorFunctions::VectorOf, VectorFunctions::scalarVectorMult, VectorFunctions::scalarVectorMult::scaling, VectorFunctions::scalarVectorMult::zeroLength, VectorFunctions::vectorScalarMult, VectorFunctions::vectorScalarDiv, VectorFunctions::inner, VectorFunctions::inner::commmutivity, VectorFunctions::inner::zeroInner, VectorFunctions::norm, VectorFunctions::norm::squareNorm, VectorFunctions::norm::lengthZero, VectorFunctions::angle, VectorFunctions::angle::commutivity, VectorFunctions::angle::lengthInsensitive, VectorFunctions::CartesianVectorOf, VectorFunctions::CartesianThreeVectorOf, VectorFunctions::cartesianZeroVector, VectorFunctions::cartesian3DZeroVector, VectorFunctions::isCartesianZeroVector, VectorFunctions::cartesian+, VectorFunctions::cartesian+::precondition, VectorFunctions::cartesian-, VectorFunctions::cartesian-::precondition, VectorFunctions::cartesianScalarVectorMult, VectorFunctions::cartesianVectorScalarMult, VectorFunctions::cartesianInner, VectorFunctions::cartesianInner::precondition, VectorFunctions::cartesianNorm, VectorFunctions::cartesianAngle, VectorFunctions::cartesianAngle::precondition, VectorFunctions::sum]
license: EPL-2.0
---

# VectorFunctions

Verbatim KerML standard-library source from `sysml.library/Kernel Libraries/Kernel Function Library/VectorFunctions.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `VectorFunctions` — standard library package
- `VectorFunctions::isZeroVector` — function
- `VectorFunctions::+` — function
- `VectorFunctions::+::zeroAddition` — inv
- `VectorFunctions::+::commutivity` — inv
- `VectorFunctions::-` — function
- `VectorFunctions::-::negation` — inv
- `VectorFunctions::-::difference` — inv
- `VectorFunctions::sum0` — function
- `VectorFunctions::sum0::precondition` — inv
- `VectorFunctions::VectorOf` — function
- `VectorFunctions::scalarVectorMult` — function
- `VectorFunctions::scalarVectorMult::scaling` — inv
- `VectorFunctions::scalarVectorMult::zeroLength` — inv
- `VectorFunctions::vectorScalarMult` — function
- `VectorFunctions::vectorScalarDiv` — function
- `VectorFunctions::inner` — function
- `VectorFunctions::inner::commmutivity` — inv
- `VectorFunctions::inner::zeroInner` — inv
- `VectorFunctions::norm` — function
- `VectorFunctions::norm::squareNorm` — inv
- `VectorFunctions::norm::lengthZero` — inv
- `VectorFunctions::angle` — function
- `VectorFunctions::angle::commutivity` — inv
- `VectorFunctions::angle::lengthInsensitive` — inv
- `VectorFunctions::CartesianVectorOf` — function
- `VectorFunctions::CartesianThreeVectorOf` — function
- `VectorFunctions::cartesianZeroVector` — feature
- `VectorFunctions::cartesian3DZeroVector` — feature
- `VectorFunctions::isCartesianZeroVector` — function
- `VectorFunctions::cartesian+` — function
- `VectorFunctions::cartesian+::precondition` — inv
- `VectorFunctions::cartesian-` — function
- `VectorFunctions::cartesian-::precondition` — inv
- `VectorFunctions::cartesianScalarVectorMult` — function
- `VectorFunctions::cartesianVectorScalarMult` — function
- `VectorFunctions::cartesianInner` — function
- `VectorFunctions::cartesianInner::precondition` — inv
- `VectorFunctions::cartesianNorm` — function
- `VectorFunctions::cartesianAngle` — function
- `VectorFunctions::cartesianAngle::precondition` — inv
- `VectorFunctions::sum` — function
