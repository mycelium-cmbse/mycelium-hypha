...
language: KerML
source: sysml.library/Kernel Libraries/Kernel Semantic Library/Clocks.kerml
declares: [Clocks, Clocks::UniversalClockLife, Clocks::universalClock, Clocks::Clock, Clocks::Clock::currentTime, Clocks::Clock::timeFlowConstraint, Clocks::TimeOf, Clocks::TimeOf::startTimeConstraint, Clocks::TimeOf::timeOrderingConstraint, Clocks::TimeOf::timeContinuityConstraint, Clocks::DurationOf, Clocks::BasicClock, Clocks::BasicTimeOf, Clocks::BasicDurationOf]
license: EPL-2.0
---

# Clocks

Verbatim KerML standard-library source from `sysml.library/Kernel Libraries/Kernel Semantic Library/Clocks.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `Clocks` — standard library package
- `Clocks::UniversalClockLife` — struct
- `Clocks::universalClock` — feature
- `Clocks::Clock` — struct
- `Clocks::Clock::currentTime` — feature
- `Clocks::Clock::timeFlowConstraint` — inv
- `Clocks::TimeOf` — function
- `Clocks::TimeOf::startTimeConstraint` — inv
- `Clocks::TimeOf::timeOrderingConstraint` — inv
- `Clocks::TimeOf::timeContinuityConstraint` — inv
- `Clocks::DurationOf` — function
- `Clocks::BasicClock` — struct
- `Clocks::BasicTimeOf` — function
- `Clocks::BasicDurationOf` — function
