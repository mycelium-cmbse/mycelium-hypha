...
language: SysML
source: sysml.library/Domain Libraries/Quantities and Units/Quantities.sysml
declares: [Quantities, Quantities::TensorQuantityValue, Quantities::TensorQuantityValue::isBound, Quantities::TensorQuantityValue::num, Quantities::TensorQuantityValue::mRef, Quantities::TensorQuantityValue::order, Quantities::TensorQuantityValue::contravariantOrder, Quantities::TensorQuantityValue::covariantOrder, Quantities::TensorQuantityValue::orderSum, Quantities::TensorQuantityValue::boundMatch, Quantities::VectorQuantityValue, Quantities::ScalarQuantityValue, Quantities::tensorQuantities, Quantities::vectorQuantities, Quantities::scalarQuantities, Quantities::3dVectorQuantityValue, Quantities::SystemOfQuantities, Quantities::SystemOfQuantities::baseQuantities, Quantities::QuantityPowerFactor, Quantities::QuantityPowerFactor::quantity, Quantities::QuantityPowerFactor::exponent, Quantities::QuantityDimension, Quantities::QuantityDimension::quantityPowerFactors]
license: EPL-2.0
---

# Quantities

Verbatim SysML standard-library source from `sysml.library/Domain Libraries/Quantities and Units/Quantities.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `Quantities` — standard library package
- `Quantities::TensorQuantityValue` — attribute def
- `Quantities::TensorQuantityValue::isBound` — attribute
- `Quantities::TensorQuantityValue::num` — attribute
- `Quantities::TensorQuantityValue::mRef` — attribute
- `Quantities::TensorQuantityValue::order` — attribute
- `Quantities::TensorQuantityValue::contravariantOrder` — attribute
- `Quantities::TensorQuantityValue::covariantOrder` — attribute
- `Quantities::TensorQuantityValue::orderSum` — assert constraint
- `Quantities::TensorQuantityValue::boundMatch` — assert constraint
- `Quantities::VectorQuantityValue` — attribute def
- `Quantities::ScalarQuantityValue` — attribute def
- `Quantities::tensorQuantities` — attribute
- `Quantities::vectorQuantities` — attribute
- `Quantities::scalarQuantities` — attribute
- `Quantities::3dVectorQuantityValue` — attribute def
- `Quantities::SystemOfQuantities` — attribute def
- `Quantities::SystemOfQuantities::baseQuantities` — attribute
- `Quantities::QuantityPowerFactor` — attribute def
- `Quantities::QuantityPowerFactor::quantity` — attribute
- `Quantities::QuantityPowerFactor::exponent` — attribute
- `Quantities::QuantityDimension` — attribute def
- `Quantities::QuantityDimension::quantityPowerFactors` — attribute
