...
language: SysML
source: sysml.library/Systems Library/Flows.sysml
declares: [Flows, Flows::MessageAction, Flows::Message, Flows::Message::thisConnection, Flows::Message::sourceEvent, Flows::Message::targetEvent, Flows::Message::seBeforeNum, Flows::Message::teAfterNum, Flows::Flow, Flows::Flow::source, Flows::Flow::target, Flows::SuccessionFlow, Flows::SuccessionFlow::source, Flows::SuccessionFlow::target, Flows::flows, Flows::flows::source, Flows::flows::target, Flows::successionFlows, Flows::successionFlows::source, Flows::successionFlows::target]
license: EPL-2.0
---

# Flows

Verbatim SysML standard-library source from `sysml.library/Systems Library/Flows.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `Flows` — standard library package
- `Flows::MessageAction` — flow def
- `Flows::Message` — flow def
- `Flows::Message::thisConnection` — action
- `Flows::Message::sourceEvent` — event occurrence
- `Flows::Message::targetEvent` — event occurrence
- `Flows::Message::seBeforeNum` — attribute
- `Flows::Message::teAfterNum` — attribute
- `Flows::Flow` — flow def
- `Flows::Flow::source` — occurrence
- `Flows::Flow::target` — occurrence
- `Flows::SuccessionFlow` — flow def
- `Flows::SuccessionFlow::source` — occurrence
- `Flows::SuccessionFlow::target` — occurrence
- `Flows::flows` — flow
- `Flows::flows::source` — occurrence
- `Flows::flows::target` — occurrence
- `Flows::successionFlows` — flow
- `Flows::successionFlows::source` — occurrence
- `Flows::successionFlows::target` — occurrence
