...
language: SysML
source: sysml.library/Systems Library/States.sysml
declares: [States, States::StateAction, States::StateAction::entryAction, States::StateAction::doAction, States::StateAction::exitAction, States::StateAction::self, States::StateAction::start, States::StateAction::done, States::StateAction::substates, States::StateAction::exclusiveStates, States::StateAction::stateTransitions, States::StateAction::stateSequencing, States::StateTransitionAction, States::stateActions]
license: EPL-2.0
---

# States

Verbatim SysML standard-library source from `sysml.library/Systems Library/States.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `States` — standard library package
- `States::StateAction` — state def
- `States::StateAction::entryAction` — action
- `States::StateAction::doAction` — action
- `States::StateAction::exitAction` — action
- `States::StateAction::self` — state
- `States::StateAction::start` — state
- `States::StateAction::done` — state
- `States::StateAction::substates` — action
- `States::StateAction::exclusiveStates` — state
- `States::StateAction::stateTransitions` — action
- `States::StateAction::stateSequencing` — succession
- `States::StateTransitionAction` — action def
- `States::stateActions` — state
