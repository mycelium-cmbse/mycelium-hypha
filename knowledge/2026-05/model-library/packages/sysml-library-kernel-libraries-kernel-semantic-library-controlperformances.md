---
name: ControlPerformances
kind: model-library-file
language: KerML
source: sysml.library/Kernel Libraries/Kernel Semantic Library/ControlPerformances.kerml
declares: [ControlPerformances, ControlPerformances::DecisionPerformance, ControlPerformances::DecisionPerformance::outgoingHBLink, ControlPerformances::MergePerformance, ControlPerformances::MergePerformance::incomingHBLink, ControlPerformances::IfPerformance, ControlPerformances::IfThenPerformance, ControlPerformances::IfElsePerformance, ControlPerformances::IfThenElsePerformance, ControlPerformances::LoopPerformance, ControlPerformances::LoopPerformance::whileDecision, ControlPerformances::LoopPerformance::untilDecision]
license: EPL-2.0
---

# ControlPerformances

Verbatim KerML standard-library source from `sysml.library/Kernel Libraries/Kernel Semantic Library/ControlPerformances.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `ControlPerformances` — standard library package
- `ControlPerformances::DecisionPerformance` — behavior
- `ControlPerformances::DecisionPerformance::outgoingHBLink` — feature
- `ControlPerformances::MergePerformance` — behavior
- `ControlPerformances::MergePerformance::incomingHBLink` — feature
- `ControlPerformances::IfPerformance` — behavior
- `ControlPerformances::IfThenPerformance` — behavior
- `ControlPerformances::IfElsePerformance` — behavior
- `ControlPerformances::IfThenElsePerformance` — behavior
- `ControlPerformances::LoopPerformance` — behavior
- `ControlPerformances::LoopPerformance::whileDecision` — step
- `ControlPerformances::LoopPerformance::untilDecision` — step
