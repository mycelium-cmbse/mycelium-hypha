---
name: FeatureReferencingPerformances
kind: model-library-file
language: KerML
source: sysml.library/Kernel Libraries/Kernel Semantic Library/FeatureReferencingPerformances.kerml
declares: [FeatureReferencingPerformances, FeatureReferencingPerformances::FeatureReferencingPerformance, FeatureReferencingPerformances::FeatureReferencingPerformance::onOccurrence, FeatureReferencingPerformances::FeatureReferencingPerformance::values, FeatureReferencingPerformances::FeatureAccessPerformance, FeatureReferencingPerformances::FeatureAccessPerformance::onOccurrence, FeatureReferencingPerformances::FeatureAccessPerformance::onOccurrence::startingAt, FeatureReferencingPerformances::FeatureAccessPerformance::onOccurrence::startingAt::accessedFeature, FeatureReferencingPerformances::FeatureReadEvaluation, FeatureReferencingPerformances::FeatureWritePerformance, FeatureReferencingPerformances::FeatureWritePerformance::onOccurrence, FeatureReferencingPerformances::FeatureWritePerformance::replacementValues, FeatureReferencingPerformances::FeatureMonitorPerformance, FeatureReferencingPerformances::FeatureMonitorPerformance::monitoredOccurrence, FeatureReferencingPerformances::FeatureMonitorPerformance::monitoredOccurrence::monitoredFeature, FeatureReferencingPerformances::FeatureMonitorPerformance::monitoredOccurrence::beforeTimeSlice, FeatureReferencingPerformances::FeatureMonitorPerformance::monitoredOccurrence::afterSnapshot, FeatureReferencingPerformances::FeatureMonitorPerformance::afterValues, FeatureReferencingPerformances::FeatureMonitorPerformance::beforeValues, FeatureReferencingPerformances::EvaluationResultMonitorPerformance, FeatureReferencingPerformances::EvaluationResultMonitorPerformance::onOccurrence, FeatureReferencingPerformances::EvaluationResultMonitorPerformance::onOccurrence::monitoredOccurrence, FeatureReferencingPerformances::BooleanEvaluationResultMonitorPerformance, FeatureReferencingPerformances::BooleanEvaluationResultToMonitorPerformance, FeatureReferencingPerformances::BooleanEvaluationResultToMonitorPerformance::isToTrue, FeatureReferencingPerformances::BooleanEvaluationResultToMonitorPerformance::monitor1, FeatureReferencingPerformances::BooleanEvaluationResultToMonitorPerformance::monitor1::earlierOccurrence, FeatureReferencingPerformances::BooleanEvaluationResultToMonitorPerformance::monitor1::laterOccurrence, FeatureReferencingPerformances::BooleanEvaluationResultToMonitorPerformance::monitor2, FeatureReferencingPerformances::BooleanEvaluationResultToMonitorPerformance::monitor2::earlierOccurrence, FeatureReferencingPerformances::BooleanEvaluationResultToMonitorPerformance::monitor2::laterOccurrence]
license: EPL-2.0
---

# FeatureReferencingPerformances

Verbatim KerML standard-library source from `sysml.library/Kernel Libraries/Kernel Semantic Library/FeatureReferencingPerformances.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `FeatureReferencingPerformances` — standard library package
- `FeatureReferencingPerformances::FeatureReferencingPerformance` — behavior
- `FeatureReferencingPerformances::FeatureReferencingPerformance::onOccurrence` — feature
- `FeatureReferencingPerformances::FeatureReferencingPerformance::values` — feature
- `FeatureReferencingPerformances::FeatureAccessPerformance` — behavior
- `FeatureReferencingPerformances::FeatureAccessPerformance::onOccurrence` — feature
- `FeatureReferencingPerformances::FeatureAccessPerformance::onOccurrence::startingAt` — feature
- `FeatureReferencingPerformances::FeatureAccessPerformance::onOccurrence::startingAt::accessedFeature` — feature
- `FeatureReferencingPerformances::FeatureReadEvaluation` — function
- `FeatureReferencingPerformances::FeatureWritePerformance` — behavior
- `FeatureReferencingPerformances::FeatureWritePerformance::onOccurrence` — feature
- `FeatureReferencingPerformances::FeatureWritePerformance::replacementValues` — feature
- `FeatureReferencingPerformances::FeatureMonitorPerformance` — behavior
- `FeatureReferencingPerformances::FeatureMonitorPerformance::monitoredOccurrence` — feature
- `FeatureReferencingPerformances::FeatureMonitorPerformance::monitoredOccurrence::monitoredFeature` — feature
- `FeatureReferencingPerformances::FeatureMonitorPerformance::monitoredOccurrence::beforeTimeSlice` — feature
- `FeatureReferencingPerformances::FeatureMonitorPerformance::monitoredOccurrence::afterSnapshot` — feature
- `FeatureReferencingPerformances::FeatureMonitorPerformance::afterValues` — feature
- `FeatureReferencingPerformances::FeatureMonitorPerformance::beforeValues` — feature
- `FeatureReferencingPerformances::EvaluationResultMonitorPerformance` — behavior
- `FeatureReferencingPerformances::EvaluationResultMonitorPerformance::onOccurrence` — feature
- `FeatureReferencingPerformances::EvaluationResultMonitorPerformance::onOccurrence::monitoredOccurrence` — expr
- `FeatureReferencingPerformances::BooleanEvaluationResultMonitorPerformance` — behavior
- `FeatureReferencingPerformances::BooleanEvaluationResultToMonitorPerformance` — behavior
- `FeatureReferencingPerformances::BooleanEvaluationResultToMonitorPerformance::isToTrue` — feature
- `FeatureReferencingPerformances::BooleanEvaluationResultToMonitorPerformance::monitor1` — feature
- `FeatureReferencingPerformances::BooleanEvaluationResultToMonitorPerformance::monitor1::earlierOccurrence` — feature
- `FeatureReferencingPerformances::BooleanEvaluationResultToMonitorPerformance::monitor1::laterOccurrence` — feature
- `FeatureReferencingPerformances::BooleanEvaluationResultToMonitorPerformance::monitor2` — feature
- `FeatureReferencingPerformances::BooleanEvaluationResultToMonitorPerformance::monitor2::earlierOccurrence` — feature
- `FeatureReferencingPerformances::BooleanEvaluationResultToMonitorPerformance::monitor2::laterOccurrence` — feature
