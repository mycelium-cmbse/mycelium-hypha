...
language: SysML
source: sysml.library/Domain Libraries/Metadata/ImageMetadata.sysml
declares: [ImageMetadata, ImageMetadata::Image, ImageMetadata::Image::content, ImageMetadata::Image::encoding, ImageMetadata::Image::location, ImageMetadata::Icon, ImageMetadata::Icon::fullImage, ImageMetadata::Icon::smallImage]
license: EPL-2.0
---

# ImageMetadata

Verbatim SysML standard-library source from `sysml.library/Domain Libraries/Metadata/ImageMetadata.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `ImageMetadata` — standard library package
- `ImageMetadata::Image` — attribute def
- `ImageMetadata::Image::content` — attribute
- `ImageMetadata::Image::encoding` — attribute
- `ImageMetadata::Image::location` — attribute
- `ImageMetadata::Icon` — metadata def
- `ImageMetadata::Icon::fullImage` — attribute
- `ImageMetadata::Icon::smallImage` — attribute
