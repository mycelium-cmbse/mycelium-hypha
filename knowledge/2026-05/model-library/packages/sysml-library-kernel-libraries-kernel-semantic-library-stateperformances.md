---
name: StatePerformances
kind: model-library-file
language: KerML
source: sysml.library/Kernel Libraries/Kernel Semantic Library/StatePerformances.kerml
declares: [StatePerformances, StatePerformances::StatePerformance, StatePerformances::StatePerformance::isTriggerDuring, StatePerformances::StatePerformance::middle, StatePerformances::StatePerformance::nonDoMiddle, StatePerformances::StatePerformance::incomingTransitionTrigger, StatePerformances::StatePerformance::accepted, StatePerformances::StatePerformance::deferrable, StatePerformances::StatePerformance::acceptable, StatePerformances::StatePerformance::acceptable::thatSP, StatePerformances::StatePerformance::acceptable::accableT, StatePerformances::StatePerformance::acceptable::accT, StatePerformances::StatePerformance::allSubstatePerformances, StatePerformances::StatePerformance::allSubstatePerformances::substatePerformances, StatePerformances::StatePerformance::allSubtransitionPerformances, StatePerformances::StatePerformance::allSubtransitionPerformances::subtransitionPerformances, StatePerformances::StateTransitionPerformance, StatePerformances::StateTransitionPerformance::isTriggerDuring, StatePerformances::StateTransitionPerformance::transitionLinkSource, StatePerformances::StateTransitionPerformance::transitionLinkTarget, StatePerformances::StateTransitionPerformance::acceptable, StatePerformances::StateTransitionPerformance::trigger, StatePerformances::StateTransitionPerformance::tdNum]
license: EPL-2.0
---

# StatePerformances

Verbatim KerML standard-library source from `sysml.library/Kernel Libraries/Kernel Semantic Library/StatePerformances.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `StatePerformances` — standard library package
- `StatePerformances::StatePerformance` — behavior
- `StatePerformances::StatePerformance::isTriggerDuring` — feature
- `StatePerformances::StatePerformance::middle` — step
- `StatePerformances::StatePerformance::nonDoMiddle` — step
- `StatePerformances::StatePerformance::incomingTransitionTrigger` — feature
- `StatePerformances::StatePerformance::accepted` — feature
- `StatePerformances::StatePerformance::deferrable` — feature
- `StatePerformances::StatePerformance::acceptable` — feature
- `StatePerformances::StatePerformance::acceptable::thatSP` — feature
- `StatePerformances::StatePerformance::acceptable::accableT` — feature
- `StatePerformances::StatePerformance::acceptable::accT` — feature
- `StatePerformances::StatePerformance::allSubstatePerformances` — function
- `StatePerformances::StatePerformance::allSubstatePerformances::substatePerformances` — feature
- `StatePerformances::StatePerformance::allSubtransitionPerformances` — function
- `StatePerformances::StatePerformance::allSubtransitionPerformances::subtransitionPerformances` — feature
- `StatePerformances::StateTransitionPerformance` — behavior
- `StatePerformances::StateTransitionPerformance::isTriggerDuring` — feature
- `StatePerformances::StateTransitionPerformance::transitionLinkSource` — feature
- `StatePerformances::StateTransitionPerformance::transitionLinkTarget` — feature
- `StatePerformances::StateTransitionPerformance::acceptable` — feature
- `StatePerformances::StateTransitionPerformance::trigger` — feature
- `StatePerformances::StateTransitionPerformance::tdNum` — feature
