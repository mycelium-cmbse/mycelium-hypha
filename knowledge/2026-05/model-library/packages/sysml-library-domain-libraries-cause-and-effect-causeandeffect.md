...
language: SysML
source: sysml.library/Domain Libraries/Cause and Effect/CauseAndEffect.sysml
declares: [CauseAndEffect, CauseAndEffect::CausationMetadata, CauseAndEffect::CausationMetadata::isNecessary, CauseAndEffect::CausationMetadata::isSufficient, CauseAndEffect::CausationMetadata::probability]
license: EPL-2.0
---

# CauseAndEffect

Verbatim SysML standard-library source from `sysml.library/Domain Libraries/Cause and Effect/CauseAndEffect.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `CauseAndEffect` — standard library package
- `CauseAndEffect::CausationMetadata` — metadata def
- `CauseAndEffect::CausationMetadata::isNecessary` — attribute
- `CauseAndEffect::CausationMetadata::isSufficient` — attribute
- `CauseAndEffect::CausationMetadata::probability` — attribute
