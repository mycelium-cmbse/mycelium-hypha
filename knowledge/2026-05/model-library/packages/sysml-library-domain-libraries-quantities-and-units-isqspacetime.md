...
language: SysML
source: sysml.library/Domain Libraries/Quantities and Units/ISQSpaceTime.sysml
declares: [ISQSpaceTime, ISQSpaceTime::width, ISQSpaceTime::height, ISQSpaceTime::thickness, ISQSpaceTime::diameter, ISQSpaceTime::radius, ISQSpaceTime::pathLength, ISQSpaceTime::distance, ISQSpaceTime::radialDistance, ISQSpaceTime::Spatial3dCoordinateFrame, ISQSpaceTime::CartesianSpatial3dCoordinateFrame, ISQSpaceTime::CartesianSpatial3dCoordinateFrame::xUnit, ISQSpaceTime::CartesianSpatial3dCoordinateFrame::yUnit, ISQSpaceTime::CartesianSpatial3dCoordinateFrame::zUnit, ISQSpaceTime::universalCartesianSpatial3dCoordinateFrame, ISQSpaceTime::CylindricalSpatial3dCoordinateFrame, ISQSpaceTime::CylindricalSpatial3dCoordinateFrame::radialDistanceUnit, ISQSpaceTime::CylindricalSpatial3dCoordinateFrame::azimuthUnit, ISQSpaceTime::CylindricalSpatial3dCoordinateFrame::zUnit, ISQSpaceTime::SphericalSpatial3dCoordinateFrame, ISQSpaceTime::SphericalSpatial3dCoordinateFrame::radialDistanceUnit, ISQSpaceTime::SphericalSpatial3dCoordinateFrame::inclinationUnit, ISQSpaceTime::SphericalSpatial3dCoordinateFrame::azimuthUnit, ISQSpaceTime::PlanetarySpatial3dCoordinateFrame, ISQSpaceTime::PlanetarySpatial3dCoordinateFrame::latitudeUnit, ISQSpaceTime::PlanetarySpatial3dCoordinateFrame::longitudeUnit, ISQSpaceTime::PlanetarySpatial3dCoordinateFrame::altitudeUnit, ISQSpaceTime::Position3dVector, ISQSpaceTime::position3dVector, ISQSpaceTime::CartesianPosition3dVector, ISQSpaceTime::CartesianPosition3dVector::x, ISQSpaceTime::CartesianPosition3dVector::y, ISQSpaceTime::CartesianPosition3dVector::z, ISQSpaceTime::cartesianPosition3dVector, ISQSpaceTime::CylindricalPosition3dVector, ISQSpaceTime::cylindricalPosition3dVector, ISQSpaceTime::SphericalPosition3dVector, ISQSpaceTime::sphericalPosition3dVector, ISQSpaceTime::PlanetaryPosition3dVector, ISQSpaceTime::planetaryPosition3dVector, ISQSpaceTime::Displacement3dVector, ISQSpaceTime::displacement3dVector, ISQSpaceTime::CartesianDisplacement3dVector, ISQSpaceTime::CartesianDisplacement3dVector::x, ISQSpaceTime::CartesianDisplacement3dVector::y, ISQSpaceTime::CartesianDisplacement3dVector::z, ISQSpaceTime::cartesianDisplacement3dVector, ISQSpaceTime::CylindricalDisplacement3dVector, ISQSpaceTime::cylindricalDisplacement3dVector, ISQSpaceTime::SphericalDisplacement3dVector, ISQSpaceTime::sphericalDisplacement3dVector, ISQSpaceTime::radiusOfCurvature, ISQSpaceTime::CurvatureValue, ISQSpaceTime::curvature, ISQSpaceTime::CurvatureUnit, ISQSpaceTime::CurvatureUnit::lengthPF, ISQSpaceTime::AreaValue, ISQSpaceTime::area, ISQSpaceTime::AreaUnit, ISQSpaceTime::AreaUnit::lengthPF, ISQSpaceTime::VolumeValue, ISQSpaceTime::volume, ISQSpaceTime::VolumeUnit, ISQSpaceTime::VolumeUnit::lengthPF, ISQSpaceTime::AngularMeasureValue, ISQSpaceTime::angularMeasure, ISQSpaceTime::AngularMeasureUnit, ISQSpaceTime::rotationalDisplacement, ISQSpaceTime::phaseAngle, ISQSpaceTime::SolidAngularMeasureValue, ISQSpaceTime::solidAngularMeasure, ISQSpaceTime::SolidAngularMeasureUnit, ISQSpaceTime::CartesianVelocity3dVector, ISQSpaceTime::cartesianVelocity3dVector, ISQSpaceTime::CartesianVelocity3dCoordinateFrame, ISQSpaceTime::SpeedValue, ISQSpaceTime::speed, ISQSpaceTime::SpeedUnit, ISQSpaceTime::SpeedUnit::lengthPF, ISQSpaceTime::SpeedUnit::durationPF, ISQSpaceTime::AccelerationValue, ISQSpaceTime::acceleration, ISQSpaceTime::AccelerationUnit, ISQSpaceTime::AccelerationUnit::lengthPF, ISQSpaceTime::AccelerationUnit::durationPF, ISQSpaceTime::CartesianAcceleration3dVector, ISQSpaceTime::cartesianAcceleration3dVector, ISQSpaceTime::CartesianAcceleration3dCoordinateFrame, ISQSpaceTime::AngularVelocityValue, ISQSpaceTime::angularVelocity, ISQSpaceTime::AngularVelocityUnit, ISQSpaceTime::AngularVelocityUnit::durationPF, ISQSpaceTime::CartesianAngularVelocity3dVector, ISQSpaceTime::cartesianAngularVelocity3dVector, ISQSpaceTime::CartesianAngularVelocity3dCoordinateFrame, ISQSpaceTime::AngularAccelerationValue, ISQSpaceTime::angularAcceleration, ISQSpaceTime::AngularAccelerationUnit, ISQSpaceTime::AngularAccelerationUnit::durationPF, ISQSpaceTime::CartesianAngularAcceleration3dVector, ISQSpaceTime::cartesianAngularAcceleration3dVector, ISQSpaceTime::CartesianAngularAcceleration3dCoordinateFrame, ISQSpaceTime::periodDuration, ISQSpaceTime::timeConstant, ISQSpaceTime::rotation, ISQSpaceTime::FrequencyValue, ISQSpaceTime::frequency, ISQSpaceTime::FrequencyUnit, ISQSpaceTime::FrequencyUnit::durationPF, ISQSpaceTime::rotationalFrequency, ISQSpaceTime::AngularFrequencyValue, ISQSpaceTime::angularFrequency, ISQSpaceTime::AngularFrequencyUnit, ISQSpaceTime::AngularFrequencyUnit::durationPF, ISQSpaceTime::wavelength, ISQSpaceTime::RepetencyValue, ISQSpaceTime::repetency, ISQSpaceTime::RepetencyUnit, ISQSpaceTime::RepetencyUnit::lengthPF, ISQSpaceTime::CartesianWave3dVector, ISQSpaceTime::cartesianWave3dVector, ISQSpaceTime::CartesianWaveVector3dCoordinateFrame, ISQSpaceTime::AngularRepetencyValue, ISQSpaceTime::angularRepetency, ISQSpaceTime::AngularRepetencyUnit, ISQSpaceTime::AngularRepetencyUnit::lengthPF, ISQSpaceTime::PhaseVelocityValue, ISQSpaceTime::phaseVelocity, ISQSpaceTime::PhaseVelocityUnit, ISQSpaceTime::PhaseVelocityUnit::lengthPF, ISQSpaceTime::PhaseVelocityUnit::durationPF, ISQSpaceTime::groupVelocity, ISQSpaceTime::DampingCoefficientValue, ISQSpaceTime::dampingCoefficient, ISQSpaceTime::DampingCoefficientUnit, ISQSpaceTime::DampingCoefficientUnit::durationPF, ISQSpaceTime::LogarithmicDecrementValue, ISQSpaceTime::logarithmicDecrement, ISQSpaceTime::AttenuationValue, ISQSpaceTime::attenuation, ISQSpaceTime::AttenuationUnit, ISQSpaceTime::AttenuationUnit::lengthPF, ISQSpaceTime::PhaseCoefficientValue, ISQSpaceTime::phaseCoefficient, ISQSpaceTime::PhaseCoefficientUnit, ISQSpaceTime::PhaseCoefficientUnit::lengthPF, ISQSpaceTime::PropagationCoefficientValue, ISQSpaceTime::propagationCoefficient, ISQSpaceTime::PropagationCoefficientUnit, ISQSpaceTime::PropagationCoefficientUnit::lengthPF]
license: EPL-2.0
---

# ISQSpaceTime

Verbatim SysML standard-library source from `sysml.library/Domain Libraries/Quantities and Units/ISQSpaceTime.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `ISQSpaceTime` — standard library package
- `ISQSpaceTime::width` — attribute
- `ISQSpaceTime::height` — attribute
- `ISQSpaceTime::thickness` — attribute
- `ISQSpaceTime::diameter` — attribute
- `ISQSpaceTime::radius` — attribute
- `ISQSpaceTime::pathLength` — attribute
- `ISQSpaceTime::distance` — attribute
- `ISQSpaceTime::radialDistance` — attribute
- `ISQSpaceTime::Spatial3dCoordinateFrame` — attribute def
- `ISQSpaceTime::CartesianSpatial3dCoordinateFrame` — attribute def
- `ISQSpaceTime::CartesianSpatial3dCoordinateFrame::xUnit` — attribute
- `ISQSpaceTime::CartesianSpatial3dCoordinateFrame::yUnit` — attribute
- `ISQSpaceTime::CartesianSpatial3dCoordinateFrame::zUnit` — attribute
- `ISQSpaceTime::universalCartesianSpatial3dCoordinateFrame` — attribute
- `ISQSpaceTime::CylindricalSpatial3dCoordinateFrame` — attribute def
- `ISQSpaceTime::CylindricalSpatial3dCoordinateFrame::radialDistanceUnit` — attribute
- `ISQSpaceTime::CylindricalSpatial3dCoordinateFrame::azimuthUnit` — attribute
- `ISQSpaceTime::CylindricalSpatial3dCoordinateFrame::zUnit` — attribute
- `ISQSpaceTime::SphericalSpatial3dCoordinateFrame` — attribute def
- `ISQSpaceTime::SphericalSpatial3dCoordinateFrame::radialDistanceUnit` — attribute
- `ISQSpaceTime::SphericalSpatial3dCoordinateFrame::inclinationUnit` — attribute
- `ISQSpaceTime::SphericalSpatial3dCoordinateFrame::azimuthUnit` — attribute
- `ISQSpaceTime::PlanetarySpatial3dCoordinateFrame` — attribute def
- `ISQSpaceTime::PlanetarySpatial3dCoordinateFrame::latitudeUnit` — attribute
- `ISQSpaceTime::PlanetarySpatial3dCoordinateFrame::longitudeUnit` — attribute
- `ISQSpaceTime::PlanetarySpatial3dCoordinateFrame::altitudeUnit` — attribute
- `ISQSpaceTime::Position3dVector` — attribute def
- `ISQSpaceTime::position3dVector` — attribute
- `ISQSpaceTime::CartesianPosition3dVector` — attribute def
- `ISQSpaceTime::CartesianPosition3dVector::x` — attribute
- `ISQSpaceTime::CartesianPosition3dVector::y` — attribute
- `ISQSpaceTime::CartesianPosition3dVector::z` — attribute
- `ISQSpaceTime::cartesianPosition3dVector` — attribute
- `ISQSpaceTime::CylindricalPosition3dVector` — attribute def
- `ISQSpaceTime::cylindricalPosition3dVector` — attribute
- `ISQSpaceTime::SphericalPosition3dVector` — attribute def
- `ISQSpaceTime::sphericalPosition3dVector` — attribute
- `ISQSpaceTime::PlanetaryPosition3dVector` — attribute def
- `ISQSpaceTime::planetaryPosition3dVector` — attribute
- `ISQSpaceTime::Displacement3dVector` — attribute def
- `ISQSpaceTime::displacement3dVector` — attribute
- `ISQSpaceTime::CartesianDisplacement3dVector` — attribute def
- `ISQSpaceTime::CartesianDisplacement3dVector::x` — attribute
- `ISQSpaceTime::CartesianDisplacement3dVector::y` — attribute
- `ISQSpaceTime::CartesianDisplacement3dVector::z` — attribute
- `ISQSpaceTime::cartesianDisplacement3dVector` — attribute
- `ISQSpaceTime::CylindricalDisplacement3dVector` — attribute def
- `ISQSpaceTime::cylindricalDisplacement3dVector` — attribute
- `ISQSpaceTime::SphericalDisplacement3dVector` — attribute def
- `ISQSpaceTime::sphericalDisplacement3dVector` — attribute
- `ISQSpaceTime::radiusOfCurvature` — attribute
- `ISQSpaceTime::CurvatureValue` — attribute def
- `ISQSpaceTime::curvature` — attribute
- `ISQSpaceTime::CurvatureUnit` — attribute def
- `ISQSpaceTime::CurvatureUnit::lengthPF` — attribute
- `ISQSpaceTime::AreaValue` — attribute def
- `ISQSpaceTime::area` — attribute
- `ISQSpaceTime::AreaUnit` — attribute def
- `ISQSpaceTime::AreaUnit::lengthPF` — attribute
- `ISQSpaceTime::VolumeValue` — attribute def
- `ISQSpaceTime::volume` — attribute
- `ISQSpaceTime::VolumeUnit` — attribute def
- `ISQSpaceTime::VolumeUnit::lengthPF` — attribute
- `ISQSpaceTime::AngularMeasureValue` — attribute def
- `ISQSpaceTime::angularMeasure` — attribute
- `ISQSpaceTime::AngularMeasureUnit` — attribute def
- `ISQSpaceTime::rotationalDisplacement` — attribute
- `ISQSpaceTime::phaseAngle` — attribute
- `ISQSpaceTime::SolidAngularMeasureValue` — attribute def
- `ISQSpaceTime::solidAngularMeasure` — attribute
- `ISQSpaceTime::SolidAngularMeasureUnit` — attribute def
- `ISQSpaceTime::CartesianVelocity3dVector` — attribute def
- `ISQSpaceTime::cartesianVelocity3dVector` — attribute
- `ISQSpaceTime::CartesianVelocity3dCoordinateFrame` — attribute def
- `ISQSpaceTime::SpeedValue` — attribute def
- `ISQSpaceTime::speed` — attribute
- `ISQSpaceTime::SpeedUnit` — attribute def
- `ISQSpaceTime::SpeedUnit::lengthPF` — attribute
- `ISQSpaceTime::SpeedUnit::durationPF` — attribute
- `ISQSpaceTime::AccelerationValue` — attribute def
- `ISQSpaceTime::acceleration` — attribute
- `ISQSpaceTime::AccelerationUnit` — attribute def
- `ISQSpaceTime::AccelerationUnit::lengthPF` — attribute
- `ISQSpaceTime::AccelerationUnit::durationPF` — attribute
- `ISQSpaceTime::CartesianAcceleration3dVector` — attribute def
- `ISQSpaceTime::cartesianAcceleration3dVector` — attribute
- `ISQSpaceTime::CartesianAcceleration3dCoordinateFrame` — attribute def
- `ISQSpaceTime::AngularVelocityValue` — attribute def
- `ISQSpaceTime::angularVelocity` — attribute
- `ISQSpaceTime::AngularVelocityUnit` — attribute def
- `ISQSpaceTime::AngularVelocityUnit::durationPF` — attribute
- `ISQSpaceTime::CartesianAngularVelocity3dVector` — attribute def
- `ISQSpaceTime::cartesianAngularVelocity3dVector` — attribute
- `ISQSpaceTime::CartesianAngularVelocity3dCoordinateFrame` — attribute def
- `ISQSpaceTime::AngularAccelerationValue` — attribute def
- `ISQSpaceTime::angularAcceleration` — attribute
- `ISQSpaceTime::AngularAccelerationUnit` — attribute def
- `ISQSpaceTime::AngularAccelerationUnit::durationPF` — attribute
- `ISQSpaceTime::CartesianAngularAcceleration3dVector` — attribute def
- `ISQSpaceTime::cartesianAngularAcceleration3dVector` — attribute
- `ISQSpaceTime::CartesianAngularAcceleration3dCoordinateFrame` — attribute def
- `ISQSpaceTime::periodDuration` — attribute
- `ISQSpaceTime::timeConstant` — attribute
- `ISQSpaceTime::rotation` — attribute
- `ISQSpaceTime::FrequencyValue` — attribute def
- `ISQSpaceTime::frequency` — attribute
- `ISQSpaceTime::FrequencyUnit` — attribute def
- `ISQSpaceTime::FrequencyUnit::durationPF` — attribute
- `ISQSpaceTime::rotationalFrequency` — attribute
- `ISQSpaceTime::AngularFrequencyValue` — attribute def
- `ISQSpaceTime::angularFrequency` — attribute
- `ISQSpaceTime::AngularFrequencyUnit` — attribute def
- `ISQSpaceTime::AngularFrequencyUnit::durationPF` — attribute
- `ISQSpaceTime::wavelength` — attribute
- `ISQSpaceTime::RepetencyValue` — attribute def
- `ISQSpaceTime::repetency` — attribute
- `ISQSpaceTime::RepetencyUnit` — attribute def
- `ISQSpaceTime::RepetencyUnit::lengthPF` — attribute
- `ISQSpaceTime::CartesianWave3dVector` — attribute def
- `ISQSpaceTime::cartesianWave3dVector` — attribute
- `ISQSpaceTime::CartesianWaveVector3dCoordinateFrame` — attribute def
- `ISQSpaceTime::AngularRepetencyValue` — attribute def
- `ISQSpaceTime::angularRepetency` — attribute
- `ISQSpaceTime::AngularRepetencyUnit` — attribute def
- `ISQSpaceTime::AngularRepetencyUnit::lengthPF` — attribute
- `ISQSpaceTime::PhaseVelocityValue` — attribute def
- `ISQSpaceTime::phaseVelocity` — attribute
- `ISQSpaceTime::PhaseVelocityUnit` — attribute def
- `ISQSpaceTime::PhaseVelocityUnit::lengthPF` — attribute
- `ISQSpaceTime::PhaseVelocityUnit::durationPF` — attribute
- `ISQSpaceTime::groupVelocity` — attribute
- `ISQSpaceTime::DampingCoefficientValue` — attribute def
- `ISQSpaceTime::dampingCoefficient` — attribute
- `ISQSpaceTime::DampingCoefficientUnit` — attribute def
- `ISQSpaceTime::DampingCoefficientUnit::durationPF` — attribute
- `ISQSpaceTime::LogarithmicDecrementValue` — attribute def
- `ISQSpaceTime::logarithmicDecrement` — attribute
- `ISQSpaceTime::AttenuationValue` — attribute def
- `ISQSpaceTime::attenuation` — attribute
- `ISQSpaceTime::AttenuationUnit` — attribute def
- `ISQSpaceTime::AttenuationUnit::lengthPF` — attribute
- `ISQSpaceTime::PhaseCoefficientValue` — attribute def
- `ISQSpaceTime::phaseCoefficient` — attribute
- `ISQSpaceTime::PhaseCoefficientUnit` — attribute def
- `ISQSpaceTime::PhaseCoefficientUnit::lengthPF` — attribute
- `ISQSpaceTime::PropagationCoefficientValue` — attribute def
- `ISQSpaceTime::propagationCoefficient` — attribute
- `ISQSpaceTime::PropagationCoefficientUnit` — attribute def
- `ISQSpaceTime::PropagationCoefficientUnit::lengthPF` — attribute
