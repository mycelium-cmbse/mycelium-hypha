...
language: SysML
source: sysml.library/Domain Libraries/Quantities and Units/SIPrefixes.sysml
declares: [SIPrefixes, SIPrefixes::yocto, SIPrefixes::zepto, SIPrefixes::atto, SIPrefixes::femto, SIPrefixes::pico, SIPrefixes::nano, SIPrefixes::micro, SIPrefixes::milli, SIPrefixes::centi, SIPrefixes::deci, SIPrefixes::deca, SIPrefixes::hecto, SIPrefixes::kilo, SIPrefixes::mega, SIPrefixes::giga, SIPrefixes::tera, SIPrefixes::peta, SIPrefixes::exa, SIPrefixes::zetta, SIPrefixes::yotta, SIPrefixes::kibi, SIPrefixes::mebi, SIPrefixes::gibi, SIPrefixes::tebi, SIPrefixes::pebi, SIPrefixes::exbi, SIPrefixes::zebi, SIPrefixes::yobi]
license: EPL-2.0
---

# SIPrefixes

Verbatim SysML standard-library source from `sysml.library/Domain Libraries/Quantities and Units/SIPrefixes.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
...
- `SIPrefixes` — standard library package
- `SIPrefixes::yocto` — attribute
- `SIPrefixes::zepto` — attribute
- `SIPrefixes::atto` — attribute
- `SIPrefixes::femto` — attribute
- `SIPrefixes::pico` — attribute
- `SIPrefixes::nano` — attribute
- `SIPrefixes::micro` — attribute
- `SIPrefixes::milli` — attribute
- `SIPrefixes::centi` — attribute
- `SIPrefixes::deci` — attribute
- `SIPrefixes::deca` — attribute
- `SIPrefixes::hecto` — attribute
- `SIPrefixes::kilo` — attribute
- `SIPrefixes::mega` — attribute
- `SIPrefixes::giga` — attribute
- `SIPrefixes::tera` — attribute
- `SIPrefixes::peta` — attribute
- `SIPrefixes::exa` — attribute
- `SIPrefixes::zetta` — attribute
- `SIPrefixes::yotta` — attribute
- `SIPrefixes::kibi` — attribute
- `SIPrefixes::mebi` — attribute
- `SIPrefixes::gibi` — attribute
- `SIPrefixes::tebi` — attribute
- `SIPrefixes::pebi` — attribute
- `SIPrefixes::exbi` — attribute
- `SIPrefixes::zebi` — attribute
- `SIPrefixes::yobi` — attribute
