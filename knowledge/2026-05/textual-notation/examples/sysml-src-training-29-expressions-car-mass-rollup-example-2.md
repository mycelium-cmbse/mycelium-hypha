...
kind: example
language: SysML
source: sysml/src/training/29. Expressions/Car Mass Rollup Example 2.sysml
...
Verbatim SysML model from `sysml/src/training/29. Expressions/Car Mass Rollup Example 2.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
