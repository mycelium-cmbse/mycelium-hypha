---
name: A-3-6-Sequences
kind: example
language: KerML
source: kerml/src/examples/KerML Spec Annex A Examples/A-3-6-Sequences.kerml
elements: []
license: EPL-2.0
---
...
Verbatim KerML model from `kerml/src/examples/KerML Spec Annex A Examples/A-3-6-Sequences.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
