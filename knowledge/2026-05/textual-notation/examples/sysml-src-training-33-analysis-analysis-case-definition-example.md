...
kind: example
language: SysML
source: sysml/src/training/33. Analysis/Analysis Case Definition Example.sysml
elements: [ActionUsage, AssertConstraintUsage, AttributeDefinition, AttributeUsage, ConstraintUsage, PartDefinition, PartUsage, RequirementUsage]
license: EPL-2.0
---

# Analysis Case Definition Example

Verbatim SysML model from `sysml/src/training/33. Analysis/Analysis Case Definition Example.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
