...
kind: example
language: SysML
source: sysml/src/validation/08-Requirements/8-Requirements.sysml
elements: [ActionDefinition, ActionUsage, AttributeUsage, ConstraintUsage, InterfaceDefinition, InterfaceUsage, PartDefinition, PartUsage, PerformActionUsage, PortDefinition, PortUsage, ReferenceUsage, RequirementDefinition, RequirementUsage]
license: EPL-2.0
---

# 8-Requirements

Verbatim SysML model from `sysml/src/validation/08-Requirements/8-Requirements.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
