---
name: A-3-8-ChangingFeatureValues
kind: example
language: KerML
source: kerml/src/examples/KerML Spec Annex A Examples/A-3-8-ChangingFeatureValues.kerml
elements: []
license: EPL-2.0
---

# A-3-8-ChangingFeatureValues

Verbatim KerML model from `kerml/src/examples/KerML Spec Annex A Examples/A-3-8-ChangingFeatureValues.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
