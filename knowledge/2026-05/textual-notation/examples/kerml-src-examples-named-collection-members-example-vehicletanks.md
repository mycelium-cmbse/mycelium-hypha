...
kind: example
language: KerML
source: kerml/src/examples/Named Collection Members Example/VehicleTanks.kerml
elements: []
license: EPL-2.0
---
...
Verbatim KerML model from `kerml/src/examples/Named Collection Members Example/VehicleTanks.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
