...
kind: example
language: SysML
source: sysml/src/examples/Vehicle Example/VehicleUsages.sysml
elements: [AttributeUsage, ConnectionUsage, FlowUsage, InterfaceUsage, PartUsage, PortUsage]
license: EPL-2.0
---

# VehicleUsages

Verbatim SysML model from `sysml/src/examples/Vehicle Example/VehicleUsages.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
