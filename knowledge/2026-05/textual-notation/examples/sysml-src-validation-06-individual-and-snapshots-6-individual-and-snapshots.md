...
kind: example
language: SysML
source: sysml/src/validation/06-Individual and Snapshots/6-Individual and Snapshots.sysml
elements: [AttributeUsage, ExhibitStateUsage, PartDefinition, PartUsage, ReferenceUsage, StateUsage]
license: EPL-2.0
---

# 6-Individual and Snapshots

Verbatim SysML model from `sysml/src/validation/06-Individual and Snapshots/6-Individual and Snapshots.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
