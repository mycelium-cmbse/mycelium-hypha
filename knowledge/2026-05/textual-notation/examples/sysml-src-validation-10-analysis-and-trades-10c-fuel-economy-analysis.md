...
kind: example
language: SysML
source: sysml/src/validation/10-Analysis and Trades/10c-Fuel Economy Analysis.sysml
elements: [ActionUsage, AttributeDefinition, AttributeUsage, ConstraintUsage, ExhibitStateUsage, PartDefinition, PartUsage, RequirementDefinition, RequirementUsage, StateUsage]
license: EPL-2.0
---

# 10c-Fuel Economy Analysis

Verbatim SysML model from `sysml/src/validation/10-Analysis and Trades/10c-Fuel Economy Analysis.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
