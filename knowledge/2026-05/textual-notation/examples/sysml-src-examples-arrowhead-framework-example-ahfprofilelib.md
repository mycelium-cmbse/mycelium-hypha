...
kind: example
language: SysML
source: sysml/src/examples/Arrowhead Framework Example/AHFProfileLib.sysml
elements: [ActionUsage, AttributeUsage, MetadataDefinition, MetadataUsage, PartDefinition, PartUsage, PortDefinition, PortUsage]
license: EPL-2.0
---

# AHFProfileLib

Verbatim SysML model from `sysml/src/examples/Arrowhead Framework Example/AHFProfileLib.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
