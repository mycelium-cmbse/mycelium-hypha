...
kind: example
language: SysML
source: sysml/src/examples/Arrowhead Framework Example/AHFSequences.sysml
elements: [CaseUsage, EventOccurrenceUsage, FlowUsage, InterfaceUsage, OccurrenceDefinition, OccurrenceUsage, PartUsage, PortUsage, ReferenceUsage]
license: EPL-2.0
---

# AHFSequences

Verbatim SysML model from `sysml/src/examples/Arrowhead Framework Example/AHFSequences.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
