...
kind: example
language: SysML
source: sysml/src/validation/01-Parts Tree/1c-Parts Tree Redefinition.sysml
...
Verbatim SysML model from `sysml/src/validation/01-Parts Tree/1c-Parts Tree Redefinition.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
