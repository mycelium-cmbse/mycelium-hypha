...
kind: example
language: KerML
source: kerml/src/examples/Simple Tests/Filtering.kerml
elements: []
license: EPL-2.0
---
...
Verbatim KerML model from `kerml/src/examples/Simple Tests/Filtering.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
