...
kind: example
language: SysML
source: sysml/src/examples/Arrowhead Framework Example/AHFNorwayTopics.sysml
elements: [ActionUsage, AttributeDefinition, AttributeUsage, CaseUsage, PartUsage, PortDefinition, PortUsage, StateUsage]
license: EPL-2.0
---

# AHFNorwayTopics

Verbatim SysML model from `sysml/src/examples/Arrowhead Framework Example/AHFNorwayTopics.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
