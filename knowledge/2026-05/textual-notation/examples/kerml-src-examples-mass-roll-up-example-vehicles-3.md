...
kind: example
language: KerML
source: kerml/src/examples/Mass Roll-up Example/Vehicles_3.kerml
elements: []
license: EPL-2.0
---
...
Verbatim KerML model from `kerml/src/examples/Mass Roll-up Example/Vehicles_3.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
