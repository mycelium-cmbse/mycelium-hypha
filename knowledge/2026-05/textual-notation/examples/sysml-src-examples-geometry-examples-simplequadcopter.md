...
kind: example
language: SysML
source: sysml/src/examples/Geometry Examples/SimpleQuadcopter.sysml
elements: [AttributeUsage, ConstraintUsage, ItemUsage, PartDefinition, PartUsage, ViewUsage]
license: EPL-2.0
---

# SimpleQuadcopter

Verbatim SysML model from `sysml/src/examples/Geometry Examples/SimpleQuadcopter.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
