...
kind: example
language: SysML
source: sysml/src/validation/14-Language Extensions/14c-Language Extensions.sysml
elements: [AttributeUsage, ConnectionDefinition, ConnectionUsage, ItemDefinition, ItemUsage, MetadataDefinition, MetadataUsage, OccurrenceDefinition, OccurrenceUsage, PartUsage, RequirementDefinition, RequirementUsage]
license: EPL-2.0
---

# 14c-Language Extensions

Verbatim SysML model from `sysml/src/validation/14-Language Extensions/14c-Language Extensions.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
