...
kind: example
language: SysML
source: sysml/src/examples/Geometry Examples/CarWithShapeAndCSG.sysml
elements: [AttributeUsage, ItemUsage, PartDefinition, PartUsage]
license: EPL-2.0
---

# CarWithShapeAndCSG

Verbatim SysML model from `sysml/src/examples/Geometry Examples/CarWithShapeAndCSG.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
