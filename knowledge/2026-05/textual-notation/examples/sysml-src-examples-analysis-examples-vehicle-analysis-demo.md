...
kind: example
language: SysML
source: sysml/src/examples/Analysis Examples/Vehicle Analysis Demo.sysml
elements: [ActionDefinition, ActionUsage, AssertConstraintUsage, AttributeDefinition, AttributeUsage, ConstraintDefinition, ConstraintUsage, ItemDefinition, ItemUsage, PartDefinition, PartUsage, PortDefinition, PortUsage, RequirementDefinition, RequirementUsage, StateUsage]
license: EPL-2.0
---

# Vehicle Analysis Demo

Verbatim SysML model from `sysml/src/examples/Analysis Examples/Vehicle Analysis Demo.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
