---
name: VehicleGeometryAndCoordinateFrames
kind: example
language: SysML
source: sysml/src/examples/Geometry Examples/VehicleGeometryAndCoordinateFrames.sysml
elements: [AssertConstraintUsage, AttributeUsage, ConstraintUsage, ItemUsage, PartDefinition, PartUsage]
license: EPL-2.0
---

# VehicleGeometryAndCoordinateFrames

Verbatim SysML model from `sysml/src/examples/Geometry Examples/VehicleGeometryAndCoordinateFrames.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
