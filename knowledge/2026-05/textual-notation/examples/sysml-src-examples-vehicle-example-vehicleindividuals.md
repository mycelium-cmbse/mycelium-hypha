...
kind: example
language: SysML
source: sysml/src/examples/Vehicle Example/VehicleIndividuals.sysml
...
Verbatim SysML model from `sysml/src/examples/Vehicle Example/VehicleIndividuals.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
