---
name: A-3-3-OneToOneConnectors
kind: example
language: KerML
source: kerml/src/examples/KerML Spec Annex A Examples/A-3-3-OneToOneConnectors.kerml
elements: []
license: EPL-2.0
---

# A-3-3-OneToOneConnectors

Verbatim KerML model from `kerml/src/examples/KerML Spec Annex A Examples/A-3-3-OneToOneConnectors.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
