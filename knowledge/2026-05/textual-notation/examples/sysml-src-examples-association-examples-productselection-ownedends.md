---
name: ProductSelection_OwnedEnds
kind: example
language: SysML
source: sysml/src/examples/Association Examples/ProductSelection_OwnedEnds.sysml
elements: [ConnectionDefinition, ConnectionUsage, ItemDefinition, ItemUsage]
license: EPL-2.0
---

# ProductSelection_OwnedEnds

Verbatim SysML model from `sysml/src/examples/Association Examples/ProductSelection_OwnedEnds.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
