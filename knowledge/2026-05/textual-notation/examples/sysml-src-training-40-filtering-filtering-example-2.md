...
kind: example
language: SysML
source: sysml/src/training/40. Filtering/Filtering Example-2.sysml
...
Verbatim SysML model from `sysml/src/training/40. Filtering/Filtering Example-2.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
