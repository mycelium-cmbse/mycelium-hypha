---
name: TimeVaryingFeatures
kind: example
language: KerML
source: kerml/src/examples/Variable Feature Examples/TimeVaryingFeatures.kerml
elements: []
license: EPL-2.0
---
...
Verbatim KerML model from `kerml/src/examples/Variable Feature Examples/TimeVaryingFeatures.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
