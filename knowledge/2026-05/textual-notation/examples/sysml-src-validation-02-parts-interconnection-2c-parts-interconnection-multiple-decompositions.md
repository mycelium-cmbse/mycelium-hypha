...
kind: example
language: SysML
source: sysml/src/validation/02-Parts Interconnection/2c-Parts Interconnection-Multiple Decompositions.sysml
elements: [AttributeUsage, PartDefinition, PartUsage, PortUsage, ReferenceUsage]
license: EPL-2.0
---

# 2c-Parts Interconnection-Multiple Decompositions

Verbatim SysML model from `sysml/src/validation/02-Parts Interconnection/2c-Parts Interconnection-Multiple Decompositions.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
