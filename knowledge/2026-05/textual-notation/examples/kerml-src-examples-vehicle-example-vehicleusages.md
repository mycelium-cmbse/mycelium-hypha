...
kind: example
language: KerML
source: kerml/src/examples/Vehicle Example/VehicleUsages.kerml
elements: [PartUsage]
license: EPL-2.0
---
...
Verbatim KerML model from `kerml/src/examples/Vehicle Example/VehicleUsages.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
