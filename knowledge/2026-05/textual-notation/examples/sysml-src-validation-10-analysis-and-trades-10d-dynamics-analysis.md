...
kind: example
language: SysML
source: sysml/src/validation/10-Analysis and Trades/10d-Dynamics Analysis.sysml
elements: [ActionDefinition, ActionUsage, AttributeUsage, PartDefinition, PartUsage, PerformActionUsage]
license: EPL-2.0
---

# 10d-Dynamics Analysis

Verbatim SysML model from `sysml/src/validation/10-Analysis and Trades/10d-Dynamics Analysis.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
