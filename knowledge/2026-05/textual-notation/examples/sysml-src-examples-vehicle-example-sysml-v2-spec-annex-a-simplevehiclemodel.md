...
kind: example
language: SysML
source: sysml/src/examples/Vehicle Example/SysML v2 Spec Annex A SimpleVehicleModel.sysml
elements: [ActionDefinition, ActionUsage, AllocationDefinition, AllocationUsage, AssertConstraintUsage, AttributeDefinition, AttributeUsage, CaseDefinition, CaseUsage, ConcernDefinition, ConcernUsage, ConnectionUsage, ConstraintUsage, EventOccurrenceUsage, ExhibitStateUsage, FlowUsage, IncludeUseCaseUsage, InterfaceDefinition, InterfaceUsage, ItemDefinition, ItemUsage, MetadataDefinition, MetadataUsage, OccurrenceUsage, PartDefinition, PartUsage, PerformActionUsage, PortDefinition, PortUsage, RenderingUsage, RequirementDefinition, RequirementUsage, SatisfyRequirementUsage, StateDefinition, StateUsage, TransitionUsage, UseCaseDefinition, UseCaseUsage, ViewDefinition, ViewUsage, ViewpointDefinition, ViewpointUsage]
license: EPL-2.0
---

# SysML v2 Spec Annex A SimpleVehicleModel

Verbatim SysML model from `sysml/src/examples/Vehicle Example/SysML v2 Spec Annex A SimpleVehicleModel.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
