...
kind: example
language: SysML
source: sysml/src/examples/Analysis Examples/Dynamics.sysml
elements: [ActionDefinition, ActionUsage, AssertConstraintUsage, AttributeUsage, ConstraintUsage]
license: EPL-2.0
---

# Dynamics

Verbatim SysML model from `sysml/src/examples/Analysis Examples/Dynamics.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
