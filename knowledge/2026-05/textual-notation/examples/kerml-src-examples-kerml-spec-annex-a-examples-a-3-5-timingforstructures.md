---
name: A-3-5-TimingForStructures
kind: example
language: KerML
source: kerml/src/examples/KerML Spec Annex A Examples/A-3-5-TimingForStructures.kerml
elements: []
license: EPL-2.0
---

# A-3-5-TimingForStructures

Verbatim KerML model from `kerml/src/examples/KerML Spec Annex A Examples/A-3-5-TimingForStructures.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
