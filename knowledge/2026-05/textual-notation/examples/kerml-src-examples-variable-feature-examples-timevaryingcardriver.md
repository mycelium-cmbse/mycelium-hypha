---
name: TimeVaryingCarDriver
kind: example
language: KerML
source: kerml/src/examples/Variable Feature Examples/TimeVaryingCarDriver.kerml
elements: []
license: EPL-2.0
---

# TimeVaryingCarDriver

Verbatim KerML model from `kerml/src/examples/Variable Feature Examples/TimeVaryingCarDriver.kerml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
