...
kind: example
language: SysML
source: sysml/src/examples/v1 Spec Examples/8.4.5 Constraining Decomposition/Vehicle Decomposition.sysml
...
Verbatim SysML model from `sysml/src/examples/v1 Spec Examples/8.4.5 Constraining Decomposition/Vehicle Decomposition.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
