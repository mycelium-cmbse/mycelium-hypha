...
kind: example
language: SysML
source: sysml/src/validation/05-State-based Behavior/5-State-based Behavior-1a.sysml
...
# 5-State-based Behavior-1a

Verbatim SysML model from `sysml/src/validation/05-State-based Behavior/5-State-based Behavior-1a.sysml` (EPL-2.0; see [NOTICE](../../../NOTICE)).
