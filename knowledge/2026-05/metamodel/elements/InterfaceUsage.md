...
name: InterfaceUsage
package: Interfaces
fully qualified name: SysML::Systems::Interfaces::InterfaceUsage
isAbstract: false
visibility: public
...
`+` [InterfaceDefinition](InterfaceDefinition.md) · `[0..*]` · *derived*

The InterfaceDefinitions that type this InterfaceUsage.

Redefines [connectionDefinition](ConnectionUsage.md#connectiondefinition)
...
| connectionDefinition | [AssociationStructure](AssociationStructure.md) | [0..*] | [ConnectionUsage](ConnectionUsage.md) | derived, ordered |
