...
name: Structure
package: Structures
fully qualified name: KerML::Kernel::Structures::Structure
isAbstract: false
visibility: public
generalizes: [Class]
specializedBy: [AssociationStructure, ItemDefinition, Metaclass, PortDefinition]
---

# Structure

`Structures` package · concrete metaclass
