...
### exposedElement : Element [0..*] {derived, ordered}
...
### satisfiedViewpoint : ViewpointUsage [0..*] {derived, ordered}
...
### viewCondition : Expression [0..*] {derived, ordered}
