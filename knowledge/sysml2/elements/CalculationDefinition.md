...
A CalculationDefinition is an <coed>ActionDefinition that also defines a Function producing a result.</coed>
...
### calculation : CalculationUsage [0..*] {derived, ordered}
