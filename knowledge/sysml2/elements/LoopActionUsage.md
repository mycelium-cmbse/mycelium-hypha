...
package: Actions
fully qualified name: SysML::Systems::Actions::LoopActionUsage
isAbstract: true
visibility: public
generalizes: [ActionUsage]
specializedBy: [ForLoopActionUsage, WhileLoopActionUsage]
---
...
- [ForLoopActionUsage](ForLoopActionUsage.md)
- [WhileLoopActionUsage](WhileLoopActionUsage.md)
