...
name: PortUsage
package: Ports
fully qualified name: SysML::Systems::Ports::PortUsage
isAbstract: false
visibility: public
...
`+` [PortDefinition](PortDefinition.md) · `[0..*]` · *derived, ordered*

The occurrenceDefinitions of this PortUsage, which must all be PortDefinitions.

Redefines [occurrenceDefinition](OccurrenceUsage.md#occurrencedefinition)
