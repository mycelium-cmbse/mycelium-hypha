...
name: UseCaseUsage
package: UseCases
fully qualified name: SysML::Systems::UseCases::UseCaseUsage
isAbstract: false
visibility: public
generalizes: [CaseUsage]
specializedBy: [IncludeUseCaseUsage]
---
...
- [IncludeUseCaseUsage](IncludeUseCaseUsage.md)
...
`+` [UseCaseDefinition](UseCaseDefinition.md) · `[0..1]` · *derived*

The UseCaseDefinition that is the definition of this UseCaseUsage.

Redefines [caseDefinition](CaseUsage.md#casedefinition)
