...
`+` [EnumerationDefinition](EnumerationDefinition.md) · `[1..1]` · *derived*

The single EnumerationDefinition that is the type of this EnumerationUsage.

Redefines [attributeDefinition](AttributeUsage.md#attributedefinition)
...
| attributeDefinition | [DataType](DataType.md) | [0..*] | [AttributeUsage](AttributeUsage.md) | derived, ordered |
...
| isReference | [Boolean](Boolean.md) | [1..1] | [AttributeUsage](AttributeUsage.md) | derived |
