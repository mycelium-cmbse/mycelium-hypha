...
package: Expressions
fully qualified name: KerML::Kernel::Expressions::LiteralExpression
isAbstract: false
visibility: public
generalizes: [Expression]
specializedBy: [LiteralBoolean, LiteralInfinity, LiteralInteger, LiteralRational, LiteralString]
---
...
- [LiteralBoolean](LiteralBoolean.md)
- [LiteralInfinity](LiteralInfinity.md)
- [LiteralInteger](LiteralInteger.md)
- [LiteralRational](LiteralRational.md)
- [LiteralString](LiteralString.md)
