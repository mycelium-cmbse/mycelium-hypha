...
### allocationDefinition : AllocationDefinition [0..*] {derived, ordered}
...
| connectionDefinition | AssociationStructure | [0..*] | [ConnectionUsage](ConnectionUsage.md) | derived, ordered |
