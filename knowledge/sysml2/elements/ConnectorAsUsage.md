...
package: Connections
isAbstract: true
generalizes: [Connector, Usage]
specializedBy: [BindingConnectorAsUsage, ConnectionUsage, FlowUsage, SuccessionAsUsage]
---

# ConnectorAsUsage

`Connections` package · abstract metaclass
...
- [BindingConnectorAsUsage](BindingConnectorAsUsage.md)
- [ConnectionUsage](ConnectionUsage.md)
- [FlowUsage](FlowUsage.md)
- [SuccessionAsUsage](SuccessionAsUsage.md)
