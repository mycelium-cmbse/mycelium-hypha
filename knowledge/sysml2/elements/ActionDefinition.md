...
package: Actions
isAbstract: false
generalizes: [Behavior, OccurrenceDefinition]
specializedBy: [CalculationDefinition, FlowDefinition, StateDefinition]
---
...
- [StateDefinition](StateDefinition.md)

## Owned features

### action : ActionUsage [0..*] {derived, ordered}
