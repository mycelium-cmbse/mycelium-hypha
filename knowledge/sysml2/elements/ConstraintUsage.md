...
isAbstract: false
visibility: public
generalizes: [BooleanExpression, OccurrenceUsage]
specializedBy: [AssertConstraintUsage, RequirementUsage]
---
...
Redefines [predicate](BooleanExpression.md#predicate)
