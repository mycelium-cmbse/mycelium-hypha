...
name: ItemUsage
package: Items
fully qualified name: SysML::Systems::Items::ItemUsage
isAbstract: false
visibility: public
generalizes: [OccurrenceUsage]
specializedBy: [MetadataUsage, PartUsage]
---
...
`+` [Structure](Structure.md) · `[0..*]` · *derived, ordered*
...
Subsets [occurrenceDefinition](OccurrenceUsage.md#occurrencedefinition)
...
A composite ItemUsage whose owningType is an ItemDefinition or ItemUsage must directly or indirectly specialize the Systems Model Library ItemUsage Items::Item::subitems.
